...
|:---|:---:|:---:|:---|
| **数学 (Math)** | 21个 | 30% | ✅ 基础完整 |
| **物理 (Physics)** | 24个 | 34% | ✅ 热力学已补全 |
| **化学 (Chemistry)** | 15个 | 21% | ⚠️ 部分TBD |
| **生物 (Biology)** | 10个 | 14% | ⚠️ 生态学缺失 |
| **总计** | **70个** | 100% | 🟡 进行中 |
...
❌ **待完成**:
- SB3.01 - Ecosystem Dynamics (生态系统) - 尚未创建
...
**任务**: 创建SB3.01 - Ecosystem Dynamics

**内容要求**:
- 3个阶段建议:
  - FOOD_CHAINS: 食物链与能量流动
  - NUTRIENT_CYCLES: 碳循环、氮循环、水循环
  - POPULATION_DYNAMICS: 种群增长、竞争、捕食
