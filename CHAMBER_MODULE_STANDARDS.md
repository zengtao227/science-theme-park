...
**反例** (错误的难度设计):
```
BASIC: P(E) = 15/100 = 0.15
CORE: P(E) = 20/100 = 0.20
ADVANCED: P(E) = 22/100 = 0.22
ELITE: P(E) = 27/100 = 0.27
...
**正例** (正确的难度设计):
```
BASIC: P(E) = 1/6 (单个骰子，一个结果)
CORE: P(E) = 2/6 (单个骰子，两个结果)
ADVANCED: P(E) = 13/52 (一副牌，一个花色)
ELITE: P(E) = 16/52 (一副牌，所有荣誉牌 A,K,Q,J)
