...
export const baselScenarios: BaselScenario[] = [
  {
    ...
    description: {
      ...
      cn: "巴塞尔标志性的绿色有轨电车穿梭于城市街道，展示了牛顿第二定律的实际应用。在Barfüsserplatz，一辆质量为10,000公斤的电车从静止开始加速至巡航速度。电动机施加15,000牛顿的向前力，而摩擦力和空气阻力提供3,000牛顿的反向力。使用F=ma，我们计算净力（12,000牛顿）产生1.2米/秒^2的加速度。当接近下一站时，司机施加制动产生-10,000牛顿，加上-3,000牛顿摩擦力，产生-13,000牛顿净力和-1.3米/秒^2的减速度。这种力与运动的日常舞蹈使巴塞尔的公共交通顺畅运行，说明了质量和力如何决定整个城市交通系统中的加速度。",
  ...
  },
  {
    ...
    description: {
      ...
      cn: "在巴塞尔莱茵河沿岸的Mittlere Brücke附近，客船通过其推进系统展示了牛顿第三定律。当船的螺旋桨旋转时，它以巨大的力向后推水——典型的莱茵河渡轮可能为3,000牛顿。根据牛顿第三定律，水同时以相等的3,000牛顿力向相反方向推动船只。这对作用-反作用力作用于不同的物体：螺旋桨作用于水，而水作用于船。船的1,500公斤质量因此以2米/秒^2向前加速。河流流动增加了复杂性，但基本原理保持不变：每个力都有一个大小相等、方向相反的反作用力。这一原理为从游泳到火箭推进的一切提供动力，使莱茵河船只之旅成为牛顿对力相互作用洞察的优雅展示。",
  ...
  },
  {
    ...
    description: {
      ...
      cn: "在巴塞尔著名的Fasnacht狂欢节期间，在Marktplatz，精心装饰的游行花车展示了牛顿第一惯性定律。一个质量为3,000公斤的巨大花车在游行开始前静止不动。尽管外观色彩缤纷，它顽固地抵抗运动——除非受到外力作用，否则它将保持静止。当游行参与者以2,000牛顿推动而摩擦力以500牛顿反对时，净1,500牛顿力克服惯性并以0.5米/秒^2加速花车。一旦以恒定速度沿游行路线移动，如果推动者保持与摩擦力相等的力，花车将以稳定速度继续前进——证明当净力为零时，运动中的物体以恒定速度保持运动。这一延续数百年的传统为支配运动和惯性的基本物理原理提供了节日般的说明。",
  ...
  },
  {
    ...
    description: {
      ...
      cn: "在巴塞尔SBB，瑞士最繁忙的国际火车站，站台安全依赖于对牛顿运动定律的理解。当一列50,000公斤的火车以25米/秒接近站台时，制动系统必须施加足够的力以安全停止。制动片压在车轮上，产生-10,000牛顿的制动力，而摩擦力增加另外-3,000牛顿。这-13,000牛顿的净力产生-0.26米/秒^2的减速度，使火车在240米内停止。牛顿第三定律解释了机制：制动片以力F推动车轮，车轮以相等的力-F推回制动片，产生热量并减慢火车。站台黄线标记安全距离，考虑各种速度下的停止距离。理解这些力相互作用确保乘客安全，因为火车到达和离开，通过精确应用物理原理将巴塞尔连接到整个欧洲的目的地。",
