...
export const BASIC_GAS_LAWS_QUESTS: Quest[] = [
  // Boyle's Law Quests (5 quests)
  {
    ...
    problem: L("Calculate V₂ using Boyle's Law: P₁V₁ = P₂V₂"),
    solution: {
      type: "numerical",
      correctAnswer: 1.0,
      unit: "L",
      tolerance: 0.02,
      explanation: L(
        "Using P₁V₁ = P₂V₂: (100)(2.0) = (200)(V₂), so V₂ = 1.0 L",
        "使用 P₁V₁ = P₂V₂: (100)(2.0) = (200)(V₂)，所以 V₂ = 1.0 L",
        "Mit P₁V₁ = P₂V₂: (100)(2,0) = (200)(V₂), also V₂ = 1,0 L"
      ),
    },
  ...
  },
  {
    ...
    problem: L("Calculate P₂ using P₁V₁ = P₂V₂"),
    solution: {
      type: "numerical",
      correctAnswer: 100,
      unit: "kPa",
      tolerance: 0.02,
      explanation: L("(50)(4.0) = P₂(2.0), so P₂ = 100 kPa"),
    },
  ...
  },
  {
    ...
    problem: L("Apply P₁V₁ = P₂V₂"),
    solution: {
      type: "numerical",
      correctAnswer: 100,
      unit: "kPa",
      tolerance: 0.02,
      explanation: L("(150)(3.0) = P₂(4.5), so P₂ = 100 kPa"),
    },
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "L",
      tolerance: 0.02,
      explanation: L("(80)(V₁) = (120)(1.5), so V₁ = 2.25 L"),
    },
    hints: [L("Rearrange to V₁ = P₂V₂/P₁")],
    requiredQuests: [],
  },
  {
    id: "BGL-B-05",
  ...
  // Charles's Law Quests (5 quests)
  {
    ...
    problem: L("Use V₁/T₁ = V₂/T₂"),
    solution: {
      type: "numerical",
      correctAnswer: 4.0,
      unit: "L",
      tolerance: 0.02,
      explanation: L("2.0/300 = V₂/600, so V₂ = 4.0 L"),
    },
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "L",
      tolerance: 0.02,
      explanation: L("5.0/400 = V₂/200, so V₂ = 2.5 L"),
    },
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "K",
      tolerance: 0.02,
      explanation: L("3.0/250 = 4.5/T₂, so T₂ = 375 K"),
    },
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "L",
      tolerance: 0.02,
      explanation: L("2.0/300 = V₂/400, so V₂ = 2.67 L"),
    },
  ...
  // Avogadro's Law Quests (5 quests)
  {
    ...
    problem: L("Use V₁/n₁ = V₂/n₂"),
    solution: {
      type: "numerical",
      correctAnswer: 44.8,
      unit: "L",
      tolerance: 0.02,
      explanation: L("22.4/1.0 = V₂/2.0, so V₂ = 44.8 L"),
    },
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "L",
      tolerance: 0.02,
      explanation: L("10/0.5 = V₂/1.0, so V₂ = 20 L"),
    },
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "L",
      tolerance: 0.02,
      explanation: L("60/3.0 = V₂/2.0, so V₂ = 40 L"),
    },
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "mol",
      tolerance: 0.02,
      explanation: L("22.4/1.0 = 67.2/n₂, so n₂ = 3.0 mol"),
    },
    hints: [L("67.2 = 3 × 22.4")],
    requiredQuests: [],
  },
  {
    ...
    solution: {
      ...
      unit: "L",
      tolerance: 0.02,
      explanation: L("5.6/0.25 = V₂/1.0, so V₂ = 22.4 L"),
    },
...
export const IDEAL_GAS_EQUATION_QUESTS: Quest[] = [
  {
    ...
    description: L("Calculate pressure for 2.0 mol gas at 300 K in 0.05 m³. Use R = 8.314 J/(mol·K)."),
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "m³",
      tolerance: 0.02,
      explanation: L("V = nRT/P = (1.0)(8.314)(273.15)/101325 = 0.0224 m³ = 22.4 L"),
    },
  ...
  },
  {
    ...
    description: L("How many moles in 0.1 m³ at 100,000 Pa and 400 K?"),
  ...
  },
  {
    ...
    description: L("Find temperature for 2.0 mol at 200,000 Pa in 0.02 m³."),
    problem: L("Solve for T"),
    solution: {
      type: "numerical",
      correctAnswer: 240.6,
  ...
  },
  {
    ...
    description: L("Calculate pressure for 5.0 mol at 350 K in 0.1 m³."),
  ...
  },
  {
    ...
    description: L("Find pressure for 0.5 mol at 298 K in 0.01 m³."),
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "m³",
      tolerance: 0.02,
      explanation: L("V = (2.5)(8.314)(400)/50000 = 0.166 m³"),
    },
  ...
  },
  {
    ...
    description: L("Find temperature for 1.0 mol at 300,000 Pa in 0.01 m³."),
  ...
  },
  {
    ...
    description: L("Convert 0.0224 m³ to liters. (1 m³ = 1000 L)"),
    ...
    solution: {
      ...
      unit: "L",
      tolerance: 0.02,
      explanation: L("0.0224 m³ × 1000 = 22.4 L"),
    },
    hints: [L("1 m³ = 1000 L")],
    requiredQuests: [],
  },
  ...
  },
  {
    ...
    description: L("A gas at 150,000 Pa, 0.05 m³, 300 K. Find moles."),
  ...
  },
  {
    ...
    description: L("If P = 101,325 Pa, T = 273 K, M = 0.032 kg/mol (O₂), find density ρ = PM/RT."),
    ...
    solution: {
      ...
      unit: "kg/m³",
      tolerance: 0.02,
      explanation: L("ρ = (101325)(0.032)/(8.314)(273) = 1.43 kg/m³"),
    },
  ...
  },
  {
    ...
    description: L("Find P for 10 mol at 500 K in 0.1 m³."),
  ...
  },
  {
    ...
    description: L("Find moles for gas at 10,000 Pa, 2.0 m³, 100 K."),
    problem: L("Solve for n"),
    solution: {
      type: "numerical",
      correctAnswer: 24.06,
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "m³",
      tolerance: 0.02,
      explanation: L("V = (0.1)(8.314)(300)/1000000 = 0.00025 m³"),
    },
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "m³",
      tolerance: 0.02,
      explanation: L("V = (1.0)(8.314)(298)/100000 = 0.0248 m³ = 24.8 L"),
    },
  ...
  },
  {
    ...
    description: L("If 0.032 kg gas occupies 0.0224 m³ at STP, find molar mass M = m/n."),
    ...
    solution: {
      ...
      unit: "kg/mol",
      tolerance: 0.02,
      explanation: L("n = 1.0 mol at STP, so M = 0.032/1.0 = 0.032 kg/mol (O₂)"),
    },
    hints: [L("At STP, 0.0224 m³ = 1 mol")],
    requiredQuests: [],
  },
  {
    id: "IGE-C-19",
    ...
    description: L("For isothermal expansion, W = nRT ln(V₂/V₁). If n=1, T=300K, V doubles, find W."),
...
export const GAS_MIXTURES_QUESTS: Quest[] = [
  // ADVANCED Quests (15)
  {
    ...
    description: L("N₂ at 60 kPa and O₂ at 40 kPa are in a container. Find total pressure."),
    problem: L("Use P_total = P₁ + P₂"),
    solution: {
      type: "numerical",
      correctAnswer: 100,
      unit: "kPa",
  ...
  },
  {
    ...
    description: L("In a mixture, N₂ has mole fraction 0.8. If total pressure is 100 kPa, find P(N₂)."),
    ...
    solution: {
      ...
      unit: "kPa",
      tolerance: 0.02,
      explanation: L("P(N₂) = 0.8 × 100 = 80 kPa"),
    },
  ...
  },
  {
    ...
    description: L("A mixture has 2 mol N₂ and 3 mol O₂. Find mole fraction of N₂."),
    problem: L("χ = n_i / n_total"),
    solution: {
      type: "numerical",
      correctAnswer: 0.4,
      tolerance: 0.02,
      explanation: L("χ(N₂) = 2/(2+3) = 0.4"),
    },
  ...
  },
  {
    ...
    description: L("In a mixture, χ(N₂) = 0.7, χ(O₂) = 0.2. Find χ(Ar)."),
  ...
  },
  {
    ...
    description: L("At 100 kPa total, N₂ is 80 kPa. If total moles = 5, find moles of N₂."),
    ...
    solution: {
      ...
      unit: "mol",
      tolerance: 0.02,
      explanation: L("χ = 80/100 = 0.8, so n(N₂) = 0.8 × 5 = 4.0 mol"),
    },
  ...
  },
  {
    ...
    description: L("1 mol He and 2 mol Ne at 300 K in 0.1 m³. Find total pressure."),
  ...
  },
  {
    ...
    solution: {
      ...
      unit: "kPa",
      tolerance: 0.02,
      explanation: L("P₂ = P₁(n₂/n₁) = 100(3/2) = 150 kPa"),
    },
  ...
  },
  {
    ...
    description: L("Dry air at 100 kPa. Water vapor added with P(H₂O) = 3 kPa. Find new total pressure."),
  ...
  },
  {
    ...
    description: L("A mixture has χ₁ = 0.4, χ₂ = 0.35, χ₃ = 0.25. Is this valid?"),
  ...
  },
  {
    ...
    description: L("Air: 80% N₂ (M=28 g/mol), 20% O₂ (M=32 g/mol). Find average M."),
  ...
  },
  {
    ...
    description: L("Graham's Law: rate₁/rate₂ = √(M₂/M₁). If M₁=4, M₂=16, find rate ratio."),
    problem: L("Calculate rate₁/rate₂"),
    solution: {
      type: "numerical",
      correctAnswer: 2.0,
      tolerance: 0.02,
      explanation: L("rate₁/rate₂ = √(16/4) = 2.0"),
    },
  ...
  },
  {
    ...
    description: L("(P + a/V²)(V - b) = RT for 1 mol. What do 'a' and 'b' represent?"),
  ...
  },
  {
    ...
    description: L("2H₂ + O₂ → 2H₂O. Start: 2 mol H₂, 1 mol O₂ at 300 kPa. After reaction, find P(H₂O)."),
    problem: L("All reactants consumed, 2 mol H₂O formed"),
    solution: {
      type: "numerical",
      correctAnswer: 200,
      unit: "kPa",
      tolerance: 0.02,
      explanation: L("2 mol H₂O from 3 mol total: P = (2/3) × 300 = 200 kPa"),
    },
  ...
  },
  {
    ...
    problem: L("Use Graham's Law: t₂/t₁ = √(M₂/M₁)"),
    solution: {
      type: "numerical",
      correctAnswer: 20,
      unit: "s",
      tolerance: 0.02,
      explanation: L("t₂ = 10 × √(16/4) = 20 s"),
    },
  ...
  },
  {
    ...
    description: L("Basel air: N₂ 78%, O₂ 21%, Ar 1% at 101 kPa. Find P(O₂)."),
    ...
    solution: {
      ...
      unit: "kPa",
      tolerance: 0.02,
      explanation: L("P(O₂) = 0.21 × 101 = 21.2 kPa"),
    },
