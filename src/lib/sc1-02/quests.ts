...
export function generateMolarMassQuests(t: any, difficulty: Difficulty): SC102Quest[] {
    ...
    for (let i = 0; i < 60; i++) {
        ...
        quests.push({
            ...
            targetLatex: `\\text{${t("sc1_02.labels.molar")}}`,
            slots: [{ id: "M", labelLatex: `\\text{${t("sc1_02.labels.molar")}}`, placeholder: t("sc1_02.placeholders.g_per_mol"), expected: mass }],
...
export function generateStoichiometryQuests(t: any, difficulty: Difficulty): SC102Quest[] {
    ...
    for (let i = 0; i < 60; i++) {
        ...
        quests.push({
            ...
            targetLatex: `\\text{${t("sc1_02.labels.amount")}}`,
            slots: [{ id: "n", labelLatex: `\\text{${t("sc1_02.labels.amount")}}`, placeholder: t("sc1_02.placeholders.mol"), expected: result }],
...
export function generateYieldQuests(t: any, difficulty: Difficulty): SC102Quest[] {
    ...
    for (let i = 0; i < 60; i++) {
        ...
        quests.push({
            ...
            targetLatex: `\\text{${t("sc1_02.labels.mass")}}`,
            slots: [{ id: "m", labelLatex: `\\text{${t("sc1_02.labels.mass")}}`, placeholder: t("sc1_02.placeholders.g"), expected: yield_val }],
