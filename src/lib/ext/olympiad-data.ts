...
export const buildOlympiadPool = (t: Translate, difficulty: Difficulty, stage: string): OlympiadQuest[] => {
    ...
    if (difficulty === "BASIC") {
        pool.push({
            ...
            slots: [{ id: "ans", labelLatex: "\\text{Winner}", placeholder: placeholder("name"), expected: "Charlie" }],
        ...
        pool.push({
            ...
            slots: [{ id: "ans", labelLatex: "\\text{Color}", placeholder: placeholder("color"), expected: "Red" }],
        ...
        pool.push({
            ...
            targetLatex: "\\text{Day}",
            slots: [{ id: "ans", labelLatex: "\\text{Day}", placeholder: placeholder("day"), expected: "Friday" }],
    ...
    if (difficulty === "CORE") {
        ...
        pool.push({
            ...
            slots: [{ id: "ans", labelLatex: "\\text{A is a}", placeholder: placeholder("knight_knave"), expected: "knave" }],
    ...
    if (difficulty === "ADVANCED") {
        ...
        pool.push({
            ...
            slots: [{ id: "ans", labelLatex: "\\text{Who?}", placeholder: placeholder("suspect"), expected: "C" }],
            correctLatex: "\\text{C}",
