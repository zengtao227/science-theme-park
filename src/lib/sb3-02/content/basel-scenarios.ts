/**
 * SB3.02 Biodiversity Module - Basel Regional Scenarios
 * 4 scenarios: Basel Zoo, Rhine River, Botanical Garden, Swiss Alps
 * Each scenario is 150-250 words in EN/CN/DE
 */

import { BaselScenario } from '../types';

export const baselScenarios: BaselScenario[] = [
  {
    id: 'basel-zoo',
    title: {
      en: 'Basel Zoo Conservation Programs',
      cn: '巴塞尔动物园保护计划',
      de: 'Basler Zoo Schutzprogramme',
    },
    content: {
      en: 'Basel Zoo, founded in 1874, is one of the oldest and most respected zoos in Europe. The zoo plays a crucial role in ex-situ conservation through its breeding programs for endangered species. Notable successes include the breeding of Indian rhinoceros, Somali wild ass, and various primate species. The zoo participates in over 40 European Endangered Species Programs (EEP), coordinating breeding efforts across multiple institutions. Beyond breeding, Basel Zoo conducts research on animal behavior, genetics, and veterinary medicine. The zoo also supports in-situ conservation projects in Madagascar, South America, and Africa. Educational programs reach over 50,000 students annually, teaching biodiversity concepts through interactive exhibits. The zoo\'s commitment to conservation extends to its sustainable operations, including renewable energy use and waste reduction. Recent initiatives focus on reintroduction programs, where zoo-bred animals are prepared for release into protected habitats. Basel Zoo demonstrates how modern zoos serve as biodiversity arks, preserving genetic diversity while inspiring public engagement in conservation.',
  ...
  },
  {
    id: 'rhine-river',
    title: {
      en: 'Rhine River Ecosystem Biodiversity',
      cn: '莱茵河生态系统生物多样性',
      de: 'Rhein-Ökosystem Biodiversität',
    },
    content: {
      en: 'The Rhine River flowing through Basel represents a remarkable biodiversity recovery story. Following severe pollution in the 1960s-1980s, including the catastrophic Sandoz chemical spill in 1986, the Rhine has undergone dramatic ecological restoration. Today, over 60 fish species inhabit the Basel section, including returning salmon after decades of absence. The riparian zones support diverse bird populations, with over 100 species recorded, including kingfishers, herons, and cormorants. Aquatic invertebrates serve as bioindicators of water quality, with mayflies and caddisflies indicating improved conditions. The river provides crucial ecosystem services: water purification, flood regulation, recreation, and transportation. Riverside vegetation creates green corridors connecting urban and rural habitats, facilitating species movement. Conservation challenges include maintaining water quality, managing invasive species like the quagga mussel, and balancing human use with ecological needs. The Rhine Action Program demonstrates successful international cooperation in river management. Ongoing monitoring tracks biodiversity trends, informing adaptive management strategies. The Rhine exemplifies how degraded ecosystems can recover through sustained conservation efforts and stakeholder collaboration.',
  ...
  },
  {
    id: 'botanical-garden',
    title: {
      en: 'Basel Botanical Garden Species Collection',
      cn: '巴塞尔植物园物种收藏',
      de: 'Basler Botanischer Garten Artensammlung',
    },
    content: {
      en: 'The University of Basel Botanical Garden, established in 1589, maintains one of Switzerland\'s most significant plant collections with over 7,500 species. The garden serves multiple conservation functions: living collections preserve rare and endangered plants, seed banking safeguards genetic diversity, and research programs study plant biology and ecology. Notable collections include alpine plants from Swiss mountains, Mediterranean species, and tropical plants in climate-controlled greenhouses. The garden participates in international plant conservation networks, exchanging seeds and knowledge with botanical institutions worldwide. Ex-situ conservation efforts focus on Swiss endemic species threatened by climate change and habitat loss. The garden\'s seed bank stores thousands of accessions, providing insurance against extinction. Educational programs teach plant identification, ethnobotany, and conservation importance. Research projects investigate plant adaptation to environmental change, pollinator relationships, and medicinal plant properties. The garden demonstrates sustainable horticulture practices, including water conservation, organic pest management, and native plant landscaping. As urban green space, it provides ecosystem services and biodiversity habitat within the city. The botanical garden exemplifies how plant collections contribute to global biodiversity conservation while serving education and research.',
  ...
  },
  {
    id: 'swiss-alps',
    title: {
      en: 'Swiss Alps Biodiversity Hotspots',
      cn: '瑞士阿尔卑斯山生物多样性热点',
      de: 'Schweizer Alpen Biodiversitäts-Hotspots',
    },
    content: {
      en: 'The Swiss Alps near Basel, including the Jura Mountains, represent critical biodiversity hotspots with unique alpine ecosystems. These high-elevation habitats support specialized species adapted to extreme conditions: cold temperatures, short growing seasons, and intense UV radiation. Alpine plant diversity is remarkable, with endemic species like Edelweiss and Alpine Aster found nowhere else. The region hosts diverse wildlife including ibex, chamois, marmots, and golden eagles. Alpine meadows provide crucial summer grazing for livestock while supporting rich insect communities, particularly butterflies and bees. Climate change poses severe threats, with warming temperatures forcing species to migrate upward, eventually running out of habitat. Glacial retreat eliminates unique cold-adapted species and alters water availability. Conservation strategies include protected areas like the Swiss National Park, habitat restoration, and climate monitoring. Research programs track species distribution shifts and ecosystem responses to warming. The Alps demonstrate high beta diversity, with species composition changing dramatically across elevation gradients. Traditional alpine agriculture maintains cultural landscapes that support biodiversity. The region exemplifies how mountain ecosystems serve as biodiversity refugia and early warning systems for climate change impacts.',
