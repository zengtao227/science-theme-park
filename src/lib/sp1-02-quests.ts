...
export function buildQuestPool(difficulty: Difficulty, stage: Stage, t?: any): SP102Quest[] {
  ...
  if (stage === "SECOND_LAW") {
    const secondLawData = {
      BASIC: [
        { prompt: "F=10 N, m=2 kg. Find a (m/s²)", answer: "5", key: "0" },
        { prompt: "F=20 N, m=5 kg. Find a (m/s²)", answer: "4", key: "1" },
        { prompt: "F=15 N, m=3 kg. Find a (m/s²)", answer: "5", key: "2" },
        { prompt: "m=10 kg, a=2 m/s². Find F (N)", answer: "20", key: "3" },
        { prompt: "m=5 kg, a=4 m/s². Find F (N)", answer: "20", key: "4" },
        { prompt: "F=30 N, a=6 m/s². Find m (kg)", answer: "5", key: "5" },
        { prompt: "F=40 N, a=8 m/s². Find m (kg)", answer: "5", key: "6" },
      ],
      CORE: [
        { prompt: "Basel tram 10000 kg accelerates at 1.5 m/s². Find F (N)", answer: "15000", key: "0" },
        { prompt: "Fasnacht float 2000 kg pushed with 1000 N. Find a (m/s²)", answer: "0.5", key: "1" },
        { prompt: "Rhine boat 1500 kg, engine thrust 3000 N. Find a (m/s²)", answer: "2", key: "2" },
        { prompt: "SBB train 50000 kg, brake force -10000 N. Find a (m/s²)", answer: "-0.2", key: "3" },
        { prompt: "Tram 12000 kg needs 2 m/s² acceleration. Find F (N)", answer: "24000", key: "4" },
        { prompt: "Car 1000 kg, net force 2000 N. Find a (m/s²)", answer: "2", key: "5" },
        { prompt: "Basel bus 8000 kg accelerates at 1 m/s². Find F (N)", answer: "8000", key: "6" },
        { prompt: "Bicycle 80 kg, force 160 N. Find a (m/s²)", answer: "2", key: "7" },
        { prompt: "Truck 5000 kg, acceleration 0.5 m/s². Find F (N)", answer: "2500", key: "8" },
      ],
      ADVANCED: [
        { prompt: "Basel tram 10000 kg, applied force 18000 N, friction 3000 N. Find a (m/s²)", answer: "1.5", key: "0" },
        { prompt: "Fasnacht float 3000 kg, push 2000 N, friction 500 N. Find a (m/s²)", answer: "0.5", key: "1" },
        { prompt: "Rhine boat 2000 kg, thrust 4000 N, water resistance 1000 N. Find a (m/s²)", answer: "1.5", key: "2" },
        { prompt: "SBB train 60000 kg, brake -15000 N, friction -3000 N. Find a (m/s²)", answer: "-0.3", key: "3" },
        { prompt: "Tram 15000 kg needs 1.8 m/s² with friction 2000 N. Find applied force (N)", answer: "29000", key: "4" },
        { prompt: "Car 1200 kg, engine 5000 N, air resistance 800 N. Find a (m/s²)", answer: "3.5", key: "5" },
        { prompt: "Basel bus 8000 kg, engine 10000 N, friction 2000 N. Find a (m/s²)", answer: "1", key: "6" },
      ],
      ELITE: [
        { prompt: "Basel tram system: 3 trams (10000, 12000, 15000 kg) all accelerate at 1.5 m/s². Total force?", answer: "55500", key: "0" },
        { prompt: "Fasnacht parade: 5 floats, each 2000 kg, each pushed with 1000 N. Total acceleration?", answer: "0.5", key: "1" },
        { prompt: "Rhine boat 2500 kg, thrust 5000 N, water resistance 20% of thrust. Find a (m/s²)", answer: "1.6", key: "2" },
      ],
    };
  ...
  if (stage === "THIRD_LAW") {
    const thirdLawData = {
      ...
      ADVANCED: [
        { prompt: "Basel tram 10000 kg accelerates at 1.5 m/s². Force on track?", answer: "15000", key: "0" },
        { prompt: "Rhine boat 2000 kg accelerates at 2 m/s². Force on water?", answer: "4000", key: "1" },
        { prompt: "Fasnacht float 3000 kg, friction 500 N, accelerates at 0.5 m/s². Force on ground?", answer: "2000", key: "2" },
        { prompt: "SBB train 50000 kg decelerates at -0.2 m/s². Force on track?", answer: "-10000", key: "3" },
        { prompt: "Rocket 5000 kg accelerates at 10 m/s². Force on exhaust gas?", answer: "50000", key: "4" },
        { prompt: "Car 1200 kg accelerates at 3 m/s². Force on road?", answer: "3600", key: "5" },
        { prompt: "Basel bus 8000 kg accelerates at 1 m/s². Force on road?", answer: "8000", key: "6" },
      ],
      ELITE: [
        ...
        { prompt: "Rhine boat 2000 kg pushes water with 4000 N. Boat accelerates at 2 m/s². Water mass pushed?", answer: "2000", key: "1" },
        { prompt: "Fasnacht float 3000 kg, ground pushes with 2000 N. Float accelerates at 0.5 m/s². Friction force?", answer: "500", key: "2" },
        { prompt: "SBB train 50000 kg, track pushes with 10000 N. Train decelerates at -0.2 m/s². Verify F=ma?", answer: "yes", key: "3" },
      ],
    };
