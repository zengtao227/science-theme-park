...
export const cnPhysics = {
    ...
    sp1_02: {
        ...
        answers: {
            no: "否",
            yes: "是",
            constant_velocity: "保持不变的速度",
            net_external_force: "外部合力",
            different_objects: "不同物体",
            west: "西"
        },
        scenarios: {
    ...
    gp2_01: {
        ...
        hints: {
            ...
            ideal_substitute_pressure: "直接把 n、R、T、V 代入 P = nRT/V。",
            ideal_substitute_moles: "使用 n = PV/(RT)，并保持压强用 Pa、体积用 m^3。",
            ideal_substitute_temperature: "先整理成 T = PV/(nR)，再代入数值。",
            ideal_substitute_pressure_high: "用给定的高温数据直接代入 P = nRT/V。",
            r_value: "使用 R = 8.314。",
            watch_units: "计算前先检查压强、体积和温度单位。",
            standard_calculation: "这是标准的理想气体直接代入题。",
            check_r_value: "确认你使用的是正确的气体常数。",
            linear_relationship: "在 V 和 n 不变时，压强与温度成正比。",
            avogadros_law: "在恒温恒压下，体积与物质的量成正比。",
            high_temperature: "体积固定时，温度越高压强越大。",
            low_temperature: "分母里的温度较低会使 n 变大。",
            high_pressure: "压强高时，气体体积更小。",
            isolate_p2: "把联合气体定律整理到 P_2 单独在一边。",
            r_value_si: "使用 R = 8.314 J/mol·K。",
            p_in_pa_v_in_m3: "压强保持 Pa，体积保持 m^3。",
            pressure_halves_volume_doubles: "恒温下压强减半，体积加倍。",
            cooling_shrinks_volume: "恒压下温度降低，体积随之减小。",
            calculate_n_then_mass: "先求 n，再乘 0.028 kg/mol。",
            volume_halves_pressure_doubles: "恒温下体积减半，压强加倍。",
            calculate_constant_first: "先算出常量 P_1V_1。",
            pressure_times_five_volume_div_five: "压强变成 5 倍，体积就变成五分之一。",
            isothermal: "波义耳定律适用于等温过程。",
            inverse_proportion: "这里压强与体积成反比。",
            two_forty_over_eighty: "先算 240 ÷ 80。",
            ten_over_two: "倍数就是 10 ÷ 2。",
            double_value: "结果正好翻倍。",
            twenty_four_hundred_over_six_hundred: "计算 2400 ÷ 600。",
            times_five: "除以 0.1 等价于乘以 10，再和 0.5 比较。",
            one_over_one_point_two_five: "体积因子是 1/1.25。",
            j_per_m3_equals_pa: "J/m^3 与 Pa 的量纲相同。",
            one_thousand_over_one_thousand: "分子分母相同，结果就是 1。",
            inverse: "使用反比例关系。",
            ln_two: "取 ln(2) ≈ 0.693。",
            compression: "在这套约定下，对气体做功的压缩过程取正。",
            intermolecular_forces_dominate: "当分子间作用最明显时，真实气体偏离最强。",
            ratio_ten: "使用 10 的压强比。",
            total_volume_two: "最终气体占据两个容器的总体积。",
            temperature_doubles_volume_doubles: "恒压下 T 加倍，V 也加倍。",
            volume_doubles_temperature_doubles: "恒压下 V 加倍，T 也加倍。",
            temperature_halves: "温度减半时，体积也减半。",
            proportional: "使用 V 与 T 的正比例关系。",
            isobaric: "查理定律要求压强恒定。",
            use_kelvin_only: "代入前必须先转成开尔文。",
            ratio_one_point_five: "比例是 3/2 = 1.5。",
            linear: "体积随绝对温度线性变化。",
            one_quarter: "100/400 = 1/4。",
            offset: "K 与 °C 之间要用 273.15 的偏移量。",
            kelvin_conversion: "先把两个温度都转成开尔文。",
            temperature_measures_ke: "平均动能与绝对温度成正比。",
            halved: "体积减半，因此温度也减半。",
            name: "判断这里对应的是哪条已命名气体定律。",
            direct_multiply: "这里直接做数值乘法即可。",
            w_equals_p_delta_v: "在等压活塞题里使用 W = PΔV。",
            proportional_short: "使用 T_2/T_1 = V_2/V_1 的正比例关系。",
            power_half: "均方根速率按 T^(1/2) 缩放。"
        },
        reasons: {
        ...
        placeholders: {
            ...
            charles_law: "查理定律",
            positive_work_on_gas: "对气体做正功",
            high_pressure: "高压",
            square_root: "平方根",
            high: "高",            v_99768: "99768",
            v_3_dot_01: "3.01",
            v_0_dot_0224: "0.0224",
            v_240_dot_56: "240.56",
            v_145495: "145495",
...
,
    gp2_02: {
        ...
        hints: {
            q_minus_w: "使用 ΔU = Q - W。",
            q_equals_du_plus_w: "整理得到 Q = ΔU + W。",
            w_equals_q_minus_du: "整理得到 W = Q - ΔU。",
            heat_loss: "系统放热时，Q 为负。",
            add_both: "减去负数等于把它加回来。",
            compression_warms: "绝热压缩会让内能升高。",
            q_net_equals_w_net: "完整循环满足 ΔU_net = 0，因此 Q_net = W_net。",
            direct_change: "当 W = 0 时，ΔU 直接等于热量变化。",
            calculate_work_first: "先算功，再代回第一定律。",
            net_gain: "做功输入大于放热时，内能净增加。",
            state_function: "内能是状态函数。",
            isochoric: "等容过程满足 W = 0。",
            cooling: "冷却会降低内能。",
            temperature_constant: "理想气体温度不变时，ΔU = 0。",
            work_done_expanding: "吸收的部分热量要用于膨胀做功。",
            heat_at_constant_pressure: "等压条件下 dH 对应传递的热量。",
            mayers_relation: "使用 Cp = Cv + R。",
            power_law: "应用绝热幂律关系。",
            calculus: "这个做功公式来自压力积分。",
            isentropic: "可逆绝热过程就是等熵过程。",
            mono_internal_energy: "单原子理想气体用 U = 1.5nRT。",
            direct_substitution: "把数值直接代入模型即可。",
            linear_relation: "这里内能与温度线性相关。",
            kinetic_energy_drops: "温度降低意味着平均动能下降。",
            diatomic_internal_energy: "取 f = 5 时，使用 U = 2.5nRT。",
            multiply_values: "仔细相乘 n、Cv 和 ΔT。",
            path_independent: "状态函数与路径无关。",
            n_cv_delta_t: "使用 ΔU = nCvΔT。",
            potential_energy: "真实气体的体积依赖来自分子间势能。",
            half: "每个有效自由度平均贡献 1/2 kT。",
            behaves_like_monatomic: "振动模冻结后会更像单原子气体。",
            also_pure_temperature_function: "对理想气体，焓也只依赖温度。",
            no_reaction_interaction: "没有反应或相互作用变化时，总 ΔU 为零。",
            isoenergetic: "理想气体若温度不变，则内能不变。",
            work_against_forces: "克服吸引力做功时，真实气体可能降温。",
            vibration_modes: "线型三原子分子有 3N-5 个振动模。",
            radiation_pressure: "光子气体压强是能量密度的三分之一。",
            monatomic: "单原子气体取 f = 3。",
            p_delta_v: "使用 W = PΔV。",
            no_displacement: "体积不变就没有边界功。",
            delta_u_zero: "理想气体等温过程满足 ΔU = 0。",
            opposite_to_expansion: "对系统做功的符号与膨胀做功相反。",
            pv_diagram: "机械功应从 PV 图中读取。",
            energy: "热量和功都属于能量。",
            negative_volume_change: "压缩时 ΔV 为负，因此系统做功为负。",
            net_expansion: "顺时针净膨胀对应系统净做正功。",
            value_8_314_times_300: "这里用 8.314 × 300 计算 RT。",
            expense_of_internal_energy: "Q = 0 时，做功来自内能下降。",
            sum: "把各段做功相加得到总功。",
            n_r_delta_t: "这个等压理想气体题可用 W = nRΔT。",
            trajectory_matters: "功取决于热力学路径。",
            logarithmic_case: "n = 1 时要改用对数形式的等温公式。",
            excluded_volume: "范德瓦耳斯修正要用 V - nb。",
            regeneration: "理想斯特林循环含两段等容回热。",
            approximation: "结果按合适精度近似。",
            second_law: "不可逆过程会产生正的熵增。"
        },
        placeholders: {
            isothermal: "等温",
            constant: "常数",
            ...
            yes_label: "是",
            negative: "负",
            polytropic_index: "多方指数",
            decreases: "减小",
            state_function: "状态函数",
            forces: "作用力",
            intermolecular_forces: "分子间作用力",
            negative_cooling: "负（降温）",
            nine_approx: "9（约）",
            positive: "正",
            pressure_label: "压强",
            joule: "焦耳",
            ...
            path: "路径",
            path_label: "路径",
            isothermal_logarithmic: "等温（对数）",
            constant_volume: "体积恒定"
        }
    },
    gp2_03: {
        title: "GP2.03 // 热机效率",
