...
,
    ...
    gp3_03: {
        ...
        prompts: {
            faraday_basic: "ΔΦ={flux}Wb, Δt={time}s，求感应电动势",
            faraday_core: "N={turns}, ΔΦ={flux}Wb, Δt={time}s，求感应电动势",
            faraday_advanced: "N={turns}, A={area}m^{2}, ΔB={field}T, Δt={time}s",
            faraday_elite: "发电机：N={turns}, A={area}m^{2}, B={field}T, f={freq}Hz",
            lenz_magnet_approaching: "磁铁 N 极靠近线圈时，感应电流方向如何？",
            lenz_magnet_leaving: "磁铁 N 极远离线圈时，感应电流方向如何？",
            lenz_field_increasing: "磁场 B 增强时，感应磁场方向如何？",
            lenz_field_decreasing: "磁场 B 减弱时，感应磁场方向如何？",
            lenz_coil_entering: "线圈进入磁场时，感应电流如何？",
            lenz_falling_magnet: "磁铁穿过线圈下落时，会发生什么？",
            lenz_rotating_coil: "线圈在磁场中旋转时，电流类型是什么？",
            lenz_moving_conductor: "导体在磁场中运动时，受力方向如何？",
            lenz_changing_current: "线圈电流增大时，感应电动势如何？",
            lenz_transformer: "原线圈输入交流电时，副线圈会出现什么效应？",
            lenz_eddy_currents: "金属板处于磁场中时，会发生什么？",
            lenz_self_inductance: "线圈电流变化时，自感电动势如何？",
            lenz_mutual_inductance: "线圈 A 电流变化时，对线圈 B 有何影响？",
            lenz_lenz_brake: "导电圆盘处于磁场中时，转动会怎样？",
            lenz_induction_heating: "线圈通交流电并靠近金属时，会发生什么？",
            lenz_maglev_train: "磁铁在导体上方运动时，力的方向如何？",
            lenz_induction_motor: "旋转磁场作用下，转子会如何运动？",
            lenz_wireless_charging: "发射线圈通交流电时，接收端会怎样？",
            lenz_metal_detector: "金属靠近线圈时，会发生哪些变化？",
            lenz_regenerative_braking: "电机作为发电机时，能量流向如何？",
            generator_basic_ac: "线圈在磁场中旋转会产生什么电流？",
            generator_basic_dc: "带换向器的发电机会输出什么电流？",
            generator_basic_frequency: "发电机频率主要取决于什么？",
            generator_basic_voltage: "发电机电压主要取决于什么？",
            generator_basic_power: "发电机功率主要取决于什么？",
            generator_core: "N={turns}, A={area}m^{2}, B={field}T, {speed}rpm，求 V",
            generator_adv_find_current: "P={power}W, V={voltage}V，求 I",
            generator_adv_find_voltage: "P={power}W, I={current}A，求 V",
            generator_adv_find_power: "V={voltage}V, I={current}A，求 P",
            generator_elite: "{type} 发电机效率 {efficiency}%，输入功率 {input}W",
