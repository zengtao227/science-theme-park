...
,
    gp2_02: {
        ...
        prompts: {
            ...
            q_ie_b3: "理想气体温度加倍。U 变为几倍？",
            q_ie_b5: "气体冷却，T 降低。U 如何变化？",
            q_ie_c3: "ΔU 取决于路径还是状态？",
            q_ie_a1: "真实气体：U 取决于 T 和 V。为何与 V 有关？",
            ...
            q_ie_a2: "能量均分定理：每个自由度的能量？",
            q_ie_a3: "低温下振动模式冻结。双原子气体 Cv → ？",
            q_ie_a4: "理想气体 U 仅取决于 T。焓 H 是否也如此？",
            q_ie_a5: "两种理想气体在相同温度下混合。ΔU？",
            q_ie_e1: "焦耳膨胀（真空）。理想气体 dT？",
            q_ie_e2: "真实气体焦耳膨胀。dT 通常如何变化？",
            q_ie_e3: "高温下CO₂（线型三原子）的自由度？（平动3+转动2+振动4）",
            q_ie_e4: "内能密度 u = U/V。光子气体 u = aT^{4}，P = u/3。状态方程？",
            q_ie_e5: "比热比 g = Cp/Cv，如何用自由度 f 表示？",
