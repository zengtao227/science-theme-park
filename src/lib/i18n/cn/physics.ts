...
,
    gp2_02: {
        ...
        prompts: {
            ...
            q_fl_b5: "系统吸收50 J热量，对系统做功20 J (W=-20)。ΔU？",
            q_fl_c3: "等容冷却：Q = -100 J，W = 0。ΔU？",
            ...
            q_fl_c4: "等压膨胀：Q=500 J，P=100 Pa，ΔV=2 m³。求ΔU？",
            q_fl_c5: "W = -100 J（压缩），Q = -50 J（冷却）。ΔU？",
            q_fl_a1: "循环：路径A (W=10, Q=50)，路径B（返回）？ΔU=0。",
            q_fl_a2: "ΔU = nCv dT。若n=1，Cv=12.5，ΔT=10，W=0，求Q。",
            q_fl_a3: "绝热膨胀 W=200 J。ΔU？",
            q_fl_a4: "理想气体自由膨胀（真空）。Q=0，W=0。ΔU？",
            q_fl_a5: "水沸腾：Q=Lv×m（潜热），W=PΔV。ΔU < Q？",
            q_fl_e1: "焓 H = U + PV。等压条件下，dH = ？",
            q_fl_e2: "Cp - Cv = R。单原子气体 Cv=1.5R。Cp？",
            q_fl_e3: "绝热过程：TV^{g-1} = 常数。单原子 g=1.67，体积压缩至原来1/2。T变为几倍？",
            q_fl_e4: "多方过程 PV^n = C。功积分 ∫PdV（n≠1）。",
            q_fl_e5: "熵 dS = dQ/T。可逆绝热过程 dS = ？",
