...
,
    gp2_02: {
        ...
        prompts: {
            ...
            q_wh_b4: "符号规定：对系统做的功为正还是负？",
            q_wh_c2: "在200 Pa下从1 m³膨胀到3 m³。求功？",
            ...
            q_wh_b5: "功等于哪个图中曲线下的面积？",
            q_wh_c3: "在100 kPa下将5 L压缩到2 L。系统做的功？",
            q_wh_c4: "PV图上顺时针循环。总功的符号？",
            q_wh_c5: "P × V 的单位？Pa × m^{3} = ？",
            q_wh_a1: "等温功：n=1，T=300 K，V: 1 → 2.718 (e)。W？",
            q_wh_a2: "绝热膨胀 ΔU = -500 J。W？",
            q_wh_a3: "循环过程 A→B→A。A→B W=100，B→A W=-40。净功？",
            q_wh_a4: "1 mol理想气体等压加热10 K，系统做的功。",
            q_wh_a5: "功是路径函数还是状态函数？",
            q_wh_e1: "多方过程 n。W = (P2V2-P1V1)/(1-n)。若 n=1？",
            q_wh_e2: "范德瓦耳斯气体：P = nRT/(V-nb) - ...（忽略'a'）。从V1等温膨胀到V2，求W。",
            q_wh_e3: "斯特林循环：两条等温线，两条……？",
            q_wh_e4: "绝热功 W = (P1V1 - P2V2)/(g-1)，单原子 g=1.67，P1V1=100，P2V2=50。",
            q_wh_e5: "不可逆做功中的熵产生？",
        },
        scenarios: {
