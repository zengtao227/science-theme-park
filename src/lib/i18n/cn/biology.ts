...
export const cnBiology = {
    ...
    gb2_01: {
        ...
        scenarios: {
            basel_biomedicine: "巴塞尔大学 - 生物中心 (Biozentrum)：生物中心的研究聚焦于突触连接是如何形成和维持的。你正在参与一项识别神经元结构组成（轴突、树突和胞体）如何负责传递关键信息的研究。理解这些过程对于治疗神经退行性疾病和维持巴塞尔生命科学研究的声望至关重要。这就像是成为人体最复杂网络的电信工程师。",
            roche_neuroscience: "罗氏神经科学 - 靶向疗法：你是巴塞尔罗氏全球研发中心的一名高级药理学家，致力于一种治疗神经退行性疾病的突破性药物。你的任务是识别出神经元的哪些部分受新候选药物的影响最大。巴塞尔是全球“神经节点”，你的工作可能会改变数百万阿尔茨海默病患者的身。这种精确映射就像是为大脑绘制地图，每一根纤维都代表着人体神经系统中的一条重要道路。",
            neural_plasticity: "巴塞尔大学 - 可塑性实验室：研究学习如何增强突触（长时程增强）有助于开发更好的教育工具。作为巴塞尔的一名研究员，你分析动作电位和离子浓度，以了解大脑如何重新接线。这项生物学与心理学交叉领域的工作是巴塞尔学术卓越的基石。这就像观察一座城市的群基础建设随着更多人使用特定路线和服务而扩张并加强。",
            friedrich_miescher: "弗雷德里希·米舍尔研究所 (FMI) - 分子回路：巴塞尔 FMI 的研究人员调查控制神经细胞生长和神经回路组装的分子机制。你正在分析触发神经递质释放的离子内流，这是所有思想和运动的基础。你在巴塞尔的工作有助于全球对意识基本“建筑模块”的理解。这就像是在破译人类有史以来创造的最复杂计算机的主蓝图。"
        },
        feedback: {
