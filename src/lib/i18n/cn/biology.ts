...
export const cnBiology = {
    gb1_01: {
        ...
        hints: {
            delta_p_spq_squared: "使用近似式 Δp ≈ s p q²。",
            rare_alleles: "稀有等位基因意味着 q 很小。",
            mean_fitness: "平均适合度要按基因型频率加权。",
            balanced_polymorphism: "这是平衡多态的平衡点。",
            equilibrium: "先假设处于哈代-温伯格平衡。",
            multiply_short: "把给定数值相乘。",
            divide_speed: "用经过的世代数去除。",
            inverse: "使用倒数关系。",
            one_over_2n: "使用 1/(2N)。",
            equal_sex: "假设雄性和雌性数量相等。",
            ns_less_than_one: "先判断 Ns 是否小于 1。",
            sample: "把它看作抽样概率。",
            structure: "使用群体结构公式。",
            pairwise: "从成对祖先谱系来理解。",
            k_equals_u: "在中性理论下，k 等于 u。",
            one_half_life: "这正好是 1 个半衰期。",
            two_half_lives: "这正好是 2 个半衰期。",
            three_half_lives: "这正好是 3 个半衰期。",
            one_minus_one_over_2n: "使用 1 - 1/(2N)。",
            quarter_remaining_path: "沿着连续减半的路径可得到剩余四分之一。",
            one_sixteenth_remaining: "剩余 1/16 表示经过了 4 个半衰期。",
            definition_short: "直接使用定义。",
            divide_short: "把相关量相除。",
            calculate_short: "按步骤完成计算。",
            ln_2: "记住 ln 2 ≈ 0.693。",
            corrected: "最后再应用校正因子。",
            formula: "使用题目给出的模型公式。",
            adaptive: "比值大于 1 表示适应性变化。",
            occam: "优先选择变化更少的树。",
            percentage: "把 100 次中的 95 次理解为百分比。"
        },
        feedback: {
            correct: "自然选择已确认！",
            incorrect: "进化需要更多时间..."
    ...
    gb2_02: {
        ...
        solver: {
            ...
            hormone_label: "激素：",
            gland_label: "腺体：",
            target_organs_label: "靶器官：",
            feedback_chain_label: "反馈链：",
            abnormal_labs_label: "异常化验：",
            extract_endocrine_clue: "提取内分泌线索",
            trace_endocrine_mechanism: "追踪内分泌机制",
            trace_feedback_loop: "沿着反馈环追踪刺激与反应",
            trace_clinical_pattern: "将症状与异常化验联系到对应的内分泌疾病模式",
    ...
    sb1_01: {
        ...
        solver: {
            ...
            extract_organelle_clue: "提取细胞器线索",
            trace_cell_role: "追踪细胞作用模式",
            clue_size_label: "大小线索：",
            clue_function_label: "功能线索：",
            clue_target_label: "目标线索：",
            trace_identification_pattern: "把可见大小或标志性特征与细胞器目录进行比对。",
            trace_function_pattern: "顺着题目中的细胞功能，定位执行该任务的细胞器。",
            trace_fact_pattern: "根据题目要求调用对应的细胞生物学参考事实或典型数值。",
    ...
    sb1_01_metabolic: {
        ...
        solver: {
            ...
            extract_metabolic_clue: "提取代谢线索",
            trace_regulation_pattern: "追踪调节模式",
            osmotic_status_label: "渗透状态：",
            respiration_clue_label: "呼吸线索：",
            homeostasis_clue_label: "内稳态线索：",
            trace_osmosis_pattern: "把外界张力环境与水分恢复平衡所需的移动方向对应起来。",
            trace_respiration_pattern: "沿着呼吸作用顺序，从燃料和氧气追踪到 ATP、二氧化碳和水。",
            trace_homeostasis_pattern: "把变量与设定点比较，再选择能把它拉回正常范围的反馈反应。",
    ...
    sb1_02: {
        ...
        solver: {
            ...
            extract_photosynthesis_clue: "提取光合作用线索",
            trace_photosynthesis_pattern: "追踪光合作用模式",
            clue_factor_label: "因素线索：",
            clue_structure_label: "结构线索：",
            trace_equation_pattern: "沿着配平后的方程保持反应物与产物的正确化学计量关系。",
            trace_factor_pattern: "先判断该因素如何影响限制步骤，再决定速率变化。",
            trace_chloroplast_pattern: "把具体过程对应到发生该光合作用步骤的叶绿体区域。",
    ...
    sb1_03: {
        ...
        solver: {
            ...
            extract_phase_clue: "提取分裂阶段线索",
            trace_chromosome_pattern: "追踪染色体变化模式",
            phase_label: "阶段：",
            chromosome_count_label: "相关数量：",
            trace_mitosis_pattern: "姐妹染色单体在后期之前保持配对，随后移向细胞两极。",
            trace_meiosis_i_pattern: "同源染色体先分离，而姐妹染色单体仍保持连接。",
            trace_meiosis_ii_pattern: "第二次分裂中，每个单倍体细胞里的姐妹染色单体继续分离。",
    ...
    sb1_04: {
        ...
        solver: {
            ...
            extract_plant_clue: "提取植物线索",
            trace_transport_pattern: "追踪植物运输模式",
            clue_structure_label: "结构线索：",
            clue_function_label: "功能线索：",
            trace_plant_structure_pattern: "把题目中的器官或组织与其承担的支撑、吸收或光合作用任务对应起来。",
            trace_water_transport_pattern: "沿着水分从根到叶的路径，结合木质部、蒸腾拉力和内聚张力机制判断过程。",
            trace_nutrient_transport_pattern: "沿着韧皮部中的源到库运输，判断糖分或信号在植物体内如何移动。",
    ...
    sb1_05: {
        ...
        solver: {
            ...
            extract_animal_clue: "提取动物线索",
            trace_survival_pattern: "追踪生存模式",
            animal_label: "动物：",
            scientific_name_label: "学名：",
            trace_classification_pattern: "利用体表、繁殖方式和骨骼特征判断动物所属类群。",
            trace_adaptation_pattern: "把环境挑战与提升生存率的适应特征对应起来。",
            trace_behavior_pattern: "把该行为与迁徙、繁殖或保护压力联系起来。",
    ...
    sb2_01_tissues: {
        ...
        solver: {
            ...
            extract_key_clue: "提取关键信息",
            classify_biological_level: "判断生物层级",
            tissue_clue_label: "组织线索：",
            organ_clue_label: "器官线索：",
            system_clue_label: "系统线索：",
            tissue_step: "利用组织线索匹配其核心功能或结构特征。",
            organ_step: "根据器官线索判断该器官由哪些主要组织共同构成。",
            system_step: "根据层级线索把结构放到正确的生物组织层次中。",
    ...
    sb2_02: {
        ...
        solver: {
            ...
            extract_system_clue: "提取系统线索",
            trace_system_pathway: "追踪系统通路",
            extract_key_clue: "提取关键信息",
            trace_system_role: "追踪系统作用",
            route_clue_label: "路径线索：",
            organ_clue_label: "器官线索：",
            system_clue_label: "系统线索：",
            trace_digestive_pattern: "沿着食物从摄入、消化、吸收到废物处理的流程判断对应结构。",
            trace_circulatory_pattern: "沿着血液从心脏到血管再到组织并返回的路径，匹配各结构的运输作用。",
            trace_respiratory_pattern: "沿着气流进入肺部并在肺泡完成气体交换的路径，判断缺失结构。",
            digestive_step: "沿着食物通过的路径，判断该器官承担的消化任务。",
            circulatory_step: "追踪血液如何流动或交换物质，从而识别对应结构。",
            respiratory_step: "沿着空气流动和气体交换过程，判断对应的器官或呼吸机制。",
    ...
    sb3_01: {
        ...
        prompts: {
            ...
            elite_e1: "\\\\text{辛普森指数 } D = \\\\sum (n/N)^{2} \\\\text{，莱茵河鱼类：} \\\\text{鳗鱼 50、鲑鱼 30、鲤鱼 20。总数 } N=100。\\\\text{ 计算 } 1 - D \\\\text{（多样性）。}"
        },
        results: {
            valid: "生态平衡",
            invalid: "营养级崩溃",
        ...
        solver: {
            ...
            identify_ecological_clue: "识别生态线索",
            apply_ecological_pattern: "应用生态规律",
            scenario_label: "情境：",
            stage_food_chain_step: "沿着营养级顺序，从生产者到消费者再到更高阶消费者推进。",
            stage_energy_flow_step: "把 10% 能量传递规律应用到当前营养级和下一营养级之间。",
            stage_cycles_step: "把题目给出的循环过程与生成的产物或储库对应起来。",
            stage_elite_step: "根据给出的生态模型判断需要先隔离或计算哪个量。",
    ...
    sb2_03: {
        ...
        solver: {
            ...
            list_parent_gametes: "列出亲本配子",
            build_punnett_square: "建立普内特结果",
            count_matching_offspring: "统计符合条件的后代",
            gametes_from: "来自以下亲本的配子",
            classic_dihybrid_gametes: "在标准双性状模型中，每个杂合亲本都能产生四种配子组合。",
            outcomes_label: "普内特方格结果：",
            dihybrid_outcomes_label: "经典双性状表现型比例：",
            genotype_count_label: "基因型计数：",
            phenotype_count_label: "表现型计数：",
            matching_outcomes_label: "符合条件的结果：",
            convert_ratio_label: "把比例项换算为概率",
    ...
    sb2_04: {
        ...
        solver: {
            ...
            extract_key_clue: "提取关键信息",
            classify_question_type: "判断题型",
            system_focus_label: "系统焦点：",
            organ_clue_label: "器官线索：",
            process_clue_label: "过程线索：",
            scenario_clue_label: "情境线索：",
            identification_step: "把题目描述的功能与执行该功能的器官或结构对应起来。",
            process_step: "顺着系统流程追踪物质或信号，找出对应的结构或机制。",
            coordination_step: "把调节、疾病或系统协同的线索与生理反应对应起来。",
            comprehensive_step: "先综合多个器官和过程，再确定最终答案。",
            reasoning_label: "推理：",
