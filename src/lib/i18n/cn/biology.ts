...
export const cnBiology = {
    ...
    gb2_01: {
        ...
        prompts: {
            ...
            calc_potential: "已知[K⁺]细胞外浓度为{k_out}，细胞内浓度为{k_in}，计算平衡电位。",
        ...
        scenarios: {
            basel_biomedicine: "巴塞尔大学 - 生物中心 (Biozentrum)：生物中心的研究聚焦于突触连接是如何形成和维持的。理解这些过程对于治疗神经退行性疾病至关重要。",
            roche_neuroscience: "罗氏 (Roche) 神经科学研究：巴塞尔罗氏的科学家通过针对特定的神经递质受体和离子通道，开发治疗阿尔茨海默病和帕金森病的药物。",
            neural_plasticity: "神经可塑性实验室：研究学习如何增强突触（长时程增强，LTP）有助于开发更好的教育工具和康复策略。",
            friedrich_miescher: "弗雷德里希·米舍尔研究所 (FMI)：巴塞尔 FMI 的研究人员调查控制神经细胞生长和神经回路组装的分子机制。"
        },
        feedback: {
