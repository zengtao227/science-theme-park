...
export const cnBiology = {
    gb1_01: {
        ...
        prompts: {
            ...
            fitness_calc: "种群：初始 {init} 个体，存活 {surv} 个。求相对适合度 w。",
            hardy_p: "哈代-温伯格定律：等位基因频率 p = {p}。求杂合度 2pq。",
            hardy_q: "哈代-温伯格定律：q² = {q2}。求等位基因频率 q。",
            drift_time: "遗传漂变：有效种群大小 N = {N}。求固定时间 t（以代为单位）。",
            mutation_div: "每代突变率 u = {u}。求遗传分化度 D。",
            decay_age: "放射性测年：剩余比例 f = {f}，半衰期 h = {h} 年。求年龄 A。",
            common_ancestor: "遗传分化度 D = {n}，替换速率 r = {r}。求共同祖先时间 T。",
            ns_c3: "初始 100，存活 100。选择系数 s？",
            ns_c4: "初始 100，存活 80。求选择系数 s。",
            ns_c5: "初始 20，存活 10。求选择系数 s。",
            ns_e1: "选择系数 s=0.1（针对隐性个体）。p=0.5，q=0.5。Δp ≈ spq²？",
            ns_e3: "适合度 wAA=1，wAa=1，waa=0.5。q=0.1。平均适合度 W = 1 − sq²？",
            ns_e4: "杂合子优势：wAA=0.8，wAa=1，waa=0.5。平衡时 q？",
            ns_e5: "突变-选择平衡：u=1e-5，s=0.1。q = √(u/s)？",
            sp_b1: "100 代，突变率 0.001。遗传分化度 D？",
            sp_b2: "500 代，突变率 0.002。分化度 D？",
            sp_b3: "1000 代，突变率 1×10⁻⁴。分化度 D？",
            sp_b4: "遗传分化度 D=0.2，经过 100 代。突变率 u？",
            sp_b5: "突变率每代 0.01。达到 D=1 需要几代？",
            sp_c4: "遗传漂变：新突变固定概率。N=100，P = 1/2N。求 P。",
            sp_c5: "N=500。新突变固定概率？",
            sp_a4: "瓶颈效应：N 缩减至 10。杂合度保留因子（1 − 1/2N）？",
            sp_a5: "有效种群大小：Nm=100，Nf=100。Ne = 4NmNf/(Nm+Nf)？",
            sp_e1: "漂变与自然选择比较：s=0.01，N=10。计算 Ns 并判断遗传漂变还是自然选择占主导（判断标准：Ns≪1→漂变；Ns≫1→选择）。",
            sp_e2: "奠基者效应：k=1 个体，p=0.5。等位基因丢失概率 (1−p)^{2k}？",
            sp_e3: "Fst 指数：Ht=0.5，Hs=0.4。Fst = (Ht−Hs)/Ht？",
            sp_e4: "溯祖时间：k=2 谱系。期望时间 = 4N / k(k−1)。系数为？",
            sp_e5: "中性理论：替换速率等于突变率 u？",
            ev_c1: "铀-238 / 铅-206 测年。半衰期 45 亿年，母核:子核 = 1:1。年龄（十亿年）？",
            ev_c2: "母核:子核 = 1:3（母核剩余 25%）。年龄（以半衰期为单位）？",
            ev_c3: "K-Ar 测年。半衰期 12.5 亿年，剩余 12.5% K。年龄（十亿年）？",
            ev_c4: "碳-14。剩余 50%，半衰期 5730 年。年龄 = 1 个半衰期？",
            ev_c5: "碳-14。剩余 6.25%。经过了几个半衰期？",
            ev_a1: "衰变常数 λ = 0.693 / T½。T½ = 6930。求 λ。",
            ev_a2: "N(t) = N₀ e^{−λt}。t = 1/λ。剩余比例？",
            ev_a3: "剩余 30%，半衰期 100 年。年龄 = −100 × log₂(0.3)？",
            ev_a4: "等时线测年：斜率 m = e^{λt} − 1，m=1。求 λt。",
            ev_a5: "碳库波动：校正系数 10%，表观年龄 1000 年 → 校正后年龄？",
            ev_e1: "分子系统发育：Jukes-Cantor 距离 K = −0.75 ln(1 − 4p/3)，p=0.25。K？",
    ...
    gb2_01: {
        ...
        prompts: {
            ...
            hint_calcium: "钙离子 (Ca^{2}^+) 的进入触发囊泡融合。",
        ...
        scenarios: {
            ...
            friedrich_miescher: "弗雷德里希·米舍尔生物医学研究所（FMI）- 神经发育与表观遗传学：在由诺华资助的FMI研究所，你致力于理解神经回路在发育过程中如何自我组装。你的项目研究钙信号在神经肌肉接头处神经递质释放中的作用。使用荧光钙指示剂和高速成像技术，你可视化Ca^{2}^+通过电压门控钙通道的内流如何触发突触囊泡融合，将乙酰胆碱释放到突触间隙（宽度20-40纳米）。你测量量子释放事件，并计算不同刺激方案下的释放概率。这项基础研究致敬了弗雷德里希·米舍尔的遗产——他于1869年在巴塞尔大学医院研究手术绷带中的白细胞核时发现了DNA。今天，FMI延续了这一开创性分子生物学传统，其研究成果为罗氏和诺华的药物开发提供信息。在分子水平上理解突触传递对于治疗重症肌无力、兰伯特-伊顿综合征和其他神经肌肉疾病至关重要。"
        },
        feedback: {
    ...
    sb1_01_metabolic: {
        ...
        prompts: {
            ...
            resp_atp_product: "ATP——三磷酸腺苷",
            resp_glucose_input: "C₆H₁₂O₆——葡萄糖（每循环1分子）",
            resp_oxygen_input: "O₂——每分子葡萄糖需6个氧分子",
            resp_co2_product: "CO₂——二氧化碳，在柠檬酸循环中产生",
            resp_water_product: "H₂O——水，在电子传递链末端由H⁺与O₂结合产生",
            resp_atp_count: "约30–32个ATP——有氧呼吸每分子葡萄糖总产量",
            resp_glycolysis_atp: "2个ATP（净值）——糖酵解阶段",
            resp_krebs_atp: "2个ATP（以GTP形式）——柠檬酸循环，每分子葡萄糖",
            resp_etc_atp: "约25个ATP——电子传递链产生",
            resp_nadh_count: "每分子葡萄糖共10个NADH（糖酵解2个 + 柠檬酸循环8个）",
            resp_nadh_atp: "NADH → 约2.5个ATP（经电子传递链）",
            resp_fadh2_atp: "FADH₂ → 约1.5个ATP（经电子传递链）",
            resp_glycolysis_location: "细胞质基质",
            resp_krebs_location: "线粒体基质",
            resp_etc_location: "线粒体内膜",
            resp_proton_gradient: "H⁺梯度——跨线粒体内膜，驱动ATP合酶",
            resp_atp_synthase: "ATP合酶——复合物V；利用H⁺梯度合成ATP",
            resp_final_acceptor: "O₂——分子氧，最终电子受体",
            resp_anaerobic_atp: "2个ATP（净值）——无氧糖酵解，无需O₂",
            resp_fermentation_product: "乳酸（乳酸发酵）或乙醇 + CO₂（酒精发酵）",
            home_body_temp: "体温调节 — 调定点：37°C",
            home_blood_ph: "血液pH稳态 — 正常范围：7.35–7.45",
            home_blood_glucose: "血糖调节 — 正常值：4–6 mmol/L",
            home_heart_rate: "心率调节——交感神经（加速）/ 副交感神经（减速）",
            home_blood_pressure: "血压调节 — 正常值：120/80 mmHg",
            home_insulin_effect: "胰岛素——降低血糖（来自胰岛β细胞）",
            home_glucagon_effect: "胰高血糖素——升高血糖（来自胰岛α细胞）",
            home_sweat_response: "排汗——蒸发散热，降低体温",
            home_shiver_response: "寒战——产热性骨骼肌活动，升高体温",
            home_kidney_function: "肾脏功能——滤过、重吸收、分泌；调节水和pH",
            home_negative_feedback: "负反馈——维持稳态的调节回路机制",
            home_set_point: "调定点——稳态系统的目标生理参考值",
            home_receptor_type: "感受器／传感器——检测实际值，传递偏差信号",
            home_effector_organ: "效应器——执行纠正反应（如肌肉、汗腺）",
            home_control_center: "控制中枢——整合信号、协调反应（如下丘脑）",
            home_adh_function: "ADH（抗利尿激素）——增加肾小管对水的重吸收",
            home_aldosterone_function: "醛固酮——促进Na⁺重吸收和K⁺排出，调节血压",
            home_parathyroid_function: "甲状旁腺激素（PTH）——升高血钙浓度",
            home_thyroid_function: "甲状腺激素（T3/T4）——调节代谢与生长发育",
            home_cortisol_function: "皮质醇——肾上腺皮质应激激素，升高血糖",
            hint_atp_product: "ATP（三磷酸腺苷）是细胞呼吸的直接能量产物",
            hint_glucose_input: "一分子葡萄糖（C₆H₁₂O₆）是细胞呼吸的起始底物",
            hint_oxygen_input: "电子传递链需要O₂作为最终电子受体（每分子葡萄糖需6个O₂）",
            hint_co2_product: "CO₂在柠檬酸循环中产生，是有机物氧化分解的废弃物，经肺呼出",
            hint_water_product: "细胞有氧呼吸在电子传递链末端，H⁺与O₂结合生成H₂O",
            hint_atp_count: "有氧呼吸每分子葡萄糖共产生约30–32个ATP",
            hint_glycolysis_atp: "糖酵解净产生2个ATP和2个NADH（每分子葡萄糖）",
            hint_krebs_atp: "柠檬酸循环每分子葡萄糖产生2个ATP（以GTP形式）、6个NADH和2个FADH₂",
            hint_etc_atp: "电子传递链（ETC）通过氧化磷酸化产生约25个ATP",
            hint_nadh_count: "糖酵解和柠檬酸循环共产生10个NADH（每分子葡萄糖）",
            hint_nadh_atp: "每个NADH经电子传递链可产生约2.5个ATP",
            hint_fadh2_atp: "每个FADH₂经电子传递链可产生约1.5个ATP",
            hint_glycolysis_location: "糖酵解发生在细胞质基质中，不需要线粒体",
            hint_krebs_location: "柠檬酸循环（克雷布斯循环）发生在线粒体基质中",
            hint_etc_location: "电子传递链位于线粒体内膜上",
            hint_proton_gradient: "线粒体内膜两侧的H⁺浓度梯度为ATP合酶提供驱动力",
            hint_atp_synthase: "ATP合酶利用线粒体内膜两侧的质子梯度合成ATP",
            hint_final_acceptor: "O₂（分子氧）是细胞有氧呼吸电子传递链的最终电子受体",
            hint_anaerobic_atp: "无氧糖酵解每分子葡萄糖净产生2个ATP，无需氧气",
            hint_fermentation_product: "乳酸发酵产物为乳酸；酒精发酵产物为乙醇和CO₂",
            hint_body_temp: "人体核心体温约37°C，由下丘脑通过负反馈调节",
            hint_blood_ph: "正常血液pH值为7.35–7.45；偏低为酸中毒，偏高为碱中毒",
            hint_blood_glucose: "血糖浓度由胰岛素（降低）和胰高血糖素（升高）共同调节",
            hint_heart_rate: "心率由交感神经（加速）和副交感神经（减速）调节",
            hint_blood_pressure: "血压由心输出量、外周阻力和肾功能共同调节",
            hint_insulin_effect: "胰岛素由胰岛β细胞分泌，促进组织细胞摄取葡萄糖，降低血糖",
            hint_glucagon_effect: "胰高血糖素由胰岛α细胞分泌，通过促进糖原分解升高血糖",
            hint_sweat_response: "排汗通过汗液蒸发带走热量，降低体温",
            hint_shiver_response: "寒战通过骨骼肌快速不自主收缩产热，升高体温",
            hint_kidney_function: "肾脏通过滤过、重吸收和分泌调节水平衡、电解质平衡和pH值",
            hint_negative_feedback: "负反馈调节使偏离调定点的偏差得到纠正，维持稳态",
            hint_set_point: "调定点是稳态系统维持的目标生理参数值",
            hint_receptor_type: "感受器（受体）检测机体的实际状态，并将偏差信号传至控制中枢",
            hint_effector_organ: "效应器（如肌肉、腺体）接受调控指令并执行纠正反应",
            hint_control_center: "控制中枢（如下丘脑）整合传入信号并协调机体反应",
            hint_adh_function: "ADH（抗利尿激素）增加肾小管和集合管对水的重吸收",
            hint_aldosterone_function: "醛固酮促进肾小管重吸收Na⁺，同时促进K⁺排出",
            hint_parathyroid_function: "甲状旁腺激素（PTH）通过促进骨吸收和肾重吸收来升高血钙",
            hint_thyroid_function: "甲状腺激素（T3/T4）调节基础代谢率、生长发育和神经系统功能",
            hint_cortisol_function: "皮质醇是肾上腺皮质分泌的应激激素，可升高血糖并抑制炎症"
        },
        latex_labels: {
            water_movement: "水分移动",
            product: "产物",
    ...
    sb1_02: {
        ...
        prompts: {
            reactant: "完成方程式：6CO_2 + 6H_2O + 光能 → C_6H_1_2O_6 + 6{O_2}。缺少的反应物数量是多少？",
            hint_oxygen: "计算方程式两边的氧原子数",
            glucose: "{co2}个CO_2分子能产生多少个葡萄糖分子？",
            hint_glucose: "CO_2与葡萄糖的比例为6:1",
    ...
    sb1_04: {
        ...
        scenarios: {
            ...
            nutrient_transport: "先正达作物科学研究 - 植物营养部门：你正在巴塞尔附近的先正达研究设施工作，研究作物植物中的养分运输以提高农业生产力。叶片光合作用产生的糖分通过韧皮部组织运输到生长区域（分生组织）、储存器官（根、块茎、果实）和代谢活跃的组织。这个过程称为转运，遵循压力流假说：源组织（成熟叶片）中的高糖浓度产生高渗透压，而汇组织（根、果实、生长尖端）中的低糖浓度产生低渗透压，驱动韧皮部汁液从源到汇的整体流动。韧皮部装载可以是共质体的（通过胞间连丝）或质外体的（通过膜转运蛋白）。理解养分运输帮助巴塞尔的农业公司开发肥料、优化作物产量以及培育具有改进养分分配的植物。这项研究支持瑞士的可持续农业和粮食安全。"
        },
        objective_title: "植物分析",
        complete: "模块完成！",
        check: "验证",
        next: "下一挑战",
        correct: "结构验证成功",
    ...
    sb1_05: {
        ...
        scenarios: {
            ...
            rhine_river: "莱茵河生态系统研究：你是巴塞尔大学研究团队的一员，正在研究莱茵河生态系统。莱茵河流经巴塞尔，尽管是欧洲最繁忙的水道之一，但仍支持多样化的水生和河岸生物。你的团队正在记录不同动物如何适应河流及其周围的生活。你正在比较三个物种：迁徙数千公里的欧洲鳗鱼（Anguilla anguilla）、在浅水中狩猎的灰鹭（Ardea cinerea）和最近重新引入的欧洲河狸（Castor fiber）。每个物种都有适应水生环境的独特适应性。鳗鱼可以在淡水和咸水中生存，鹭有专门的狩猎适应性，河狸通过筑坝改变其栖息地。你的任务：识别并解释每种动物用于在莱茵河生态系统中生存的特定适应性，并解释这些适应性如何提供生存优势。理解这些适应性有助于为维护莱茵河生物多样性的保护工作提供信息，这对巴塞尔的环境健康至关重要。",
            alpine_animals: "瑞士阿尔卑斯山生物多样性研究：你正在参加巴塞尔附近瑞士山区高山动物的实地研究。高山环境带来极端挑战：低氧、寒冷温度、陡峭地形和季节性食物短缺。你的研究重点是三种标志性的瑞士高山物种：具有卓越攀爬能力的阿尔卑斯山羊（Capra ibex）、冬眠6-7个月的阿尔卑斯旱獭（Marmota marmota）和在广阔领地上狩猎的金雕（Aquila chrysaetos）。每个物种都进化出了高山生存的特定适应性。山羊有分裂的蹄子以抓住岩石，旱獭有冬眠的生理适应性，鹰有在山区地形狩猎的卓越视力和飞行适应性。你的任务：分析每种动物的适应性如何具体应对高山环境的挑战（低氧、寒冷、陡峭地形、有限食物）。这项研究有助于理解气候变化如何影响高山物种，并为瑞士山区生态系统的保护策略提供信息。",
            wildlife_conservation: "巴塞尔地区野生动物保护项目：你正在与巴塞尔州自然保护办公室合作开展保护和恢复当地野生动物种群的项目。由于城市化和栖息地丧失，巴塞尔地区的野生动物在过去一个世纪中发生了重大变化。你的项目重点关注三个保护成功案例：1970年代重新引入并现在繁荣的欧洲河狸（Castor fiber）、已适应在巴塞尔高楼上筑巢的游隼（Falco peregrinus）和缓慢返回瑞士森林的欧洲猞猁（Lynx lynx）。每个物种展示了保护生物学的不同方面。河狸展示了成功的重新引入，游隼展示了城市适应，猞猁展示了自然重新定居。理解它们的行为和进化适应对保护规划至关重要。你的任务：分析每个物种的行为和进化历史如何影响保护策略，并解释为什么理解进化对有效的野生动物管理至关重要。这项工作直接促进了巴塞尔的生物多样性目标，并展示了对动物行为和进化的科学理解如何为造福野生动物和人类社区的现实世界保护决策提供信息。"
        },
        objective_title: "动物分析",
        complete: "模块完成！",
        check: "验证",
        next: "下一挑战",
        correct: "分类验证成功",
    ...
    sb2_02: {
        ...
        expressions: {
            ...
            enteric_nervous: "肠道神经系统",
            celiac: "乳糜泻",
            blood_vessels: "血管",
            gas_exchange: "气体交换",
            atria_ventricles: "2心房 + 2心室",
            blood_pressure: "血压",
            hemoglobin: "血红蛋白",
            atherosclerosis: "动脉粥样硬化",
            frank_starling: "Frank-Starling定律",
            bp_regulation: "血压调节",
            heart_failure: "心力衰竭",
            rest_exercise_co: "静息: 5升/分，运动: 25升/分",
            respiratory_pathway: "呼吸通道",
            breathing: "呼吸",
            surfactant: "表面活性剂",
            asthma: "哮喘",
            copd: "慢性阻塞性肺病",
        ...
        answers: {
            ...
            malabsorption: "吸收不良",
            comparison: "比较",
            mechanical_chemical: "物理+化学消化",
            pulmonary: "肺循环",
            pulmonary_circulation: "肺循环",
            heart_rate: "心率",
            elasticity: "弹性",
            elastic_walls: "弹性管壁吸收压力",
            varicose_veins: "静脉曲张",
            sa_node: "窦房结",
            sa_node_full: "窦房结（心房）",
            heart_attack: "心脏病发作",
            heart_attack_stroke: "心脏病发作、中风",
            stretch: "牵拉",
            increased_stretch: "牵拉增加→收缩增强",
            mechanisms: "调节机制",
            compensation: "代偿",
            cardiac_hypertrophy: "心肌肥大",
            increase: "增加",
            ...
            vibration: "振动",
            vocal_cord_vibration: "声带振动",
            collapse: "塌陷",
            alveolar_collapse: "肺泡塌陷",
            reduced_airflow: "气流减少",
            reduced_airflow_hypoxia: "气流减少，低氧血症",
            increased_breathing_rate: "呼吸频率加快",
            adaptation: "适应",
            increased_rbc: "红细胞增多",
            reduction: "减少",
            mechanical: "机械消化",
            ...
            alveoli: "肺泡",
            oxygen: "氧气",
            contracts_and_moves_down: "收缩并下移",
            hemoglobin: "血红蛋白",
            exhaled_through_lungs: "经肺呼出",
            high_co2_levels: "二氧化碳水平升高",
            left_ventricle: "左心室",
            right_atrium: "右心房",
            capillaries: "毛细血管",
            valves: "瓣膜",
            systemic_circulation: "体循环",
            red_blood_cells: "红细胞",
            systole: "收缩期",
            heart_contraction: "心脏收缩",
            ...
            nephron: "肾单位",
            filtration: "过滤",
            reabsorbed_into_blood: "重吸收到血液中",
            secretion_from_blood: "从血液分泌",
            adh: "抗利尿激素",
            urea: "尿素",
            collecting_duct: "集合管",
            bronchi: "支气管",
        ...
        hints: {
            ...
            digestive_e3: "第二大脑",
            digestive_e4: "受损绒毛",
            digestive_e5: "物理消化 vs 酶解",
            circulatory_a1: "CO = HR x SV",
            circulatory_a2: "伸展与回弹",
            circulatory_a3: "血液淤积在静脉",
            circulatory_a4: "4 个结合位点",
            circulatory_a5: "天然起搏器",
            circulatory_e1: "动脉堵塞",
            circulatory_e2: "输入越多 = 输出越多",
            circulatory_e3: "神经、激素、肾脏",
            circulatory_e4: "心脏扩大",
            circulatory_e5: "25/5 = 5",
            respiratory_a1: "网球场大小",
            respiratory_a2: "MV = TV x RR",
            respiratory_a3: "从高浓度到低浓度",
            respiratory_a4: "气流振动声带",
            respiratory_a5: "表面张力过高",
            respiratory_e1: "气道狭窄",
            respiratory_e2: "呼吸更快/更深",
    ...
    sb3_02: {
        ...
        diversity_calculator: {
            title: "物种多样性计算器",
            add_species: "添加物种",
            species_placeholder: "物种 {index}",
            total_individuals: "总个体数",
            species_richness: "物种丰富度",
            shannon_index: "香农指数 (H')",
            simpson_index: "辛普森指数 (D)",
            evenness: "均匀度 (J')",
            evenness_description: "均匀度范围从 0 到 1，1 表示完全均匀",
            formulas: "公式：",
            formula_labels: {
                shannon: "香农指数：",
                simpson: "辛普森指数：",
        ...
        ecosystem_map: {
            title: "巴塞尔地区生态系统地图",
            select_region: "选择一个区域查看详情",
            biodiversity_score: "生物多样性评分",
            key_species: "关键物种",
            threats: "威胁",
    ...
    sb2_04: {
        ...
        stages: {
            ...
            circulatory_system: "循环系统",
            excretory_system: "排泄系统"
        },
        labels: {
            anatomy_display: "解剖显示",
            input_terminal: "输入终端",
            hint: "提示",
            analysis: "系统分析",
            mouth: "口腔",
        ...
        results: {
            ...
            invalid: "系统错误",
            valid_desc: "生理功能已确认。",
            invalid_desc: "请重新计算系统响应。",
            next: "下一任务"
        },
        quests: {
            digestive: {
                basic_1: "哪个器官储存和分解食物？",
                basic_2: "大部分营养吸收发生在哪里？",
                basic_3: "哪个器官产生胆汁？",
                basic_4: "哪个器官产生消化酶和胰岛素？",
                basic_5: "哪条管道连接口腔和胃？",
                core_1: "口腔中通过咀嚼发生的是什么类型的消化？",
                core_2: "胃中分解蛋白质的是什么？",
                core_3: "胆汁对脂肪有什么作用？",
                core_4: "小肠中哪些结构增加吸收表面积？",
                core_5: "消化食物中的大部分水在哪里被吸收？",
                core_6: "推动食物通过消化道的波浪状肌肉收缩叫什么？",
                advanced_1: "为什么不同的消化酶在消化系统的不同部位工作？",
                advanced_2: "当胃酸损伤胃壁时会发生什么？",
                advanced_3: "身体如何发出释放消化酶的信号？",
                advanced_4: "什么酶缺乏导致乳糖不耐受？",
                advanced_5: "吸收的营养如何到达身体细胞？",
                elite_1: "巴塞尔马拉松跑者出现消化问题。解释运动期间血流重新分配如何影响消化。",
                elite_2: "设计一个优化整个消化系统酶功能的膳食计划。",
                elite_3: "肠道吸收：识别小肠吸收葡萄糖的主要主动运输机制 (SGLT1)。",
                elite_4: "系统效率：解释“肠肝循环”如何最大限度地提高胆汁盐在消化中的利用率。",
                elite_5: "微生物组平衡：识别大肠中纤维发酵产生的代谢副产物（短链脂肪酸）。"
            },
            respiratory: {
                basic_1: "哪条管道将空气从喉咙输送到肺部？",
                basic_2: "肺部的气体交换发生在哪里？",
                basic_3: "哪块肌肉控制呼吸？",
                basic_4: "气管的两个分支叫什么？",
                basic_5: "哪个器官过滤、加温和湿润进入的空气？",
                core_1: "吸气时膈肌会发生什么？",
                core_2: "哪种气体从肺泡进入血液毛细血管？",
                core_3: "呼气时肺容量会发生什么？",
                core_4: "红细胞中携带氧气的是什么蛋白质？",
                core_5: "二氧化碳如何从身体中排出？",
                core_6: "什么触发呼吸频率增加？",
                advanced_1: "运动期间呼吸系统如何响应增加的氧气需求？",
                advanced_2: "哮喘发作时气道会发生什么？",
                advanced_3: "身体如何适应高海拔的低氧环境？",
                advanced_4: "肺泡中的液体如何影响气体交换？",
                advanced_5: "呼吸频率如何影响血液pH值？",
                elite_1: "分析在莱茵河冷水游泳如何影响呼吸功能和氧气输送。",
                elite_2: "巴塞尔大学医院的一名患者血氧低。诊断可能的呼吸系统故障。",
                elite_3: "为巴塞尔设计一个通过呼吸练习和空气质量监测改善呼吸健康的公共卫生计划。",
                elite_4: "平衡逻辑：如果一名在莱茵河游泳的人过度通气，其 $[H^+]$ 浓度相对于 $CO_2$ 的流失会如何变化？",
                elite_5: "呼吸性酸中毒：当 $CO_2$ 潴留时，识别维持稳态的即时化学缓冲反应。"
            },
            circulatory: {
                basic_1: "哪个心室将血液泵送到全身？",
                basic_2: "哪些血管将血液从心脏输送出去？",
                basic_3: "哪个心房接收来自身体的缺氧血液？",
                basic_4: "营养和废物的交换发生在哪里？",
                basic_5: "什么防止血液在心脏中倒流？",
                core_1: "从心脏到身体再回来的循环路径叫什么？",
                core_2: "从心脏到肺再回来的循环路径叫什么？",
                core_3: "哪些血细胞携带氧气？",
                core_4: "心跳的收缩阶段叫什么？",
                core_5: "动脉中的血压是如何产生的？",
                core_6: "哪些血细胞对抗感染？",
                core_7: "哪种血液成分帮助形成凝块？",
                advanced_1: "运动期间心率如何变化，为什么？",
                advanced_2: "当动脉被斑块堵塞时会发生什么？",
                advanced_3: "身体如何防止伤口失血？",
                advanced_4: "贫血中的疲劳是什么原因？",
                advanced_5: "血流如何帮助调节体温？",
                elite_1: "解释循环系统在巴塞尔马拉松期间如何适应以满足增加的氧气需求。",
                elite_2: "一名患者有高血压。分析心血管因素并提出干预措施。",
                elite_3: "系统协调：将应对突发 pH 值下降的生理反应按从快到慢的顺序排列。",
                elite_4: "心脏力学：描述“弗兰克-斯塔林定律”及其在使心输出量与静脉回流相匹配中的作用。",
                elite_5: "血管物理学：解释血管半径的微小变化如何显著影响阻力（半径的四次方）。"
            },
            excretory: {
                basic_1: "哪些器官过滤血液以去除废物？",
                basic_2: "哪个器官储存尿液？",
                basic_3: "哪些管道将尿液从肾脏输送到膀胱？",
                basic_4: "哪条管道将尿液排出体外？",
                basic_5: "肾脏的功能单位是什么？",
                core_1: "肾单位中尿液形成的第一步是什么？",
                core_2: "肾单位中像葡萄糖这样的有用物质会发生什么？",
                core_3: "额外的废物如何添加到尿液中？",
                core_4: "哪种激素调节肾脏中的水重吸收？",
                core_5: "尿液中的主要氮废物是什么？",
                core_6: "尿液在肾单位的哪里被浓缩？",
                advanced_1: "肾脏如何帮助调节血压？",
                advanced_2: "什么导致肾结石形成？",
                advanced_3: "肾脏如何维持血液pH值？",
                advanced_4: "为什么未治疗的糖尿病会导致尿液中出现葡萄糖？",
                advanced_5: "肾脏如何响应脱水？",
                elite_1: "巴塞尔大学医院的一名患者肾衰竭。解释这如何影响整体身体稳态。",
                elite_2: "为巴塞尔设计一个通过营养和水合预防肾病的公共卫生计划。",
                elite_3: "为巴塞尔大学医院的慢性肾病患者提出治疗方案。",
                elite_4: "肾脏稳态：在代谢性酸中毒（低 pH）中，集合管中的哪种细胞类型会增加 $H^+$ 的分泌？",
                elite_5: "跨学科：利用 Henderson-Hasselbalch 方程解释为什么肾脏重吸收 $HCO_3^-$ 而不是 $CO_3^{2-}$ 来进行精确的 pH 控制。"
            }
        },
        scenarios: {
            digestive_system: "您正在分析消化系统在分解食物和吸收营养中的作用。了解器官如何协同工作有助于解释营养和健康。",
            respiratory_system: "您正在研究呼吸系统如何在空气和血液之间交换气体。这个过程对细胞呼吸和能量产生至关重要。",
            circulatory_system: "您正在检查心脏和血管如何在全身运输氧气、营养和废物。该系统维持稳态。",
            excretory_system: "您正在调查肾脏如何过滤血液和维持液体平衡。排泄系统去除代谢废物并调节身体化学。"
        }
    }
};
