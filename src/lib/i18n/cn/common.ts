...
export const cnCommon = {
    ...
    home: {
        ...
        sp3_01_subtitle: "通过巴塞尔实验室仪器掌握国际单位制、单位换算和测量精度。",
        sp3_02_title: "SP3.02 // 力与运动",
        sp3_02_subtitle: "巴塞尔之力：探索摩擦力、加速度与碰撞动力学。",
        sp3_03_title: "SP3.03 // 能量与功率",
        sp3_03_subtitle: "模拟莱茵河水力发电：势能、动能与功率输出。",
        sp3_04_title: "SP3.04 // 流体与压强",
        sp3_04_subtitle: "在巴塞尔莱茵河港口探索压强、浮力和液压系统。",
        sp3_05_title: "SP3.05 // 简单机械",
        sp3_05_subtitle: "通过巴塞尔建筑工地场景掌握杠杆、滑轮和斜面。",
        sp3_06_title: "SP3.06 // 声学原理",
        sp3_06_subtitle: "巴塞尔赌场音乐厅中的波、声音与音乐物理。",
