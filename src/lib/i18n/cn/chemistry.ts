...
export const cnChemistry = {
    ...
    sc1_06: {
        scenarios: {
            ...
            RT_BASIC_2: "在巴塞尔大学的化学实验室中，Müller 教授向她的中学生班级演示了电解实验。她使用霍夫曼电解器，将电流通过水，将其分解为氢气和氧气。学生们观察到电极上形成的泡泡——氢气的体积是氧气的两倍，这与水分子的 H₂O 比例完全吻合。这种分解反应对于生产纯氢气至关重要，罗氏（Roche）在其药物合成过程中广泛使用这些氢气。实验室位于诺华园区附近历史悠久的圣约翰区，在那里传授化学基础知识已有 150 多年的历史。学生们了解到，这种反应需要能量输入（吸热），这与释放能量的化合反应截然不同。",
            ...
            RT_BASIC_4: "在巴塞尔建筑材料实验室，工程师 Sarah 演示了石灰石（碳酸钙）分解生产生石灰（氧化钙）的过程。当在窑中加热到 900°C 时，石灰石会分解并释放二氧化碳气体。这种分解反应对于生产水泥至关重要，巴塞尔在包括罗氏塔（Roche Tower，高178米，瑞士最高建筑）和著名的诺华园区在内的大型建筑项目中广泛使用这些水泥。该实验室位于 Kleinhüningen 工业区，为巴塞尔的建筑项目测试材料。Sarah 解释说，这种反应需要大量的热能，因此是吸热反应。学生们了解到释放的 CO₂ 会导致温室气体排放，这也是巴塞尔建筑行业正在研究更多可持续替代方案的原因。",
            ...
            EB_CORE_1: "在巴塞尔水处理厂的除磷设施中，化学家 Weber 博士演示了氢氧化钙如何去除废水中的磷酸盐。这种复分解反应形成了不溶性的磷酸钙，从而从溶液中沉淀出来。配平这个含有多原子离子的方程式需要 3 个氢氧化钙分子和 2 个磷酸分子，产生 1 个磷酸钙和 6 个水分子。该设施每天处理 18 万立方米废水，去除可能会导致莱茵河藻类大量繁殖的磷酸盐。Weber 博士解释说，在处理磷酸根 (PO₄³⁻) 等基团时，将其作为整体来看待会使配平更容易。这一过程保护了巴塞尔的莱茵河河滨，那里每年有 5 万名居民进行娱乐活动。理解多原子离子的配平对于诺华和罗氏设施的药用废水处理至关重要。",
            ...
            EB_CORE_4: "在罗氏分析化学实验室，分析员 Maria 演示了铝与硫酸的反应。这种置换反应产生硫酸铝和氢气。配平这个含有多原子硫酸根离子的方程式需要 2 个铝原子和 3 个硫酸分子反应生成 1 个硫酸铝分子和 3 个氢分子。实验室使用此反应制备用于水质净化测试的硫酸铝。Maria 解释说，将硫酸根 (SO₄²⁻) 视为一个整体可以简化配平——两边各数出 3 个硫酸根基团。这一原理对于在药物合成中处理多原子离子的制药化学家至关重要。实验室每周进行 500 次分析测试，确保制药产品符合纯度标准。理解多原子离子配平有助于学生体会药物质量控制的复杂性，精确的化学计量确保了全球患者的用药安全。",
