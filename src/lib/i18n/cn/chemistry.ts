...
export const cnChemistry = {
    gc3_01: {
        ...
        solver: {
            rule_concentration: "根据勒夏特列原理，平衡会朝着抵消浓度变化的方向移动",
            rule_temperature: "升温有利于吸热方向，降温有利于放热方向",
    ...
    gc3_02: {
        ...
        solver: {
            rule_sc: "简单立方晶胞含 1 个原子，配位数为 6，堆积效率约为 52%",
            rule_bcc: "体心立方晶胞含 2 个原子，配位数为 8，堆积效率约为 68%",
            rule_fcc: "面心立方晶胞含 4 个原子，配位数为 12，堆积效率约为 74%",
            lattice_type_label: "晶格类型：",
            read_lattice_property: "根据结构类型读出题目要求的晶格性质"
        }
    },
    gc1_01: {
        placeholders: {
    ...
    gc2_01: {
        ...
        solver: {
            rule_alkanes: "利用显示的结构统计原子数、化学键，或判断分子式",
            rule_aromatics: "芳香体系由离域的 pi 电子和共振稳定性来识别",
            rule_biomolecules: "根据分子结构识别官能团或生物分子类别",
            molecule_shown_label: "显示的分子：",
            match_feature_to_concept: "将观察到的结构特征与题目要求的有机化学概念对应起来"
        }
    },
    sc1_01: {
        placeholders: {
    ...
    sc2_01: {
        ...
        prompts: {
            arr_b: "使用阿伦尼乌斯方程计算速率常数k。",
            arr_c1: "根据温度变化，计算k变化了多少。",
            arr_c2: "已知活化能降低，计算k的增幅。",
            arr_c3: "根据给定参数计算ln(k)。",
            arr_c4: "根据给定数据计算活化能E_a。",
            arr_c5: "计算催化前后k_new / k_old的比值。",
            arr_a1: "利用ln(k2/k1)求活化能E_a。",
            arr_a2: "利用阿伦尼乌斯图斜率计算E_a。",
            arr_a3: "计算指前因子A。",
            arr_a4: "计算达到目标k所需的温度T。",
            arr_a5: "根据给定条件计算k_cat。",
            arr_e1: "计算该机理的总体速率常数k_overall。",
            arr_e2: "计算压力相关速率常数k(P)。",
            arr_e3: "计算考虑隧穿修正后的k_tunnel。",
            arr_e4: "计算动力学同位素比k_H / k_D。",
            arr_e5: "计算活化吉布斯自由能Delta G double dagger。",
            rl_b: "根据速率方程数据计算反应速率。",
            rl_b4: "浓度变化后，计算新反应速率。",
            rl_b5: "计算初始反应速率rate_0。",
            rl_c2: "根据实验规律判断反应级数n。",
            rl_c3: "计算t时刻浓度[A]_t。",
            rl_c4: "计算所需反应时间t。",
            rl_c5: "根据测量数据计算速率常数k。",
            rl_a2: "计算多步反应的总体速率。",
            rl_a3: "计算稳态中间体浓度[I]_ss。",
            rl_a4: "由速率常数计算平衡常数K_eq。",
            rl_e1: "计算最大浓度[A]_max。",
            rl_e2: "计算拐点时间t_inflection。",
            rl_e3: "计算链式反应的链长。",
            rl_e4: "计算量子产率Phi。",
            rl_e5: "计算最大反应速率V_max。",
            hl_b: "计算半衰期t_1/2。",
            ...
            hl_c3: "计算t时刻剩余量N_t。",
            hl_c4: "计算剩余药物浓度[D]_t。",
            hl_c5: "计算半衰期比值t_1/2,A / t_1/2,B。",
            hl_a1: "计算达到峰值的时间t_max。",
            hl_a2: "计算总体半衰期t_1/2,overall。",
            hl_a3: "计算平衡浓度[A]_eq。",
            hl_a4: "计算350K下的半衰期。",
            hl_e1: "根据同位素数据计算样品年龄。",
            hl_e2: "计算各衰变通道的分支比。",
    ...
    sc2_02: {
        ...
        labels: {
            ...
            weak_acid: "弱酸",
            formula: "滴定公式",
            answer_target: "\\text{答案}",
            answer_slot: "答案",
            result_placeholder: "结果",
            indicator_target: "\\text{指示剂}",
            indicator_slot: "指示剂",
            indicator_placeholder: "指示剂名称",
            monitor_indicator: "指示剂",
            monitor_acid_type: "酸类型",
            ph_range: "pH 范围",
        ...
        prompts: {
            ...
            curves_basic_1: "识别滴定曲线类型。",
            curves_basic_2: "识别弱酸滴定曲线。",
            curves_basic_3: "求等当点体积。",
            curves_basic_4: "计算等当点体积。",
            curves_basic_5: "求弱酸等当点体积。",
            curves_core_1: "求等当点 pH。",
            curves_core_2: "求弱酸在等当点的 pH。",
            curves_core_3: "求强酸体系等当点 pH。",
            curves_core_4: "求缓冲区 pH。",
            curves_core_5: "求稀酸体系等当点体积。",
            curves_advanced_1: "求弱酸的 pKa。",
            curves_advanced_2: "计算高浓度体系的等当点。",
            curves_advanced_3: "估算缓冲容量对应体积。",
            curves_advanced_4: "求半等当点 pH。",
            curves_advanced_5: "精确计算等当点体积。",
            curves_elite_1: "完成复杂 pKa 计算。",
            curves_elite_2: "分析低浓度缓冲体系。",
            curves_elite_3: "求解多步骤等当点计算。",
            curves_elite_4: "求解高级缓冲体积问题。",
            curves_elite_5: "求加入 25 mL 碱时的精确 pH。",
            equivalence_basic_1: "求等当点时的 Vb。",
            equivalence_basic_2: "计算等当点 Vb。",
            equivalence_basic_3: "求等当体积 Vb。",
            equivalence_basic_4: "求达到等当点所需 Vb。",
            equivalence_basic_5: "计算该条件下的 Vb。",
            equivalence_core_1: "精确计算等当点体积。",
            equivalence_core_2: "求高浓度条件下的 Vb。",
            equivalence_core_3: "求低浓度条件下的 Vb。",
            equivalence_core_4: "完成复杂等当体积计算。",
            equivalence_core_5: "完成反向浓度体积计算。",
            equivalence_advanced_1: "求稀释条件下的 Vb。",
            equivalence_advanced_2: "按 2:1 浓度比求 Vb。",
            equivalence_advanced_3: "按反比浓度条件求 Vb。",
            equivalence_advanced_4: "高精度计算 Vb。",
            equivalence_advanced_5: "按 1:3 浓度比求 Vb。",
            equivalence_elite_1: "求复杂比例条件下的 Vb。",
            equivalence_elite_2: "求近 1:1 比例条件下的 Vb。",
            equivalence_elite_3: "求精细稀释条件下的 Vb。",
            equivalence_elite_4: "求近浓度条件下的 Vb。",
            equivalence_elite_5: "求微调条件下的 Vb。",
            indicators_basic_1: "为强酸滴定选择指示剂。",
            indicators_basic_2: "为酸性变色范围选择指示剂。",
            indicators_basic_3: "为弱酸滴定选择指示剂。",
            indicators_basic_4: "为宽 pH 范围选择指示剂。",
            indicators_basic_5: "为碱性变色范围选择指示剂。",
            indicators_core_1: "为弱酸滴定选择最佳指示剂。",
            indicators_core_2: "为酸性区间选择指示剂。",
            indicators_core_3: "为近中性弱酸条件选择指示剂。",
            indicators_core_4: "为近中性范围选择指示剂。",
            indicators_core_5: "为弱酸缓冲体系选择指示剂。",
            indicators_advanced_1: "为半等当点范围选择指示剂。",
            indicators_advanced_2: "为低 pH 条件选择指示剂。",
            indicators_advanced_3: "为高 pH 弱酸条件选择指示剂。",
            indicators_advanced_4: "为全范围检测选择指示剂。",
            indicators_advanced_5: "为弱酸等当范围选择指示剂。",
            indicators_elite_1: "为精确弱酸范围选择指示剂。",
            indicators_elite_2: "为窄酸性范围选择指示剂。",
            indicators_elite_3: "为缓冲区范围选择指示剂。",
            indicators_elite_4: "为近中性精细范围选择指示剂。",
    ...
    sc2_04: {
        ...
        prompts: {
            ...
            elite_rhine_sample: "莱茵河水样 A：处理前质量=100g，处理后=99.8g。"
        },
        scenarios: {
            ...
            elite_analysis: "莱茵河水质专家分析"
        },
        solver: {
            read_curve_rule: "在给定温度下读取溶解度曲线以确定 S",
            use_relation_to_determine: "利用上面的关系求出"
        }
    },
    sc3_01: {
        back: "返回枢纽",
        ...
        hints: {
            ...
            oxygen_is_red: "\\text{氧原子为红色。}",
            nitrogen_is_blue: "\\text{氮原子为蓝色。}",
            add_all_atoms: "\\text{将所有原子相加。}",
            count_black_spheres: "\\text{数黑色球体。}",
            smallest_white_atoms: "\\text{最小的白色原子。}",
            red_spheres: "\\text{红色球体。}",
            simplify_if_possible: "\\text{尽可能化简。}",
            carbon_over_total: "\\text{碳 / 原子总数}",
            roughly_atoms_minus_one: "\\text{大约为原子数 - 1}",
            already_simplified: "\\text{已是最简形式}",
            use_precise_masses: "\\text{使用精确原子质量}",
            exact_count_required: "\\text{需要精确计数}",
            mass_of_c_over_total: "\\text{碳的质量 / 总质量}",
        ...
        prompts: {
            ...
            find_hydrogen_count: "求 {molecule} 中氢原子数。",
            find_oxygen_count: "求 {molecule} 中氧原子数。",
            find_nitrogen_count: "求 {molecule} 中氮原子数。",
            total_atom_count: "{molecule} 的原子总数是多少？",
            verify_carbon_atoms: "核对 {molecule} 的碳原子数。",
            count_hydrogen: "统计 {molecule} 中氢原子数量。",
            oxygen_atoms: "{molecule} 中有多少个氧原子？",
            co_ratio: "{molecule} 的 C:O 比是多少？",
            approx_molar_mass: "估算 {molecule} 的摩尔质量。",
            complete_formula: "补全 {molecule} 的分子式。",
            carbon_percentage: "{molecule} 中碳元素占比是多少？",
            estimate_bond_count: "估算 {molecule} 的化学键数量。",
            simplest_ratio: "写出 {molecule} 的最简原子比。",
            precise_molar_mass: "精确计算 {molecule} 的摩尔质量。",
            identify_formula_precisely: "准确写出 {molecule} 的分子式。",
    ...
    sc3_02: {
        ...
        scenarios: {
            ...
            fragrance_design: "奇华顿巴塞尔 - 分子的艺术：你是巴塞尔奇华顿公司的一名初级调香师，与世界一级的香氛大师并肩工作。创造一种新香水是艺术直觉与有机化学之间的一场复杂舞蹈。香味中的每一个“音符”实际上都是一个特定的有机分子，通常具有赋予其特征香气的独特官能团，例如醛类的柑橘味或酯类的花香味。今天，你正在对一系列芳香分子进行分类，以便为一款新的奢侈香氛找到完美的添加成分。你的工作确保了奇华顿始终是全球气味创新的领导者，其总部就在巴塞尔。这就像成为一名画家，但你不是在画布上使用色彩，而是使用分子结构来创造嗅觉杰作，唤起人们的记忆和情感。"
        }
    },
    sc3_03: {
        back: "返回枢纽",
    ...
    sc3_04: {
        ...
        solver: {
            rule_hydroxyl: "醇类可通过羟基 -OH 识别",
            rule_carboxyl: "羧酸含有羧基 -COOH",
            rule_aldehyde: "醛类含有末端的 -CHO 基团",
            rule_ketone: "酮类在碳链内部含有羰基",
            rule_solubility: "更强的极性和与水形成氢键通常会带来更高的水溶性",
            rule_intermolecular_forces: "比较分子间作用力，判断哪种分子粒子间吸引更强",
            choose_stronger_interactions: "选择在该比较条件下因官能团而具有更强分子间作用力的分子"
        }
    },
    gc1_02: {
        placeholders: {
    ...
    sc2_05: {
        ...
        scenarios: {
            ...
            titration: "罗氏质量控制实验室——您是罗氏巴塞尔总部的质量控制分析师，通过滴定分析验证新型药物化合物的纯度。使用已校准的滴定管，逐滴将标准0.1 M NaOH溶液加入已称重并溶于水的药物样品中。pH电极持续监测溶液，生成滴定曲线。等当点处的急剧pH跳跃表示完全中和，使用的滴定剂精确体积揭示了药物浓度。任何与规定纯度（最低99.5%）的偏差都将触发全批次调查。计算等当点体积和对应纯度，并报告该批次是否通过罗氏质量标准。"
        },
        contexts: {
            PH_B1: "计算0.1 M盐酸（HCl）溶液的pH值。HCl是强酸，在水中完全解离。使用公式pH = -log[H⁺]求解结果。",
            PH_B2: "计算25°C时纯水的pH值。在该温度下，水自电离产生[H⁺] = 1×10⁻⁷ M。求中性水的pH值。",
            PH_B3: "计算0.01 M NaOH溶液的pH值。NaOH是强碱，完全解离。先求pOH，再利用pH + pOH = 14换算。",
            PH_B4: "计算0.001 M硝酸（HNO₃）溶液的pH值。硝酸是强酸。以[H⁺] = 0.001 M代入pH = -log[H⁺]求解。",
            PH_B5: "计算0.0001 M KOH溶液的pH值。KOH是强碱。先求pOH，再用pH = 14 - pOH换算为pH。",
            PH_C1: "计算弱酸CH₃COOH溶液的pH值（Ka = 1.8×10⁻⁵，C = 0.1 M）。弱酸只部分解离。使用简化公式pH = ½(pKa - log C)。",
            PH_C2: "缓冲溶液含0.1 M CH₃COOH + 0.1 M CH₃COONa。应用亨德森-哈塞尔巴赫方程：pH = pKa + log([A⁻]/[HA])，求缓冲液的pH。",
            PH_C3: "计算0.01 M NH₃溶液的pH值（Kb = 1.8×10⁻⁵）。氨是弱碱。由Kb求pOH，再换算：pH = 14 - pOH。",
            PH_C4: "混合缓冲液含0.2 M HA + 0.1 M A⁻，pKa = 5.0。应用亨德森-哈塞尔巴赫方程：pH = pKa + log([A⁻]/[HA])，求缓冲液的pH。",
            PH_C5: "计算将0.1 M HCl稀释至0.001 M后的pH值。强酸稀释100倍后，H⁺浓度等比降低。求新的pH值。",
            PH_A1: "多质子酸H₂SO₄：第一步完全解离，第二步Ka₂ = 1.2×10⁻²。计算溶液中H⁺的总浓度，进而求pH。",
            PH_A2: "应用亨德森-哈塞尔巴赫方程，已知pH = 5.5，pKa = 4.76。变形公式求出达到此pH所需的[A⁻]/[HA]比值。",
            PH_A3: "氨基酸甘氨酸在等电点（pI = 6.0）时净电荷为零。由pI = ½(pKa₁ + pKa₂)，利用已知解离常数计算pI。",
            PH_A4: "计算0.05 M H₃PO₄溶液的pH值（Ka₁ = 7.5×10⁻³）。只考虑第一步解离。使用弱酸近似法求[H⁺]。",
            PH_A5: "评估0.5 M CH₃COOH + 0.5 M CH₃COONa缓冲体系的缓冲容量。高浓度对应高缓冲容量。计算pH并确定缓冲极限。",
            PH_E1: "诺华酶促缓冲液：离子强度影响有效pKa。对0.1 M缓冲液，活度系数γ(A⁻) = 0.8，pKa（理想）= 4.76，用pKa(有效) = pKa(理想) - log(γ(A⁻))计算校正后的有效pKa。",
            PH_E2: "巴塞尔大学医院——低温治疗：血液pKa在37°C为6.1，在30°C升至6.25。若30°C时[HCO₃⁻]/[CO₂] = 20，用亨德森-哈塞尔巴赫方程计算此时的血液pH。",
            PH_E3: "肠外营养：氨基酸甘氨酸（pKa₁ = 2.35，pKa₂ = 9.78）在等电点处作为两性离子缓冲剂。求pI = ½(pKa₁ + pKa₂)，以确定最佳输注液pH。",
            PH_E4: "生理缓冲：血液pH维持在7.4。已知[HCO₃⁻] = 24 mM，pKa = 6.1，求所需P(CO₂)（mmHg）。使用亨德森-哈塞尔巴赫方程及溶解度常数α = 0.03 mM/mmHg。",
            PH_E5: "代谢性酸中毒：患者[HCO₃⁻]降至15 mM。计算通过呼吸代偿使pH达到7.1所需的P(CO₂)，为临床呼吸机参数调整提供依据。",
            NT_B1: "HCl + NaOH → NaCl + H₂O。在等摩尔酸碱条件下，计算生成NaCl的摩尔数。此1:1化学计量关系是所有中和计算的基础。",
            NT_B2: "将50 mL 0.2 M HCl与50 mL 0.2 M NaOH混合。等摩尔完全反应。确定反应后中性盐溶液的最终pH值。",
            NT_B3: "将25 mL 0.1 M H₂SO₄与50 mL 0.1 M NaOH混合。H₂SO₄是二元酸。比较H⁺和OH⁻的摩尔数，判断是否完全中和。",
            NT_B4: "将20 mL 0.15 M HNO₃与30 mL 0.1 M KOH混合。计算各反应物的摩尔数，判断中和后哪种反应物过量。",
            NT_B5: "将10 mL 0.5 M HCl与25 mL 0.2 M NaOH混合。计算最终溶液的总体积，这是求最终浓度的前提。",
            NT_C1: "酸过量情形：将30 mL 0.2 M HCl与20 mL 0.2 M NaOH混合。酸未被完全中和。计算溶液中剩余[H⁺]，求最终pH值。",
            NT_C2: "碱过量情形：将25 mL 0.1 M HCl与40 mL 0.1 M NaOH混合。碱过量。计算剩余[OH⁻]，求溶液最终pH值。",
            NT_C3: "二元酸：H₂SO₄ + 2NaOH → Na₂SO₄ + 2H₂O。确定完全中和所需的酸碱摩尔比。该1:2比例对正确化学计量至关重要。",
            NT_C4: "中和热：强酸与强碱反应的ΔH = -57.3 kJ/mol。计算一定摩尔数HCl与NaOH在绝热容器中反应放出的热量。",
            NT_C5: "混合中和：向20 mL 0.1 M HCl与20 mL 0.1 M CH₃COOH的混合液中加入40 mL 0.1 M NaOH。计算总酸摩尔数，判断NaOH是否能完全中和两种酸。",
            NT_A1: "弱酸 + 强碱：CH₃COOH + NaOH → CH₃COONa + H₂O。等当点时只剩共轭碱。利用CH₃COO⁻的Kb计算等当点pH。",
            NT_A2: "弱碱 + 强酸：NH₃ + HCl → NH₄Cl。等当点时只剩NH₄⁺。利用NH₄⁺的Ka（pKa = 14 - pKb）计算等当点pH。",
            NT_A3: "半中和：向50 mL 0.1 M CH₃COOH中加入25 mL 0.1 M NaOH，中和了一半的酸，形成缓冲溶液。用亨德森-哈塞尔巴赫方程求pH。",
            NT_A4: "多元酸中和：H₃PO₄ + 3NaOH → Na₃PO₄ + 3H₂O。计算摩尔比及完全中和一定量H₃PO₄所需NaOH的体积。",
            NT_A5: "电导滴定：等当点处所有离子结合为水和盐，电导率降至最低。在电导率-体积图上找到该最小值点即为等当点。",
            NT_E1: "血液缓冲中和：CO₂骤增产生0.02 mol H₂CO₃。计算完全中和所需OH⁻（来自药物）的摩尔数，为临床用药剂量提供依据。",
            NT_E2: "两性缓冲：H₂PO₄⁻既可作酸又可作碱。根据反应HPO₄²⁻ + H⁺ → H₂PO₄⁻，计算0.1 mol HPO₄²⁻能中和的H⁺摩尔数。",
            NT_E3: "诺华质量控制：处理酸性废液。100 L的0.05 M H₂SO₄需要中和。计算安全处置前完全中和所需Ca(OH)₂的摩尔数。",
            NT_E4: "乳酸中和：运动时0.05 mol CH₃CH(OH)COOH进入血液。计算碳酸氢盐缓冲体系消耗HCO₃⁻的摩尔数，以维持血液pH。",
            NT_E5: "肾脏代偿：肾脏通过排泄NH₄⁺来消除多余H⁺。若0.1 mol NH₄⁺随尿液排出，计算返回血液的\"新生\"HCO₃⁻摩尔数，以恢复pH。",
            TT_B1: "利用C₁V₁ = C₂V₂（滴定等当点时n₁ = n₂），求完全中和25 mL 0.1 M HCl所需0.2 M NaOH的体积。",
            TT_B2: "20 mL未知浓度HCl溶液被30 mL 0.15 M NaOH恰好中和。利用n(HCl) = n(NaOH)计算HCl的浓度。",
            TT_B3: "用0.1 M NaOH滴定50 mL 0.1 M CH₃COOH。利用n(酸) = n(碱)计算达到等当点所需NaOH的体积。",
            TT_B4: "强酸/强碱滴定的指示剂选择：等当点时pH = 7。确定合适的指示剂，并计算预期的等当点pH值。",
            TT_B5: "滴定管读数：初始读数0.50 mL，终点读数25.80 mL。用终点读数减去初始读数，计算实际加入的滴定剂体积。",
            TT_C1: "滴定曲线分析：pH从4骤升至10标志着等当点。读取曲线，在拐点处确定精确的等当点体积。",
            TT_C2: "半等当点：达到等当点需加入25 mL NaOH，在加入12.5 mL处pH = pKa。计算半等当点的pH值。",
            TT_C3: "指示剂变色范围：酚酞在pH 8.2–10.0之间变色。判断该指示剂是否适合等当点呈碱性的弱酸/强碱滴定。",
            TT_C4: "二元酸滴定：H₂SO₄有两个等当点（第一个：一个H⁺被中和；第二个：两个H⁺均被中和）。确定第一等当点处的pH值。",
            TT_C5: "精密度检查：三次滴定结果分别为24.8、25.1和24.9 mL。计算平均体积，作为分析报告的最终结果。",
            TT_A1: "弱酸滴定曲线：用0.1 M NaOH滴定0.1 M CH₃COOH（Ka = 1.8×10⁻⁵），分别计算10%、50%、90%和100%中和时的pH值。",
            TT_A2: "缓冲区间：中和程度在25%至75%之间时，pH变化仅约1个单位。在滴定曲线上找出该平坦区域，解释溶液抵抗pH变化的原因。",
            TT_A3: "多元酸H₃PO₄滴定出现三个等当点（pKa₁ = 2.15，pKa₂ = 7.20，pKa₃ = 12.35）。计算各等当点处的pH值。",
            TT_A4: "微分滴定：d(pH)/dV在等当点处取得最大值。利用微分曲线从实验数据中精确定位等当点体积。",
            TT_A5: "Gran作图法：将前等当点数据线性化，绘制V × 10^(-pH)对加入体积的图。外推x轴截距即为弱酸滴定的等当点体积。",
            TT_E1: "药典标准：对一种弱有机酸药物进行滴定，半等当点出现在pH 4.75处。确定pKa值，该数据须作为法规申报用合格证书（CoA）的必填项。",
