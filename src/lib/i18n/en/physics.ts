...
,
        ...
        sp3_06: {
                ...
                solver: {
                        medium_reason: "Sound travels faster in water because the particles are closer together and pass vibrations on more efficiently.",
                        vacuum_reason: "A vacuum contains no particles, so sound has no medium through which to travel.",
                        doppler_reason: "When the source approaches, the wavefronts are compressed and the observed frequency becomes higher.",
                        interference_reason: "If two in-phase waves cancel at a point, that point shows destructive interference.",
                        refraction_reason: "A change of medium changes sound speed and bends the wave, which is refraction.",
                        diffraction_reason: "Bending around edges or openings is diffraction.",
                        resonance_freq_reason: "Resonance occurs when the driving frequency matches the natural frequency, so",
                        hearing_range_reason: "Human hearing extends from about 20 Hz to 20000 Hz.",
                        pitch_reason: "Pitch increases when frequency increases.",
                        ultrasound_reason: "Ultrasound is above 20 kHz, so it lies above the human hearing range.",
                        infrasound_reason: "Infrasound is below 20 Hz, which is below the human hearing range.",
                        bat_echolocation_reason: "A frequency of 50000 Hz is well above the human hearing range.",
                        timbre_reason: "If two instruments share the same fundamental frequency but sound different, the differing property is timbre.",
                        earthquake_reason: "A frequency of 5 Hz lies below 20 Hz, so humans cannot hear it.",
                        critical_bands_reason: "These tones are far enough apart in frequency that the ear can distinguish them.",
                        just_intonation_reason: "the just fifth is slightly larger.",
                        formants_reason: "The resonant frequency bands that define vowel quality are called formants.",
                        missing_fundamental_reason: "The harmonic spacing is 200 Hz, so the perceived missing fundamental is 200 Hz.",
                        masking_reason: "A strong tone making a nearby frequency harder to hear is the masking effect.",
                        pain_threshold_reason: "A level near 140 dB is not safe for hearing.",
                        distance_effect_reason: "Doubling the distance quarters intensity, so the level drops by about 6 dB.",
                        safe_level_reason: "Prolonged exposure above 85 dB can cause hearing damage.",
                        distance_double_reason: "Doubling distance reduces intensity by 6 dB, so 80 dB becomes 74 dB.",
                        inverse_square_reason: "Going from 10 m to 100 m reduces intensity by 100, so the level drops by 20 dB to 40 dB.",
                        combining_sources_reason: "Two identical sources add about 3 dB, so 60 dB becomes 63 dB.",
                        absorption_reason: "Halving intensity changes the level by about -3 dB.",
                        jet_engine_reason: "Increasing distance by a factor of 10 lowers level by 20 dB, so 130 dB becomes 110 dB.",
                        four_sources_reason: "Four identical sources add about 6 dB, so 50 dB becomes 56 dB.",
                        phon_reason: "Perceived loudness level is measured in phons.",
                        sone_reason: "Doubling sones means doubling perceived loudness.",
                        a_weighting_reason: "A-weighted sound levels are written as dB(A).",
                        noise_dose_reason: "A 3 dB increase halves the safe exposure time, so 88 dB for 4 h is still a 100% dose.",
                        itu_weighting_reason: "ITU-R 468 weighting is used for perceived noise measurements, especially in audio systems.",
                        sonic_boom_reason: "Breaking the sound barrier creates a shock wave heard as a sonic boom.",
                        acoustic_impedance_reason: "A large impedance mismatch reflects most sound energy at the boundary."
                }
        },
        ...
        gp2_01: {
                ...
                hints: {
                        ...
                        ideal_substitute_pressure: "Substitute n, R, T, and V directly into P = nRT/V.",
                        ideal_substitute_moles: "Use n = PV/(RT) and keep pressure in Pa and volume in m^3.",
                        ideal_substitute_temperature: "Rearrange to T = PV/(nR) before substituting values.",
                        ideal_substitute_pressure_high: "Apply P = nRT/V directly with the given high-temperature values.",
                        r_value: "Use R = 8.314.",
                        watch_units: "Check pressure, volume, and temperature units before calculating.",
                        standard_calculation: "This is a direct ideal-gas substitution.",
                        check_r_value: "Confirm that you are using the correct gas constant.",
                        linear_relationship: "At constant V and n, pressure is directly proportional to temperature.",
                        avogadros_law: "At constant pressure and temperature, volume is proportional to amount.",
                        high_temperature: "Higher temperature raises pressure when volume is fixed.",
                        low_temperature: "Low temperature in the denominator can make n larger.",
                        high_pressure: "High pressure makes the gas occupy a smaller volume.",
                        isolate_p2: "Rearrange the combined gas law so P_2 is alone.",
                        r_value_si: "Use R = 8.314 J/mol·K.",
                        p_in_pa_v_in_m3: "Keep pressure in Pa and volume in m^3.",
                        pressure_halves_volume_doubles: "At constant temperature, halving pressure doubles volume.",
                        cooling_shrinks_volume: "At constant pressure, lower temperature gives smaller volume.",
                        calculate_n_then_mass: "Find n first, then multiply by 0.028 kg/mol.",
                        volume_halves_pressure_doubles: "At constant temperature, halving volume doubles pressure.",
                        calculate_constant_first: "Compute the constant P_1V_1 before solving.",
                        pressure_times_five_volume_div_five: "If pressure becomes 5 times larger, volume becomes one fifth.",
                        isothermal: "Boyle's law applies to isothermal processes.",
                        inverse_proportion: "Pressure and volume are inversely proportional here.",
                        two_forty_over_eighty: "Evaluate 240 ÷ 80 first.",
                        ten_over_two: "The pressure factor is 10 ÷ 2.",
                        double_value: "The result is exactly double.",
                        twenty_four_hundred_over_six_hundred: "Compute 2400 ÷ 600.",
                        times_five: "Dividing by 0.1 is the same as multiplying by 10, then compare with 0.5.",
                        one_over_one_point_two_five: "The volume factor is 1/1.25.",
                        j_per_m3_equals_pa: "J/m^3 has the same units as Pa.",
                        one_thousand_over_one_thousand: "The numerator and denominator cancel to 1.",
                        inverse: "Use the inverse relation.",
                        ln_two: "Use ln(2) ≈ 0.693.",
                        compression: "Compression means work done on the gas is positive in this convention.",
                        intermolecular_forces_dominate: "Real-gas deviations become strongest when intermolecular forces matter most.",
                        ratio_ten: "Use the pressure ratio of 10.",
                        total_volume_two: "The final gas fills the total volume of both bulbs.",
                        temperature_doubles_volume_doubles: "At constant pressure, doubling T doubles V.",
                        volume_doubles_temperature_doubles: "At constant pressure, doubling V doubles T.",
                        temperature_halves: "If temperature halves, volume halves as well.",
                        proportional: "Use the direct proportionality between V and T.",
                        isobaric: "Charles's law requires constant pressure.",
                        use_kelvin_only: "Convert Celsius to Kelvin before applying the law.",
                        ratio_one_point_five: "The ratio is 3/2 = 1.5.",
                        linear: "Volume changes linearly with absolute temperature.",
                        one_quarter: "100/400 = 1/4.",
                        offset: "Convert between K and °C with the 273.15 offset.",
                        kelvin_conversion: "Convert both temperatures to Kelvin first.",
                        temperature_measures_ke: "Average kinetic energy is proportional to absolute temperature.",
                        halved: "The volume is halved, so the temperature is halved.",
                        name: "Identify which named gas law matches the condition.",
                        direct_multiply: "Compute the work directly from the numerical product.",
                        w_equals_p_delta_v: "Use W = PΔV in the isobaric piston case.",
                        proportional_short: "Use the direct proportion T_2/T_1 = V_2/V_1.",
                        power_half: "RMS speed scales with T^(1/2)."
                },
                reasons: {
                ...
                placeholders: {
                        ...
                        positive_work_on_gas: "Positive work on gas",
...
,
        gp2_02: {
                ...
                hints: {
                        q_minus_w: "Use ΔU = Q - W.",
                        q_equals_du_plus_w: "Rearrange to Q = ΔU + W.",
                        w_equals_q_minus_du: "Rearrange to W = Q - ΔU.",
                        heat_loss: "Heat released by the system means Q is negative.",
                        add_both: "Subtracting a negative adds the magnitudes.",
                        compression_warms: "Compression work raises internal energy in an adiabatic step.",
                        q_net_equals_w_net: "For a full cycle, ΔU_net = 0 so Q_net = W_net.",
                        direct_change: "With W = 0, ΔU follows the heat directly.",
                        calculate_work_first: "Compute W before using the first law.",
                        net_gain: "A smaller heat loss than work input gives a net gain in internal energy.",
                        state_function: "Internal energy is a state function.",
                        isochoric: "In an isochoric process, W = 0.",
                        cooling: "Cooling lowers internal energy.",
                        temperature_constant: "If temperature stays constant for an ideal gas, ΔU = 0.",
                        work_done_expanding: "Some absorbed heat is used for expansion work.",
                        heat_at_constant_pressure: "At constant pressure, dH matches the heat transfer.",
                        mayers_relation: "Use Cp = Cv + R.",
                        power_law: "Apply the adiabatic power-law relation.",
                        calculus: "This work formula comes from evaluating the pressure integral.",
                        isentropic: "A reversible adiabatic process is isentropic.",
                        mono_internal_energy: "For a monatomic ideal gas, U = 1.5nRT.",
                        direct_substitution: "Substitute the values directly into the model.",
                        linear_relation: "Internal energy scales linearly with temperature here.",
                        kinetic_energy_drops: "Lower temperature means lower average kinetic energy.",
                        diatomic_internal_energy: "For f = 5, use U = 2.5nRT.",
                        multiply_values: "Multiply n, Cv, and ΔT carefully.",
                        path_independent: "State functions do not depend on path.",
                        n_cv_delta_t: "Use ΔU = nCvΔT.",
                        potential_energy: "Real-gas volume dependence comes from intermolecular potential energy.",
                        half: "Each active degree contributes 1/2 kT on average.",
                        behaves_like_monatomic: "Freezing out vibrational modes makes the gas behave more like a monatomic gas.",
                        also_pure_temperature_function: "For an ideal gas, enthalpy also depends only on temperature.",
                        no_reaction_interaction: "Without reaction or interaction change, the total ΔU stays zero.",
                        isoenergetic: "No temperature change means no internal-energy change for an ideal gas.",
                        work_against_forces: "Doing work against attractive forces can cool a real gas.",
                        vibration_modes: "A linear triatomic molecule has 3N-5 vibrational modes.",
                        radiation_pressure: "Photon gas pressure is one third of the energy density.",
                        monatomic: "Use f = 3 for a monatomic gas.",
                        p_delta_v: "Use W = PΔV.",
                        no_displacement: "No volume change means no boundary work.",
                        delta_u_zero: "For isothermal ideal-gas work, ΔU = 0.",
                        opposite_to_expansion: "Work done on the system has the opposite sign of expansion work.",
                        pv_diagram: "Mechanical work is read from a PV diagram.",
                        energy: "Work and heat are both energy quantities.",
                        negative_volume_change: "Compression gives a negative ΔV for system work.",
                        net_expansion: "Clockwise net expansion gives positive net work by the system.",
                        value_8_314_times_300: "Use 8.314 × 300 for RT.",
                        expense_of_internal_energy: "With Q = 0, work comes at the expense of internal energy.",
                        sum: "Add the path works to get the cycle total.",
                        n_r_delta_t: "For this isobaric ideal-gas case, W = nRΔT.",
                        trajectory_matters: "Work depends on the thermodynamic path.",
                        logarithmic_case: "The n = 1 case becomes the logarithmic isothermal formula.",
                        excluded_volume: "The van der Waals correction uses V - nb.",
                        regeneration: "The ideal Stirling cycle includes two isochoric regeneration steps.",
                        approximation: "Round the numerical result appropriately.",
                        second_law: "Irreversible processes produce positive entropy."
                },
                labels: {
                        yes_no: "Yes/No",
                        label_yn: "Y/N",
                ...
                placeholders: {
                        ...
                        yes_label: "Yes",
                        negative: "Negative",
                        polytropic_index: "Polytropic index",
                        decreases: "Decreases",
                        state_function: "State Function",
                        forces: "forces",
                        intermolecular_forces: "Intermolecular forces",
                        negative_cooling: "Negative (Cooling)",
                        nine_approx: "9 (approx)",
                        positive: "Positive",
                        ...
                        path: "path",
                        path_label: "Path",
                        isothermal_logarithmic: "Isothermal (ln)",
