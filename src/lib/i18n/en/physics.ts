...
,
        ...
        gp2_01: {
                ...
                prompts: {
                        ...
                        boyle_k_find_v: "PV constant k = 2400 (kPa·L). If P = 600 kPa, find V.",
                        boyle_p_increase_factor: "Pressure increases by 25%. By what factor does the volume change?",
                        boyle_energy_density: "PV = 5000 J (energy density). If V = 0.01 m^{3}, find P.",
                        boyle_hyperbola: "Graph of P vs V is a hyperbola: P(V) = k/V. If k = 100, find P at V = 5.",
                        boyle_isothermal_work: "Isothermal work W = nRT·ln(V_2/V_1). P_1 V_1 = 1000 J. Expand V to 2V. Find W.",
                        boyle_compress_v3: "Gas is compressed to V/3 isothermally. What is the sign of work done on the gas?",
                        boyle_real_gas_limit: "Real gases deviate from Boyle's Law most at which conditions?",
                        boyle_compress_atm: "P_1 = 1 atm, V_1 = 10 L. Compress to P_2 = 10 atm. Find V_2 (ideal gas).",
                        boyle_two_bulbs: "Two bulbs connected: P_1 = 2, V_1 = 1; P_2 = 0, V_2 = 1. Open valve. Find final P.",
                        charles_celsius_find_v2: "Charles's Law: V_1 = 3 L, T_1 = 27 °C (300 K). T_2 = 127 °C (400 K). Find V_2.",
                        charles_find_t2_c2: "Charles's Law: V_1 = 2 L, T_1 = 200 K. V_2 = 3 L. Find T_2.",
                        charles_cool_factor: "Gas cools from 400 K to 100 K at constant pressure. By what factor does volume change?",
                        charles_abs_zero: "What is absolute zero expressed in degrees Celsius?",
                        charles_20c_to_80c: "Charles's Law: V_1 = 5 L at 20 °C (293 K). Find V_2 at 80 °C (353 K).",
                        charles_ke_proportional: "Heating a gas raises its kinetic energy. Mean kinetic energy is proportional to which quantity?",
                        charles_find_t2_a3: "Charles's Law: V_1 = 10 L, T_1 = 500 K. V_2 = 5 L. Find T_2.",
                        charles_combined_reduces: "The Combined Gas Law at constant pressure reduces to which law?",
                        charles_isobaric_work: "Isobaric expansion: W = P(V_2 - V_1). P = 100 Pa, V changes from 1 to 2 m^{3}. Find W.",
                        charles_density_factor: "Ideal gas: density \\rho \\propto 1/T at constant P. If T doubles, by what factor does \\rho change?",
                        charles_vt_slope: "V-T graph slope = nR/P. If n = 1 mol and P = 8.314 Pa, find the slope.",
                        charles_piston_work: "T_1 = 300 K, V_1 = 1 m^{3}. Piston expands doing W = 300 J at P = 100 Pa. Find V_2.",
                        charles_find_t2_piston: "From previous problem: T_1/V_1 = T_2/V_2. T_1 = 300 K, V_1 = 1 m^{3}, V_2 = 4 m^{3}. Find T_2.",
                        charles_carnot_ke: "In kinetic theory, temperature is proportional to mean kinetic energy. If T doubles, by what power does v_{rms} change?",
                },
                scenarios: {
...
,
        ...
        gp3_03: {
                ...
                prompts: {
                        faraday_basic: "ΔΦ={flux}Wb, Δt={time}s, find EMF",
                        faraday_core: "N={turns}, ΔΦ={flux}Wb, Δt={time}s, find EMF",
                        faraday_advanced: "N={turns}, A={area}m^{2}, ΔB={field}T, Δt={time}s",
                        faraday_elite: "Generator: N={turns}, A={area}m^{2}, B={field}T, f={freq}Hz",
                        lenz_magnet_approaching: "N pole approaching coil, induced current direction?",
                        lenz_magnet_leaving: "N pole leaving coil, induced current direction?",
                        lenz_field_increasing: "B field increasing, induced field direction?",
                        lenz_field_decreasing: "B field decreasing, induced field direction?",
                        lenz_coil_entering: "Coil entering B field, induced current?",
                        lenz_falling_magnet: "Magnet falling through coil, what happens?",
                        lenz_rotating_coil: "Coil rotating in B field, current type?",
                        lenz_moving_conductor: "Conductor moving in B field, force direction?",
                        lenz_changing_current: "Current increasing in coil, induced EMF?",
                        lenz_transformer: "AC in primary coil, secondary coil effect?",
                        lenz_eddy_currents: "Metal plate in B field, what happens?",
                        lenz_self_inductance: "Current changing in coil, self-induced EMF?",
                        lenz_mutual_inductance: "Current in coil A, effect on coil B?",
                        lenz_lenz_brake: "Conducting disk in B field, rotation effect?",
                        lenz_induction_heating: "AC in coil near metal, what happens?",
                        lenz_maglev_train: "Moving magnet over conductor, force direction?",
                        lenz_induction_motor: "Rotating B field, rotor behavior?",
                        lenz_wireless_charging: "AC in transmitter coil, receiver effect?",
                        lenz_metal_detector: "Metal near coil, what changes?",
                        lenz_regenerative_braking: "Motor as generator, energy flow?",
                        generator_basic_ac: "Rotating coil in B field produces?",
                        generator_basic_dc: "Generator with commutator produces?",
                        generator_basic_frequency: "Generator frequency depends on?",
                        generator_basic_voltage: "Generator voltage depends on?",
                        generator_basic_power: "Generator power depends on?",
                        generator_core: "N={turns}, A={area}m^{2}, B={field}T, {speed}rpm, find V",
                        generator_adv_find_current: "P={power}W, V={voltage}V, find I",
                        generator_adv_find_voltage: "P={power}W, I={current}A, find V",
                        generator_adv_find_power: "V={voltage}V, I={current}A, find P",
                        generator_elite: "{type} generator {efficiency}% efficient, {input}W input",
