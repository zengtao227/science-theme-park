...
export const enBiology = {
    gb1_01: {
        ...
        prompts: {
            ...
            fitness_calc: "Population: {init} individuals, {surv} survived. Find relative fitness w.",
            hardy_p: "Hardy-Weinberg: allele frequency p = {p}. Find heterozygosity 2pq.",
            hardy_q: "Hardy-Weinberg: q² = {q2}. Find allele frequency q.",
            drift_time: "Genetic drift: effective population size N = {N}. Find fixation time t (in generations).",
            mutation_div: "Mutation rate u = {u} per generation. Find genetic divergence D.",
            decay_age: "Radiometric dating: fraction remaining f = {f}, half-life h = {h} years. Find age A.",
            common_ancestor: "Divergence D = {n}. Substitution rate r = {r}. Find time to common ancestor T.",
            ns_c3: "Init 100, Surv 100. Selection coefficient s?",
            ns_c4: "Init 100, Surv 80. Find selection coefficient s.",
            ns_c5: "Init 20, Surv 10. Find selection coefficient s.",
            ns_e1: "Selection s=0.1 against recessive. p=0.5, q=0.5. Δp ≈ spq²?",
            ns_e3: "Fitness wAA=1, wAa=1, waa=0.5. q=0.1. Mean fitness W = 1 − sq²?",
            ns_e4: "Heterozygote advantage. wAA=0.8, wAa=1, waa=0.5. Equilibrium q?",
            ns_e5: "Mutation-selection balance. u=1e-5, s=0.1. q = √(u/s)?",
            sp_b1: "100 generations, mutation rate 0.001. Genetic divergence D?",
            sp_b2: "500 generations, mutation rate 0.002. Divergence D?",
            sp_b3: "1000 generations, mutation rate 1×10⁻⁴. Divergence D?",
            sp_b4: "Divergence D=0.2, 100 generations elapsed. Mutation rate u?",
            sp_b5: "Mutation rate 0.01 per generation. Generations to reach D=1?",
            sp_c4: "Genetic drift: fixation probability of new mutation. N=100. P = 1/2N. Find P.",
            ...
            sp_e5: "Neutral theory: rate of substitution equals mutation rate u?",
            ev_c1: "Uranium-238 / Lead-206 dating. Half-life 4.5 Gy. Parent:daughter ratio 1:1. Age (Gy)?",
            ev_c2: "Parent:daughter ratio 1:3 (25% parent remaining). Age in half-lives?",
            ev_c3: "K-Ar dating. Half-life 1.25 Gy. 12.5% K remaining. Age (Gy)?",
            ev_c4: "Carbon-14. 50% remaining. Half-life 5730 y. Age = 1 half-life?",
            ev_c5: "Carbon-14. 6.25% remaining. How many half-lives?",
            ev_a1: "Decay constant λ = 0.693 / T½. T½ = 6930. Find λ.",
            ev_a2: "N(t) = N₀ e^{−λt}. t = 1/λ. Fraction remaining?",
            ev_a3: "30% remains. Half-life = 100 y. Age = −100 × log₂(0.3)?",
            ev_a4: "Isochron dating. Slope m = e^{λt} − 1. m=1. Find λt.",
            ev_a5: "Carbon reservoir fluctuation: correction factor 10%. Apparent age 1000 y → corrected age?",
            ev_e1: "Molecular phylogeny. Jukes-Cantor distance K = −0.75 ln(1 − 4p/3). p=0.25. K?",
        ...
        hints: {
            delta_p_spq_squared: "Use the approximation Δp ≈ s p q².",
            rare_alleles: "Rare alleles mean q is small.",
            mean_fitness: "Mean fitness is weighted across genotype frequencies.",
            balanced_polymorphism: "This is a balanced polymorphism equilibrium.",
            equilibrium: "Assume Hardy-Weinberg equilibrium first.",
            multiply_short: "Multiply the given values.",
            divide_speed: "Divide by the elapsed generations.",
            inverse: "Use the reciprocal relation.",
            one_over_2n: "Use 1/(2N).",
            equal_sex: "Assume equal numbers of males and females.",
            ns_less_than_one: "Check whether Ns is less than 1.",
            sample: "Treat this as a sampling probability.",
            structure: "Use the population-structure formula.",
            pairwise: "Think in pairwise ancestral lineages.",
            k_equals_u: "Under neutrality, k equals u.",
            one_half_life: "That is one half-life.",
            two_half_lives: "That is two half-lives.",
            three_half_lives: "That is three half-lives.",
            one_minus_one_over_2n: "Use 1 - 1/(2N).",
            quarter_remaining_path: "Follow the halving path to one quarter remaining.",
            one_sixteenth_remaining: "1/16 remains after four half-lives.",
            definition_short: "Use the definition directly.",
            divide_short: "Divide the relevant quantities.",
            calculate_short: "Carry out the calculation step by step.",
            ln_2: "Recall that ln 2 ≈ 0.693.",
            corrected: "Apply the correction factor at the end.",
            formula: "Use the stated model formula.",
            adaptive: "A value above 1 indicates adaptive change.",
            occam: "Prefer the tree with fewer changes.",
            percentage: "Interpret 95 out of 100 as a percentage."
        },
        feedback: {
    ...
    sb2_01_tissues: {
        ...
        solver: {
            ...
            extract_key_clue: "Extract Key Clue",
            classify_biological_level: "Classify Biological Level",
            tissue_clue_label: "Tissue clue:",
            organ_clue_label: "Organ clue:",
            system_clue_label: "System clue:",
            tissue_step: "Use the tissue clue to match a defining function or structure.",
            organ_step: "Use the organ clue to decide how multiple tissue types combine in one organ.",
            system_step: "Use the hierarchy clue to place the structure at the correct biological level.",
    ...
    sb2_02: {
        ...
        answers: {
            ...
            alveoli: "alveoli",
            oxygen: "oxygen",
            contracts_and_moves_down: "contracts and moves down",
            hemoglobin: "hemoglobin",
            exhaled_through_lungs: "exhaled through lungs",
            high_co2_levels: "high CO2 levels",
            ...
            systole: "systole",
            heart_contraction: "heart contraction",
            ...
            reabsorbed_into_blood: "reabsorbed into blood",
            secretion_from_blood: "secretion from blood",
            adh: "ADH",
            urea: "urea",
            ...
            efficiency: "Efficiency",
            more_time_absorption: "More time for absorption",
            infection_risk: "Infection risk",
            bacterial_infection: "Bacterial infection",
            metabolism: "Metabolism",
            malabsorption: "Malabsorption",
            comparison: "Comparison",
            mechanical_chemical: "Mechanical + Chemical",
            pulmonary: "Pulmonary",
            heart_rate: "Heart rate",
            elasticity: "Elasticity",
            elastic_walls: "Elastic walls absorb pressure",
            varicose_veins: "Varicose veins",
            sa_node: "SA node",
            sa_node_full: "SA node (sinoatrial)",
            heart_attack: "Heart attack",
            heart_attack_stroke: "Heart attack, stroke",
            stretch: "Stretch",
            increased_stretch: "Increased stretch -> stronger contraction",
            mechanisms: "Mechanisms",
            compensation: "Compensation",
            cardiac_hypertrophy: "Cardiac hypertrophy",
            increase: "Increase",
            respiratory_rate: "Respiratory rate",
            area: "Area",
            gradient: "Gradient",
            concentration_gradient: "Concentration gradient",
            vibration: "Vibration",
            vocal_cord_vibration: "Vocal cord vibration",
            collapse: "Collapse",
            alveolar_collapse: "Alveolar collapse",
            reduced_airflow: "Reduced airflow",
            reduced_airflow_hypoxia: "Reduced airflow, hypoxia",
            increased_breathing_rate: "Increased breathing rate",
            adaptation: "Adaptation",
            increased_rbc: "Increased RBC production",
            reduction: "Reduction"
        },
        solver: {
            ...
            extract_key_clue: "Extract Key Clue",
            trace_system_role: "Trace System Role",
            organ_clue_label: "Organ clue:",
            system_clue_label: "System clue:",
            digestive_step: "Follow food through the pathway and match the organ to its digestive job.",
            circulatory_step: "Track how blood moves or exchanges materials to identify the matching structure.",
            respiratory_step: "Follow airflow and gas exchange to identify the organ or breathing mechanism.",
        ...
        expressions: {
            ...
            enteric_nervous: "Enteric nervous system",
            celiac: "Celiac disease",
            blood_vessels: "Blood vessels",
            gas_exchange: "Gas exchange",
            atria_ventricles: "2 atria + 2 ventricles",
            blood_pressure: "Blood pressure",
            hemoglobin: "Hemoglobin",
            atherosclerosis: "Atherosclerosis",
            frank_starling: "Frank-Starling",
            bp_regulation: "BP regulation",
            heart_failure: "Heart failure",
            rest_exercise_co: "Rest: 5 L/min, Exercise: 25 L/min",
            respiratory_pathway: "Respiratory pathway",
            breathing: "Breathing",
        ...
        hints: {
            ...
            digestive_a1: "Neutralizes acid",
            digestive_a2: "Surface area matters",
            digestive_a3: "Longer = more contact time",
            digestive_a4: "Acid kills bacteria",
            digestive_a5: "Processing nutrients",
            digestive_e1: "Inflammatory bowel disease",
            digestive_e2: "Breaks down lactose",
            digestive_e3: "Second brain",
            digestive_e4: "Damaged villi",
            digestive_e5: "Physical vs enzymatic",
            circulatory_a1: "CO = HR x SV",
            circulatory_a2: "Stretch and recoil",
            circulatory_a3: "Blood pools in veins",
            circulatory_a4: "4 binding sites",
            circulatory_a5: "Natural pacemaker",
            circulatory_e1: "Blocked arteries",
            circulatory_e2: "More blood in = more out",
            circulatory_e3: "Neural, hormonal, renal",
            circulatory_e4: "Heart enlarges",
            circulatory_e5: "25/5 = 5",
            respiratory_a1: "Tennis court size",
            respiratory_a2: "MV = TV x RR",
            respiratory_a3: "High to low concentration",
            respiratory_a4: "Air vibrates cords",
            respiratory_a5: "Surface tension too high",
            respiratory_e1: "Narrowed airways",
            respiratory_e2: "Breathe faster/deeper",
    ...
    sb3_02: {
        ...
        diversity_calculator: {
            ...
            species_placeholder: "Species {index}",
            total_individuals: "Total Individuals",
            species_richness: "Species Richness",
            shannon_index: "Shannon Index (H')",
            simpson_index: "Simpson Index (D)",
            evenness: "Evenness (J')",
            evenness_description: "Evenness ranges from 0 to 1, with 1 indicating perfect evenness",
            formulas: "Formulas:",
            formula_labels: {
        ...
        ecosystem_map: {
            ...
            select_region: "Select a region to view details",
    ...
    sb3_01: {
        ...
        solver: {
            ...
            identify_ecological_clue: "Identify Ecological Clue",
            apply_ecological_pattern: "Apply Ecological Pattern",
            scenario_label: "Scenario:",
            stage_food_chain_step: "Move along the trophic order from producer to consumer to the next higher consumer.",
            stage_energy_flow_step: "Apply the 10% rule from the current trophic level to the next one.",
            stage_cycles_step: "Link the named cycle process to the product or reservoir it generates.",
            stage_elite_step: "Use the given ecological model to decide which quantity must be isolated or computed.",
    ...
    sb2_03: {
        ...
        solver: {
            ...
            list_parent_gametes: "List Parent Gametes",
            build_punnett_square: "Build Punnett Outcomes",
            count_matching_offspring: "Count Matching Offspring",
            gametes_from: "Gametes from",
            classic_dihybrid_gametes: "For the standard dihybrid model, each heterozygous parent contributes four gamete combinations.",
            outcomes_label: "Punnett outcomes:",
            dihybrid_outcomes_label: "Classic dihybrid phenotype ratio:",
            genotype_count_label: "Genotype counts:",
            phenotype_count_label: "Phenotype counts:",
            matching_outcomes_label: "Matching outcomes:",
            convert_ratio_label: "Convert the ratio part to a probability",
    ...
    sb2_04: {
        ...
        solver: {
            ...
            extract_key_clue: "Extract Key Clue",
            classify_question_type: "Classify Question Type",
            system_focus_label: "System focus:",
            organ_clue_label: "Organ clue:",
            process_clue_label: "Process clue:",
            scenario_clue_label: "Scenario clue:",
            identification_step: "Match the named function to the organ or structure that performs it.",
            process_step: "Trace the process through the system and identify the structure or mechanism responsible.",
            coordination_step: "Link regulation, disease, or coordination clues to the physiological response.",
            comprehensive_step: "Integrate multiple organs and processes before selecting the final response.",
