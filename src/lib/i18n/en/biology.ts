...
export const enBiology = {
    ...
    gb2_02: {
        ...
        solver: {
            ...
            hormone_label: "Hormone",
            gland_label: "Gland",
            target_organs_label: "Target organs",
            feedback_chain_label: "Feedback chain",
            abnormal_labs_label: "Abnormal labs",
            extract_endocrine_clue: "Extract Endocrine Clue",
            trace_endocrine_mechanism: "Trace Endocrine Mechanism",
            trace_feedback_loop: "Follow stimulus and response through the loop",
            trace_clinical_pattern: "Link symptoms and abnormal labs to the endocrine disorder pattern",
    ...
    sb1_01: {
        ...
        solver: {
            ...
            extract_organelle_clue: "Extract Organelle Clue",
            trace_cell_role: "Trace Cell Role",
            clue_size_label: "Size clue:",
            clue_function_label: "Function clue:",
            clue_target_label: "Target clue:",
            trace_identification_pattern: "Compare the visible size or hallmark feature to the organelle catalog.",
            trace_function_pattern: "Follow the cellular job in the prompt to the organelle that performs it.",
            trace_fact_pattern: "Use the requested reference fact and decide which cell structure or value it points to.",
    ...
    sb1_01_metabolic: {
        ...
        solver: {
            ...
            extract_metabolic_clue: "Extract Metabolic Clue",
            trace_regulation_pattern: "Trace Regulation Pattern",
            osmotic_status_label: "Osmotic status:",
            respiration_clue_label: "Respiration clue:",
            homeostasis_clue_label: "Homeostasis clue:",
            trace_osmosis_pattern: "Compare the surrounding tonicity to the direction water must move to restore balance.",
            trace_respiration_pattern: "Follow the respiration sequence from fuel and oxygen to ATP, carbon dioxide, and water.",
            trace_homeostasis_pattern: "Compare the variable to its set point and select the feedback response that pushes it back toward normal.",
    ...
    sb1_02: {
        ...
        solver: {
            ...
            extract_photosynthesis_clue: "Extract Photosynthesis Clue",
            trace_photosynthesis_pattern: "Trace Photosynthesis Pattern",
            clue_factor_label: "Factor clue:",
            clue_structure_label: "Structure clue:",
            trace_equation_pattern: "Follow the balanced equation to keep reactants and products in the correct stoichiometric ratio.",
            trace_factor_pattern: "Check how the named factor changes the limiting step before deciding the rate effect.",
            trace_chloroplast_pattern: "Match the process to the chloroplast region where that photosynthesis step occurs.",
    ...
    sb1_03: {
        ...
        solver: {
            ...
            extract_phase_clue: "Extract Phase Clue",
            trace_chromosome_pattern: "Trace Chromosome Pattern",
            phase_label: "Phase:",
            chromosome_count_label: "Relevant count:",
            trace_mitosis_pattern: "Sister chromatids stay paired until anaphase, then move to opposite poles.",
            trace_meiosis_i_pattern: "Homologous chromosome pairs separate first while sister chromatids remain joined.",
            trace_meiosis_ii_pattern: "Sister chromatids separate in each haploid cell during the second division.",
    ...
    sb1_04: {
        ...
        solver: {
            ...
            extract_plant_clue: "Extract Plant Clue",
            trace_transport_pattern: "Trace Plant Transport Pattern",
            clue_structure_label: "Structure clue:",
            clue_function_label: "Function clue:",
            trace_plant_structure_pattern: "Map the named organ or tissue to the plant job it performs in support, absorption, or photosynthesis.",
            trace_water_transport_pattern: "Follow water from roots to leaves through xylem, transpiration pull, and cohesion-tension.",
            trace_nutrient_transport_pattern: "Follow source-to-sink movement in phloem to identify how sugars or signals travel through the plant.",
    ...
    sb1_05: {
        ...
        solver: {
            ...
            extract_animal_clue: "Extract Animal Clue",
            trace_survival_pattern: "Trace Survival Pattern",
            animal_label: "Animal:",
            scientific_name_label: "Scientific name:",
            trace_classification_pattern: "Use body covering, reproduction, and skeletal traits to place the animal group.",
            trace_adaptation_pattern: "Match the habitat challenge to the adaptation that improves survival there.",
            trace_behavior_pattern: "Connect the behavior to migration, reproduction, or conservation pressure.",
    ...
    sb2_02: {
        ...
        solver: {
            ...
            extract_system_clue: "Extract System Clue",
            trace_system_pathway: "Trace System Pathway",
            extract_key_clue: "Extract Key Clue",
            trace_system_role: "Trace System Role",
            route_clue_label: "Route clue:",
            organ_clue_label: "Organ clue:",
            system_clue_label: "System clue:",
            trace_digestive_pattern: "Follow food processing from ingestion to digestion, absorption, and waste handling.",
            trace_circulatory_pattern: "Follow blood from heart to vessels to tissues and back, matching each structure to its transport role.",
            trace_respiratory_pattern: "Follow airflow into the lungs and gas exchange at the alveoli before identifying the missing structure.",
