...
export const enChemistry = {
    ...
    sc2_01: {
        ...
        prompts: {
            ...
            arr_c3: "\\ln(k)",
            arr_c4: "E_a",
            arr_c5: "k_{\\text{new}}/k_{\\text{old}}",
            arr_a1: "\\ln(k_2/k_1)",
            arr_a2: "\\text{slope}",
            arr_a3: "A",
            arr_a4: "T",
            arr_a5: "k_{\\text{cat}}",
            arr_e1: "k_{\\text{overall}}",
            arr_e2: "k(P)",
            arr_e3: "k_{\\text{tunnel}}",
            arr_e4: "k_H/k_D",
            arr_e5: "\\Delta G^\\ddagger",
            rl_b: "\\text{rate}",
            rl_b4: "\\text{rate}_{\\text{new}}",
            rl_b5: "\\text{rate}_0",
            rl_c2: "n",
            rl_c3: "[A]_t",
            rl_c4: "t",
            rl_c5: "k",
            rl_a2: "\\text{rate}_{\\text{overall}}",
            rl_a3: "[I]_{\\text{ss}}",
            rl_a4: "K_{\\text{eq}}",
            rl_e1: "[A]_{\\text{max}}",
            rl_e2: "t_{\\text{inflection}}",
            rl_e3: "\\text{chain length}",
            rl_e4: "\\Phi",
            rl_e5: "V_{\\text{max}}",
            hl_b: "t_{1/2}",
            hl_b4: "[A]",
            ...
            hl_a1: "t_{\\text{max}}",
            hl_a2: "t_{1/2,\\text{overall}}",
            hl_a3: "[A]_{\\text{eq}}",
            hl_a4: "t_{1/2}(350\\text{K})",
            hl_e1: "\\text{age}",
            hl_e2: "\\text{branch ratio}",
            hl_e3: "A_2/A_1",
            hl_e5: "\\text{exposure age}",
        },
        problems: {
