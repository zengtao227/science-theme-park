...
export const enChemistry = {
    ...
    sc2_01: {
        ...
        prompts: {
            ...
            arr_c1: "Given temperature change, calculate how much k changes.",
            arr_c2: "Given lower activation energy, calculate the increase in k.",
            arr_c3: "Calculate ln(k) from the given Arrhenius parameters.",
            arr_c4: "Calculate activation energy E_a from the given data.",
            arr_c5: "Calculate the ratio k_new / k_old after catalysis.",
            arr_a1: "Use ln(k2/k1) to solve for activation energy E_a.",
            arr_a2: "Use Arrhenius plot slope to calculate E_a.",
            arr_a3: "Calculate the pre-exponential factor A.",
            arr_a4: "Calculate temperature T required for the target k.",
            arr_a5: "Calculate catalytic rate constant k_cat from given values.",
            arr_e1: "Calculate overall rate constant k_overall for the mechanism.",
            arr_e2: "Calculate pressure-dependent rate constant k(P).",
            arr_e3: "Calculate tunnel-corrected rate constant k_tunnel.",
            arr_e4: "Calculate kinetic isotope ratio k_H / k_D.",
            arr_e5: "Calculate activation Gibbs energy Delta G double dagger.",
            rl_b: "Calculate reaction rate from the given rate law data.",
            rl_b4: "Calculate the new reaction rate after concentration change.",
            rl_b5: "Calculate initial reaction rate rate_0.",
            rl_c2: "Determine reaction order n from the experiment pattern.",
            rl_c3: "Calculate concentration [A]_t at time t.",
            rl_c4: "Calculate required reaction time t.",
            rl_c5: "Calculate rate constant k from provided measurements.",
            rl_a2: "Calculate overall reaction rate for the multi-step process.",
            rl_a3: "Calculate steady-state intermediate concentration [I]_ss.",
            rl_a4: "Calculate equilibrium constant K_eq from rate constants.",
            rl_e1: "Calculate maximum concentration [A]_max.",
            rl_e2: "Calculate inflection time t_inflection.",
            rl_e3: "Calculate chain length for the chain reaction.",
            rl_e4: "Calculate quantum yield Phi.",
            rl_e5: "Calculate maximum rate V_max.",
            hl_b: "Calculate half-life t_1/2.",
            hl_b4: "Calculate remaining concentration [A] after decay.",
            hl_c2: "Calculate remaining fraction f.",
            hl_c3: "Calculate remaining amount N_t at time t.",
            hl_c4: "Calculate remaining drug concentration [D]_t.",
            hl_c5: "Calculate half-life ratio t_1/2,A over t_1/2,B.",
            hl_a1: "Calculate the time t_max of peak intermediate/activity.",
            hl_a2: "Calculate overall half-life t_1/2,overall.",
            hl_a3: "Calculate equilibrium concentration [A]_eq.",
            hl_a4: "Calculate half-life at 350K.",
        ...
        problems: {
            ...
            rl_mixed: "Mixed order: rate = k[A][B]. [A]=2 M, [B]=3 M, k=0.5 M^-^{2}s^-¹. Find rate.",
    ...
    sc2_02: {
        ...
        labels: {
            ...
            answer_target: "\\text{Answer}",
            answer_slot: "Answer",
            result_placeholder: "Result",
            indicator_target: "\\text{Indicator}",
            indicator_slot: "Indicator",
            indicator_placeholder: "indicator name",
            monitor_indicator: "INDICATOR",
            monitor_acid_type: "ACID TYPE",
            ph_range: "pH range",
        ...
        prompts: {
            ...
            curves_basic_1: "Identify the titration curve type.",
            curves_basic_2: "Identify the weak-acid titration curve.",
            curves_basic_3: "Find the equivalence volume.",
            curves_basic_4: "Calculate the equivalence-point volume.",
            curves_basic_5: "Find the weak-acid equivalence volume.",
            curves_core_1: "Find pH at equivalence.",
            curves_core_2: "Find weak-acid pH at equivalence.",
            curves_core_3: "Find strong-acid equivalence pH.",
            curves_core_4: "Find pH in the buffer region.",
            curves_core_5: "Find equivalence volume for the dilute acid.",
            curves_advanced_1: "Determine the weak-acid pKa.",
            curves_advanced_2: "Calculate the high-concentration equivalence point.",
            curves_advanced_3: "Estimate the buffer-capacity volume.",
            curves_advanced_4: "Find pH at half-equivalence.",
            curves_advanced_5: "Compute the precise equivalence volume.",
            curves_elite_1: "Perform the complex pKa calculation.",
            curves_elite_2: "Analyze the low-concentration buffer case.",
            curves_elite_3: "Solve the multi-step equivalence calculation.",
            curves_elite_4: "Solve the advanced buffer-volume case.",
            curves_elite_5: "Find the exact pH at 25 mL of added base.",
            equivalence_basic_1: "Find Vb at equivalence.",
            equivalence_basic_2: "Calculate Vb at the equivalence point.",
            equivalence_basic_3: "Compute equivalence volume Vb.",
            equivalence_basic_4: "Find the required equivalence volume Vb.",
            equivalence_basic_5: "Calculate Vb for this equivalence setup.",
            equivalence_core_1: "Compute the precise equivalence-point volume.",
            equivalence_core_2: "Find Vb for the high-concentration case.",
            equivalence_core_3: "Find Vb for the low-concentration case.",
            equivalence_core_4: "Solve the complex equivalence-volume calculation.",
            equivalence_core_5: "Solve the reverse concentration-volume case.",
            equivalence_advanced_1: "Determine Vb in the dilute-case setup.",
            equivalence_advanced_2: "Solve Vb for the 2:1 concentration ratio.",
            equivalence_advanced_3: "Solve Vb for the inverse-ratio case.",
            equivalence_advanced_4: "Compute Vb with high precision.",
            equivalence_advanced_5: "Compute Vb for the 1:3 ratio case.",
            equivalence_elite_1: "Solve Vb for this complex ratio.",
            equivalence_elite_2: "Solve Vb for this near-1:1 ratio.",
            equivalence_elite_3: "Compute Vb for this precise dilute case.",
            equivalence_elite_4: "Compute Vb for this close-concentration case.",
            equivalence_elite_5: "Compute Vb for this fine-tuned setup.",
            indicators_basic_1: "Select an indicator for strong-acid titration.",
            indicators_basic_2: "Choose the indicator for this acidic range.",
            indicators_basic_3: "Select an indicator for weak-acid titration.",
            indicators_basic_4: "Choose an indicator for a broad pH range.",
            indicators_basic_5: "Choose an indicator for a basic transition range.",
            indicators_core_1: "Choose the best indicator for weak-acid titration.",
            indicators_core_2: "Choose the indicator for an acidic transition range.",
            indicators_core_3: "Choose the indicator near neutral weak-acid conditions.",
            indicators_core_4: "Choose the indicator for near-neutral range.",
            indicators_core_5: "Choose the indicator for the weak-acid buffer case.",
            indicators_advanced_1: "Choose the indicator for a half-equivalence range.",
            indicators_advanced_2: "Choose the indicator for very low pH.",
            indicators_advanced_3: "Choose the indicator for high-pH weak-acid case.",
            indicators_advanced_4: "Choose an indicator for the full-range check.",
            indicators_advanced_5: "Choose the indicator for weak-acid equivalence range.",
            indicators_elite_1: "Choose the indicator for a precise weak-acid range.",
            indicators_elite_2: "Choose the indicator for a narrow acidic range.",
            indicators_elite_3: "Choose the indicator for the buffer-region range.",
            indicators_elite_4: "Choose the indicator for near-neutral precision range.",
    ...
    sc2_04: {
        ...
        mission: {
            ...
            elite_analysis_title: "Rhine Water Quality Analysis"
        },
        stages: {
            dissolve: "DISSOLVE",
            saturate: "SATURATE",
            ...
            elite_hint: "Analyze the data rigorously."
        },
        prompts: {
            solubility_given: "T = {temp}°C",
            elite_rhine_sample: "Rhine Water Sample A: Mass before=100g, after=99.8g."
        },
        scenarios: {
    ...
    sc3_01: {
        ...
        labels: {
            ...
            snap: "Snap",
            carbon: "\\text{Carbon}",
            hydrogen: "\\text{Hydrogen}",
            oxygen: "\\text{Oxygen}",
            nitrogen: "\\text{Nitrogen}",
            total: "\\text{Total}",
            mass_per_mol: "\\text{Mass (g/mol)}",
            percent: "\\text{Percent}",
            bonds: "\\text{Bonds}",
            groups: "\\text{Groups}",
            rings: "\\text{Rings}",
        ...
        hints: {
            ...
            oxygen_is_red: "\\text{Oxygen is red.}",
            nitrogen_is_blue: "\\text{Nitrogen is blue.}",
            add_all_atoms: "\\text{Add all atoms.}",
            count_black_spheres: "\\text{Count black spheres.}",
            smallest_white_atoms: "\\text{Smallest white atoms.}",
            red_spheres: "\\text{Red spheres.}",
            simplify_if_possible: "\\text{Simplify if possible.}",
            carbon_over_total: "\\text{Carbon / Total atoms}",
            roughly_atoms_minus_one: "\\text{Roughly atoms - 1}",
            already_simplified: "\\text{Already simplified}",
            use_precise_masses: "\\text{Use precise atomic masses}",
            exact_count_required: "\\text{Exact count required}",
            mass_of_c_over_total: "\\text{Mass of C / Total mass}",
        ...
        prompts: {
            ...
            find_hydrogen_count: "Find Hydrogen count in {molecule}.",
            find_oxygen_count: "Find Oxygen count in {molecule}.",
            find_nitrogen_count: "Find Nitrogen count in {molecule}.",
            total_atom_count: "Total atom count in {molecule}?",
            verify_carbon_atoms: "Verify Carbon atoms in {molecule}.",
            count_hydrogen: "Count Hydrogen in {molecule}.",
            oxygen_atoms: "Oxygen atoms in {molecule}?",
            co_ratio: "C:O ratio in {molecule}?",
            approx_molar_mass: "Approximate molar mass of {molecule}?",
            complete_formula: "Complete formula for {molecule}?",
            carbon_percentage: "Carbon percentage in {molecule}?",
            estimate_bond_count: "Estimate bond count in {molecule}?",
            simplest_ratio: "Simplest ratio for {molecule}?",
            precise_molar_mass: "Precise molar mass of {molecule}?",
            identify_formula_precisely: "Identify {molecule} formula precisely.",
    ...
    sc3_02: {
        ...
        scenarios: {
            ...
            fragrance_design: "Givaudan Basel - The Art of the Molecule: You are a junior perfumer at Givaudan in Basel, working alongside world-class masters of fragrance. The creation of a new perfume is a complex dance between artistic intuition and organic chemistry. Each 'note' in a scent is actually a specific organic molecule, often with a unique functional group that gives it its characteristic aroma, such as the citrus scent of an aldehyde or the floral smell of an ester. Today, you are classifying a series of aromatic molecules to find the perfect addition to a new luxury fragrance. Your work ensures that Givaudan remains the world leader in scent innovation, headquartered right here in Basel. This is like being a painter, but instead of using colors on a canvas, you are using molecular structures to create an olfactory masterpiece that evokes memories and emotions."
        }
    },
    sc3_03: {
        back: "Return to Nexus",
    ...
    sc2_05: {
        ...
        contexts: {
            PH_B1: "Calculate the pH of a 0.1 M HCl solution. HCl is a strong acid that fully dissociates in water. Use pH = -log[H+] to find the result.",
            PH_B2: "Calculate the pH of pure water at 25 °C. At this temperature, water self-ionizes with [H+] = 1×10⁻⁷ M. Determine the neutral pH value.",
            PH_B3: "Calculate the pH of a 0.01 M NaOH solution. NaOH is a strong base that fully dissociates. First find pOH, then use pH + pOH = 14.",
            PH_B4: "Calculate the pH of a 0.001 M HNO₃ solution. Nitric acid is a strong acid. Apply pH = -log[H+] with [H+] = 0.001 M.",
            PH_B5: "Calculate the pH of a 0.0001 M KOH solution. KOH is a strong base. Find pOH first, then convert to pH using pH = 14 - pOH.",
            PH_C1: "Calculate the pH of a weak acid CH₃COOH solution (Ka = 1.8×10⁻⁵, C = 0.1 M). Weak acids only partially dissociate. Use the simplified formula pH = ½(pKa - log C).",
            PH_C2: "A buffer solution contains 0.1 M CH₃COOH + 0.1 M CH₃COONa. Apply the Henderson-Hasselbalch equation: pH = pKa + log([A⁻]/[HA]) to find the buffer pH.",
            PH_C3: "Calculate the pH of a 0.01 M NH₃ solution (Kb = 1.8×10⁻⁵). Ammonia is a weak base. Find pOH from Kb, then convert: pH = 14 - pOH.",
            PH_C4: "A mixed buffer contains 0.2 M HA + 0.1 M A⁻, with pKa = 5.0. Use Henderson-Hasselbalch: pH = pKa + log([A⁻]/[HA]) to find the buffer pH.",
            PH_C5: "Calculate the pH after diluting 0.1 M HCl to 0.001 M. When a strong acid is diluted 100-fold, the H+ concentration drops proportionally. Find the new pH.",
            PH_A1: "Polyprotic acid H₂SO₄: the first dissociation is complete. The second dissociation has Ka₂ = 1.2×10⁻². Calculate the total H+ concentration and resulting pH.",
            PH_A2: "Apply Henderson-Hasselbalch with pH = 5.5 and pKa = 4.76. Rearrange to find the ratio [A⁻]/[HA] needed to achieve this pH in the buffer.",
            PH_A3: "Amino acid glycine is at its isoelectric point (pI = 6.0), where it carries no net charge. Calculate pI from pI = ½(pKa₁ + pKa₂) using the given dissociation constants.",
            PH_A4: "Calculate the pH of a 0.05 M H₃PO₄ solution (Ka₁ = 7.5×10⁻³). Only the first dissociation is significant. Use the weak acid approximation to find [H+].",
            PH_A5: "Evaluate the buffer capacity of 0.5 M CH₃COOH + 0.5 M CH₃COONa. High concentrations give high buffer capacity. Calculate pH and identify the capacity limit.",
            PH_E1: "Novartis Enzyme Buffer: Ionic strength affects the effective pKa. For a 0.1 M buffer where the activity coefficient γ(A⁻) = 0.8 and pKa(ideal) = 4.76, calculate the corrected effective pKa using pKa(eff) = pKa(ideal) - log(γ(A⁻)).",
            PH_E2: "University Hospital Basel – Hypothermia treatment: Blood pKa is 6.1 at 37 °C but rises to 6.25 at 30 °C. If the [HCO₃⁻]/[CO₂] ratio is 20 at 30 °C, calculate the resulting blood pH using Henderson-Hasselbalch.",
            PH_E3: "Parenteral Nutrition: Amino acid Glycine (pKa₁ = 2.35, pKa₂ = 9.78) acts as a zwitterion buffer at its isoelectric point. Find pI = ½(pKa₁ + pKa₂) to determine the optimal infusion pH.",
            PH_E4: "Physiological Buffer: Blood pH is maintained at 7.4. Given [HCO₃⁻] = 24 mM and pKa = 6.1, find the required P(CO₂) in mmHg. Use Henderson-Hasselbalch and the solubility constant α = 0.03 mM/mmHg.",
            PH_E5: "Metabolic Acidosis: A patient's [HCO₃⁻] drops to 15 mM. Calculate the P(CO₂) required for respiratory compensation to reach pH 7.1. This guides the clinical decision on ventilation settings.",
            NT_B1: "HCl + NaOH → NaCl + H₂O. Given equal moles of acid and base, calculate the moles of NaCl salt formed. This 1:1 stoichiometry is the foundation of all neutralization calculations.",
            NT_B2: "Mix 50 mL of 0.2 M HCl with 50 mL of 0.2 M NaOH. Equal moles react completely. Determine the final pH of the resulting neutral salt solution.",
            NT_B3: "Mix 25 mL of 0.1 M H₂SO₄ with 50 mL of 0.1 M NaOH. H₂SO₄ is diprotic. Check whether complete neutralization occurs by comparing moles of H+ and OH⁻.",
            NT_B4: "Mix 20 mL of 0.15 M HNO₃ with 30 mL of 0.1 M KOH. Calculate moles of each reactant to identify which is in excess after the neutralization reaction.",
            NT_B5: "Mix 10 mL of 0.5 M HCl with 25 mL of 0.2 M NaOH. Calculate the total volume of the final solution. This is needed before determining final concentration.",
            NT_C1: "Excess acid scenario: Mix 30 mL of 0.2 M HCl with 20 mL of 0.2 M NaOH. Not all acid is neutralized. Calculate the excess [H+] in the final solution and determine the resulting pH.",
            NT_C2: "Excess base scenario: Mix 25 mL of 0.1 M HCl with 40 mL of 0.1 M NaOH. The base is in excess. Calculate the excess [OH⁻] and determine the final pH of the solution.",
            NT_C3: "Diprotic acid: H₂SO₄ + 2 NaOH → Na₂SO₄ + 2 H₂O. Identify the mole ratio of acid to base needed for complete neutralization. This 1:2 ratio is critical for correct stoichiometry.",
            NT_C4: "Heat of neutralization: ΔH = -57.3 kJ/mol for strong acid + strong base. Calculate the heat released when a specific number of moles of HCl reacts with NaOH in an insulated flask.",
            NT_C5: "Mixed neutralization: Add 40 mL of 0.1 M NaOH to a mixture of 20 mL of 0.1 M HCl + 20 mL of 0.1 M CH₃COOH. Calculate total moles of acid and determine whether the base neutralizes both.",
            NT_A1: "Weak acid + strong base: CH₃COOH + NaOH → CH₃COONa + H₂O. At the equivalence point, only the conjugate base remains. Calculate the pH using Kb of CH₃COO⁻.",
            NT_A2: "Weak base + strong acid: NH₃ + HCl → NH₄Cl. At the equivalence point, only NH₄⁺ remains. Calculate the pH using Ka of NH₄⁺ (pKa = 14 - pKb).",
            NT_A3: "Partial neutralization: Add 25 mL of 0.1 M NaOH to 50 mL of 0.1 M CH₃COOH. This neutralizes half the acid, creating a buffer. Apply Henderson-Hasselbalch to find pH.",
            NT_A4: "Polyprotic neutralization: H₃PO₄ + 3 NaOH → Na₃PO₄ + 3 H₂O. Calculate the mole ratio and the volume of NaOH needed to completely neutralize a given amount of H₃PO₄.",
            NT_A5: "Conductometric titration: Conductivity reaches a minimum at the equivalence point because all ions have combined into water and salt. Identify this minimum on a conductivity-volume graph.",
            NT_E1: "Blood Buffer Neutralization: A sudden rise in CO₂ produces 0.02 mol of H₂CO₃. Calculate the moles of OH⁻ (from an administered medication) required for complete neutralization, to guide dosing decisions.",
            NT_E2: "Amphoteric Buffer: H₂PO₄⁻ acts as both acid and base. Calculate the amount of H⁺ neutralized by 0.1 mol of HPO₄²⁻, using the reaction HPO₄²⁻ + H⁺ → H₂PO₄⁻.",
            NT_E3: "Novartis Quality Control: Neutralizing an acid waste stream. 100 L of 0.05 M H₂SO₄ must be treated. Calculate the moles of Ca(OH)₂ required for full neutralization before safe disposal.",
            NT_E4: "Lactic Acid Neutralization: During exercise, 0.05 mol of CH₃CH(OH)COOH enters the blood. Calculate the moles of HCO₃⁻ consumed by the bicarbonate buffer to maintain blood pH.",
            NT_E5: "Renal Compensation: The kidney excretes NH₄⁺ to remove excess H⁺. If 0.1 mol of NH₄⁺ is excreted via urine, calculate the moles of 'new' HCO₃⁻ returned to the blood to restore pH.",
            TT_B1: "Use C₁V₁ = C₂V₂ (for titration: n₁ = n₂ at equivalence). Find the volume of 0.2 M NaOH needed to completely neutralize 25 mL of 0.1 M HCl.",
            TT_B2: "20 mL of an unknown HCl solution is neutralized by 30 mL of 0.15 M NaOH at the equivalence point. Use n(HCl) = n(NaOH) to calculate the concentration of HCl.",
            TT_B3: "Titration of 50 mL of 0.1 M CH₃COOH with 0.1 M NaOH. Calculate the volume of NaOH required to reach the equivalence point using n(acid) = n(base).",
            TT_B4: "Indicator selection for strong acid/strong base titration: At the equivalence point, pH = 7. Identify an appropriate indicator and calculate the expected equivalence point pH.",
            TT_B5: "Burette reading: Initial reading 0.50 mL, final reading 25.80 mL. Calculate the volume of titrant delivered by subtracting initial from final reading.",
            TT_C1: "Titration curve analysis: A sharp pH jump from pH 4 to pH 10 marks the equivalence point. Read the curve to identify the exact equivalence volume at the inflection point.",
            TT_C2: "Half-equivalence point: 25 mL of NaOH is needed to reach the equivalence point. At half this volume (12.5 mL added), pH = pKa. Calculate the pH at the half-equivalence point.",
            TT_C3: "Indicator range: Phenolphthalein changes colour between pH 8.2 and 10.0. Determine whether this indicator is suitable for a weak acid / strong base titration with an alkaline equivalence point.",
            TT_C4: "Diprotic acid titration: H₂SO₄ has two equivalence points (first: one H⁺ neutralized; second: both H⁺ neutralized). Determine the pH at the first equivalence point.",
            TT_C5: "Precision check: Three titration trials give volumes of 24.8, 25.1, and 24.9 mL. Calculate the average volume to use as the final result in your analysis report.",
            TT_A1: "Weak acid titration curve: Calculate the pH at 10%, 50%, 90%, and 100% neutralization of 0.1 M CH₃COOH with 0.1 M NaOH, using Henderson-Hasselbalch and Ka = 1.8×10⁻⁵.",
            TT_A2: "Buffer region: Between 25% and 75% neutralization, pH changes by only ≈1 unit. Identify this flat region on the titration curve and explain why the solution resists pH change here.",
            TT_A3: "Polyprotic acid H₃PO₄ titration shows three equivalence points (pKa₁ = 2.15, pKa₂ = 7.20, pKa₃ = 12.35). Calculate the pH at each equivalence point.",
            TT_A4: "Derivative titration: The rate of pH change d(pH)/dV is maximum at the equivalence point. Use the derivative curve to pinpoint the exact equivalence volume from experimental data.",
            TT_A5: "Gran plot: Linearize the pre-equivalence data by plotting V × 10^(–pH) vs volume added. The extrapolated x-intercept gives the equivalence volume for weak acid titrations.",
            TT_E1: "Pharmacopoeia Standards: A weak organic acid drug is titrated. The half-equivalence point occurs at pH 4.75. Determine pKa, which must be reported on the Certificate of Analysis for regulatory submission.",
