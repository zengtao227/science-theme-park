...
export const deCommon = {
    ...
    home: {
        ...
        sp3_02_subtitle: "Mechanik in Basel: Erforsche Reibung, Beschleunigung und Kollisionsdynamik.",
        sp3_03_title: "SP3.03 // ENERGIE & LEISTUNG",
        sp3_03_subtitle: "Modelliere die Rheinhydropower mit potenzieller, kinetischer Energie und Leistung.",
        sp3_04_title: "SP3.04 // DRUCK & FLUIDE",
        sp3_04_subtitle: "Erkunde Druck, Auftrieb und Hydraulik im Basler Rheinhafen.",
        sp3_05_title: "SP3.05 // EINFACHE MASCHINEN",
        sp3_05_subtitle: "Meistere Hebel, Flaschenzüge und schiefe Ebenen mit Basler Baustellen-Szenarien.",
        sp3_06_title: "SP3.06 // AKUSTIK",
        sp3_06_subtitle: "Wellen, Schall und Musikphysik im Stadtcasino Basel.",
        ...
        sp1_01_old: { // Keep old reference if needed for other places, but remove from direct home keys if possible. Actually just flat is better.
