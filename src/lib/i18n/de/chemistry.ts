...
export const deChemistry = {
    ...
    gc3_02: {
        ...
        labels: {
            ...
            tet_voids: "Tet. Hohlräume",
            voids: "ZWISCHENGITTERPLÄTZE",
            tetrahedral: "Tetraedrisch",
            octahedral: "Oktaedrisch",
            show_voids: "Zwischengitterplätze anzeigen",
    ...
    sc2_01: {
        ...
        prompts: {
            arr_b: "Berechne die Geschwindigkeitskonstante k mit der Arrhenius-Gleichung.",
            arr_c1: "Berechne, wie stark sich k bei Temperaturaenderung aendert.",
            arr_c2: "Berechne den Anstieg von k bei kleinerer Aktivierungsenergie.",
            arr_c3: "Berechne ln(k) aus den gegebenen Parametern.",
            arr_c4: "Berechne die Aktivierungsenergie E_a aus den Daten.",
            arr_c5: "Berechne das Verhaeltnis k_new / k_old nach Katalyse.",
            arr_a1: "Bestimme E_a mit ln(k2/k1).",
            arr_a2: "Berechne E_a aus der Steigung des Arrhenius-Diagramms.",
            arr_a3: "Berechne den Praeexponentialfaktor A.",
            arr_a4: "Berechne die erforderliche Temperatur T fuer das Ziel-k.",
            arr_a5: "Berechne k_cat aus den gegebenen Werten.",
            arr_e1: "Berechne die Gesamtgeschwindigkeitskonstante k_overall.",
            arr_e2: "Berechne die druckabhaengige Konstante k(P).",
            arr_e3: "Berechne die tunnelkorrigierte Konstante k_tunnel.",
            arr_e4: "Berechne das kinetische Isotopenverhaeltnis k_H / k_D.",
            arr_e5: "Berechne die Aktivierungs-Gibbsenergie Delta G double dagger.",
            rl_b: "Berechne die Reaktionsrate aus dem Geschwindigkeitsgesetz.",
            rl_b4: "Berechne die neue Reaktionsrate nach Konzentrationsaenderung.",
            rl_b5: "Berechne die Anfangsrate rate_0.",
            rl_c2: "Bestimme die Reaktionsordnung n aus dem Versuchsmuster.",
            rl_c3: "Berechne die Konzentration [A]_t zum Zeitpunkt t.",
            rl_c4: "Berechne die benoetigte Reaktionszeit t.",
            rl_c5: "Berechne die Geschwindigkeitskonstante k aus Messdaten.",
            rl_a2: "Berechne die Gesamtreaktionsrate des Mehrstufenprozesses.",
            rl_a3: "Berechne die stationaere Zwischenkonzentration [I]_ss.",
            rl_a4: "Berechne die Gleichgewichtskonstante K_eq aus den Konstanten.",
            rl_e1: "Berechne die maximale Konzentration [A]_max.",
            rl_e2: "Berechne die Wendepunktzeit t_inflection.",
            rl_e3: "Berechne die Kettenlaenge der Kettenreaktion.",
            rl_e4: "Berechne die Quantenausbeute Phi.",
            rl_e5: "Berechne die maximale Rate V_max.",
            hl_b: "Berechne die Halbwertszeit t_1/2.",
            hl_b4: "Berechne die verbleibende Konzentration [A] nach Zerfall.",
            hl_c2: "Berechne den verbleibenden Anteil f.",
            hl_c3: "Berechne die verbleibende Menge N_t zur Zeit t.",
            hl_c4: "Berechne die verbleibende Arzneimittelkonzentration [D]_t.",
            hl_c5: "Berechne das Verhaeltnis t_1/2,A / t_1/2,B.",
            hl_a1: "Berechne die Zeit t_max des Maximums.",
            hl_a2: "Berechne die Gesamt-Halbwertszeit t_1/2,overall.",
            hl_a3: "Berechne die Gleichgewichtskonzentration [A]_eq.",
            hl_a4: "Berechne die Halbwertszeit bei 350K.",
    ...
    sc2_02: {
        ...
        labels: {
            ...
            answer_target: "\\text{Antwort}",
            answer_slot: "Antwort",
            result_placeholder: "Ergebnis",
            indicator_target: "\\text{Indikator}",
            indicator_slot: "Indikator",
            indicator_placeholder: "Indikatorname",
            monitor_indicator: "INDIKATOR",
            monitor_acid_type: "SÄURETYP",
            ph_range: "pH-Bereich",
        ...
        prompts: {
            ...
            curves_basic_1: "Bestimme den Typ der Titrationskurve.",
            curves_basic_2: "Bestimme die Kurve einer schwachen Säure.",
            curves_basic_3: "Bestimme das Äquivalenzvolumen.",
            curves_basic_4: "Berechne das Volumen am Äquivalenzpunkt.",
            curves_basic_5: "Bestimme das Äquivalenzvolumen der schwachen Säure.",
            curves_core_1: "Bestimme den pH-Wert am Äquivalenzpunkt.",
            curves_core_2: "Bestimme den pH-Wert einer schwachen Säure am Äquivalenzpunkt.",
            curves_core_3: "Bestimme den Äquivalenz-pH bei starker Säure.",
            curves_core_4: "Bestimme den pH-Wert im Pufferbereich.",
            curves_core_5: "Bestimme das Äquivalenzvolumen bei verdünnter Säure.",
            curves_advanced_1: "Bestimme den pKa-Wert der schwachen Säure.",
            curves_advanced_2: "Berechne den Äquivalenzpunkt bei hoher Konzentration.",
            curves_advanced_3: "Schätze das Volumen für die Pufferkapazität.",
            curves_advanced_4: "Bestimme den pH-Wert am Halbäquivalenzpunkt.",
            curves_advanced_5: "Berechne das präzise Äquivalenzvolumen.",
            curves_elite_1: "Löse die komplexe pKa-Berechnung.",
            curves_elite_2: "Analysiere den Niedrigkonzentrations-Pufferfall.",
            curves_elite_3: "Löse die mehrstufige Äquivalenzrechnung.",
            curves_elite_4: "Löse den erweiterten Puffer-Volumenfall.",
            curves_elite_5: "Bestimme den exakten pH bei 25 mL zugegebener Base.",
            equivalence_basic_1: "Bestimme Vb am Äquivalenzpunkt.",
            equivalence_basic_2: "Berechne Vb am Äquivalenzpunkt.",
            equivalence_basic_3: "Berechne das Äquivalenzvolumen Vb.",
            equivalence_basic_4: "Bestimme das benötigte Vb für Äquivalenz.",
            equivalence_basic_5: "Berechne Vb für diese Äquivalenzbedingung.",
            equivalence_core_1: "Berechne das präzise Äquivalenzvolumen.",
            equivalence_core_2: "Bestimme Vb für den Hochkonzentrationsfall.",
            equivalence_core_3: "Bestimme Vb für den Niedrigkonzentrationsfall.",
            equivalence_core_4: "Löse die komplexe Äquivalenzvolumen-Rechnung.",
            equivalence_core_5: "Löse den umgekehrten Konzentrations-Volumen-Fall.",
            equivalence_advanced_1: "Bestimme Vb im verdünnten Fall.",
            equivalence_advanced_2: "Bestimme Vb beim Konzentrationsverhältnis 2:1.",
            equivalence_advanced_3: "Bestimme Vb im inversen Verhältnisfall.",
            equivalence_advanced_4: "Berechne Vb mit hoher Präzision.",
            equivalence_advanced_5: "Berechne Vb beim Verhältnis 1:3.",
            equivalence_elite_1: "Bestimme Vb für dieses komplexe Verhältnis.",
            equivalence_elite_2: "Bestimme Vb für dieses nahezu 1:1-Verhältnis.",
            equivalence_elite_3: "Bestimme Vb für den präzisen Verdünnungsfall.",
            equivalence_elite_4: "Bestimme Vb für den nahen Konzentrationsfall.",
            equivalence_elite_5: "Bestimme Vb für diese Feineinstellung.",
            indicators_basic_1: "Wähle einen Indikator für starke Säure-Titration.",
            indicators_basic_2: "Wähle einen Indikator für den sauren Bereich.",
            indicators_basic_3: "Wähle einen Indikator für schwache Säure-Titration.",
            indicators_basic_4: "Wähle einen Indikator für einen breiten pH-Bereich.",
            indicators_basic_5: "Wähle einen Indikator für den basischen Umschlagbereich.",
            indicators_core_1: "Wähle den besten Indikator für schwache Säure-Titration.",
            indicators_core_2: "Wähle den Indikator für den sauren Umschlagbereich.",
            indicators_core_3: "Wähle den Indikator nahe neutraler schwacher Säure.",
            indicators_core_4: "Wähle den Indikator für den neutralen Bereich.",
            indicators_core_5: "Wähle den Indikator für den Pufferfall der schwachen Säure.",
            indicators_advanced_1: "Wähle den Indikator für den Halbäquivalenzbereich.",
            indicators_advanced_2: "Wähle den Indikator für sehr niedrigen pH.",
            indicators_advanced_3: "Wähle den Indikator für den hohen pH bei schwacher Säure.",
            indicators_advanced_4: "Wähle den Indikator für den Vollbereichstest.",
            indicators_advanced_5: "Wähle den Indikator für den Äquivalenzbereich schwacher Säure.",
            indicators_elite_1: "Wähle den Indikator für den präzisen schwachen Säurebereich.",
            indicators_elite_2: "Wähle den Indikator für einen engen sauren Bereich.",
            indicators_elite_3: "Wähle den Indikator für den Pufferbereich.",
            indicators_elite_4: "Wähle den Indikator für den präzisen Neutralbereich.",
    ...
    sc2_03: {
        ...
        prompts: {
            boyle_given: "V_1=10L, P_1=1bar, V_2=5L",
            charles_given: "V_1=20L, T_1=300K, T_2=330K",
            combined_given: "P_1=1, V_1=10, P_2=2",
    ...
    sc2_04: {
        ...
        stages: {
            ...
            elite_hint: "Analysieren Sie die Daten rigoros."
        },
        prompts: {
            solubility_given: "T = {temp}°C",
            elite_rhine_sample: "Rhein-Wasserprobe A: Masse vorher=100g, nachher=99.8g."
        },
        scenarios: {
    ...
    sc3_01: {
        ...
        labels: {
            ...
            bond: "Bindung",
            snap: "Einrasten",
            carbon: "\\text{Kohlenstoff}",
            hydrogen: "\\text{Wasserstoff}",
            oxygen: "\\text{Sauerstoff}",
            nitrogen: "\\text{Stickstoff}",
            total: "\\text{Gesamt}",
            mass_per_mol: "\\text{Masse (g/mol)}",
            percent: "\\text{Prozent}",
            bonds: "\\text{Bindungen}",
            groups: "\\text{Gruppen}",
            rings: "\\text{Ringe}",
        ...
        hints: {
            ...
            oxygen_is_red: "\\text{Sauerstoff ist rot.}",
            nitrogen_is_blue: "\\text{Stickstoff ist blau.}",
            add_all_atoms: "\\text{Alle Atome addieren.}",
            count_black_spheres: "\\text{Schwarze Kugeln zählen.}",
            smallest_white_atoms: "\\text{Kleinste weiße Atome.}",
            red_spheres: "\\text{Rote Kugeln.}",
            simplify_if_possible: "\\text{Wenn möglich vereinfachen.}",
            carbon_over_total: "\\text{Kohlenstoff / Gesamtatome}",
            roughly_atoms_minus_one: "\\text{Ungefähr Atome - 1}",
            already_simplified: "\\text{Bereits vereinfacht}",
            use_precise_masses: "\\text{Genaue Atommassen verwenden}",
            exact_count_required: "\\text{Genaue Zählung erforderlich}",
            mass_of_c_over_total: "\\text{Masse von C / Gesamtmasse}",
        ...
        prompts: {
            ...
            find_hydrogen_count: "Bestimmen Sie die Anzahl der Wasserstoffatome in {molecule}.",
            find_oxygen_count: "Bestimmen Sie die Anzahl der Sauerstoffatome in {molecule}.",
            find_nitrogen_count: "Bestimmen Sie die Anzahl der Stickstoffatome in {molecule}.",
            total_atom_count: "Wie viele Atome hat {molecule} insgesamt?",
            verify_carbon_atoms: "Überprüfen Sie die Kohlenstoffatome in {molecule}.",
            count_hydrogen: "Zählen Sie die Wasserstoffatome in {molecule}.",
            oxygen_atoms: "Wie viele Sauerstoffatome hat {molecule}?",
            co_ratio: "Wie ist das C:O-Verhältnis in {molecule}?",
            approx_molar_mass: "Bestimmen Sie die ungefähre molare Masse von {molecule}.",
            complete_formula: "Vervollständigen Sie die Formel von {molecule}.",
            carbon_percentage: "Wie groß ist der Kohlenstoffanteil in {molecule}?",
            estimate_bond_count: "Schätzen Sie die Anzahl der Bindungen in {molecule}.",
            simplest_ratio: "Geben Sie das einfachste Verhältnis für {molecule} an.",
            precise_molar_mass: "Berechnen Sie die genaue molare Masse von {molecule}.",
            identify_formula_precisely: "Geben Sie die Formel von {molecule} exakt an.",
    ...
    sc3_02: {
        ...
        scenarios: {
            ...
            green_chemistry_initiative: "Die Green-Chemistry-Initiativen der Universität Basel zielen darauf ab, die Umweltauswirkungen der organischen Synthese durch katalytische Innovationen zu verringern.",
            ...
            givaudan_fragrance_design: "Givaudan in Basel kombiniert organische Chemie mit künstlerischer Intuition, um die nächste Generation globaler Düfte zu entwerfen."
        }
    },
    sc3_03: {
        back: "Zurück zum Nexus",
    ...
    sc2_05: {
        ...
        contexts: {
            PH_B1: "Berechne den pH-Wert einer 0,1 M HCl-Lösung. HCl ist eine starke Säure, die in Wasser vollständig dissoziiert. Verwende pH = -log[H⁺].",
            PH_B2: "Berechne den pH-Wert von reinem Wasser bei 25 °C. Bei dieser Temperatur beträgt die Eigendissoziation [H⁺] = 1×10⁻⁷ M. Bestimme den neutralen pH-Wert.",
            PH_B3: "Berechne den pH-Wert einer 0,01 M NaOH-Lösung. NaOH ist eine starke Base. Berechne zuerst pOH, dann: pH = 14 - pOH.",
            PH_B4: "Berechne den pH-Wert einer 0,001 M HNO₃-Lösung. Salpetersäure ist eine starke Säure. Setze [H⁺] = 0,001 M in pH = -log[H⁺] ein.",
            PH_B5: "Berechne den pH-Wert einer 0,0001 M KOH-Lösung. KOH ist eine starke Base. Berechne zuerst pOH, dann: pH = 14 - pOH.",
            PH_C1: "Berechne den pH-Wert einer schwachen Säure CH₃COOH (Ka = 1,8×10⁻⁵, C = 0,1 M). Schwache Säuren dissoziieren nur teilweise. Verwende die Näherungsformel pH = ½(pKa - log C).",
            PH_C2: "Eine Pufferlösung enthält 0,1 M CH₃COOH + 0,1 M CH₃COONa. Wende die Henderson-Hasselbalch-Gleichung an: pH = pKa + log([A⁻]/[HA]).",
            PH_C3: "Berechne den pH-Wert einer 0,01 M NH₃-Lösung (Kb = 1,8×10⁻⁵). Ammoniak ist eine schwache Base. Berechne pOH aus Kb, dann: pH = 14 - pOH.",
            PH_C4: "Ein gemischter Puffer enthält 0,2 M HA + 0,1 M A⁻, pKa = 5,0. Wende Henderson-Hasselbalch an: pH = pKa + log([A⁻]/[HA]).",
            PH_C5: "Berechne den pH nach der Verdünnung von 0,1 M HCl auf 0,001 M. Bei 100-facher Verdünnung einer starken Säure sinkt [H⁺] proportional. Bestimme den neuen pH-Wert.",
            PH_A1: "Mehrprotonige Säure H₂SO₄: Die erste Dissoziation verläuft vollständig, die zweite hat Ka₂ = 1,2×10⁻². Berechne die Gesamt-H⁺-Konzentration und den pH-Wert.",
            PH_A2: "Wende Henderson-Hasselbalch mit pH = 5,5 und pKa = 4,76 an. Forme die Gleichung um, um das Verhältnis [A⁻]/[HA] zu berechnen, das diesen pH ergibt.",
            PH_A3: "Aminosäure Glycin am isoelektrischen Punkt (pI = 6,0) trägt keine Nettoladung. Berechne pI = ½(pKa₁ + pKa₂) mit den gegebenen Dissoziationskonstanten.",
            PH_A4: "Berechne den pH-Wert einer 0,05 M H₃PO₄-Lösung (Ka₁ = 7,5×10⁻³). Nur die erste Dissoziation ist relevant. Verwende die Schwachsäure-Näherung, um [H⁺] zu bestimmen.",
            PH_A5: "Beurteile die Pufferkapazität von 0,5 M CH₃COOH + 0,5 M CH₃COONa. Höhere Konzentration bedeutet höhere Kapazität. Berechne den pH und bestimme die Kapazitätsgrenze.",
            PH_E1: "Novartis-Enzympuffer: Ionenstärke beeinflusst den effektiven pKa. Für einen 0,1 M Puffer mit γ(A⁻) = 0,8 und pKa(ideal) = 4,76, berechne pKa(eff) = pKa(ideal) - log(γ(A⁻)).",
            PH_E2: "Universitätsspital Basel – Hypothermiebehandlung: Blut-pKa beträgt 6,1 bei 37 °C, steigt auf 6,25 bei 30 °C. Wenn [HCO₃⁻]/[CO₂] = 20 bei 30 °C, berechne den Blut-pH mit Henderson-Hasselbalch.",
            PH_E3: "Parenterale Ernährung: Aminosäure Glycin (pKa₁ = 2,35, pKa₂ = 9,78) wirkt am isoelektrischen Punkt als Zwitterion-Puffer. Berechne pI = ½(pKa₁ + pKa₂) für den optimalen Infusions-pH.",
            PH_E4: "Physiologischer Puffer: Blut-pH wird bei 7,4 gehalten. Gegeben: [HCO₃⁻] = 24 mM, pKa = 6,1. Berechne P(CO₂) in mmHg mit Henderson-Hasselbalch und Löslichkeitskonstante α = 0,03 mM/mmHg.",
            PH_E5: "Metabolische Azidose: [HCO₃⁻] eines Patienten sinkt auf 15 mM. Berechne den P(CO₂), der durch respiratorische Kompensation benötigt wird, um pH 7,1 zu erreichen – als Grundlage für Beatmungseinstellungen.",
            NT_B1: "HCl + NaOH → NaCl + H₂O. Bei gleicher Molzahl von Säure und Base, berechne die entstandenen Mole NaCl. Das 1:1-Verhältnis ist die Basis aller Neutralisationsberechnungen.",
            NT_B2: "Mische 50 mL 0,2 M HCl mit 50 mL 0,2 M NaOH. Gleiche Molmengen reagieren vollständig. Bestimme den pH-Wert der entstehenden neutralen Salzlösung.",
            NT_B3: "Mische 25 mL 0,1 M H₂SO₄ mit 50 mL 0,1 M NaOH. H₂SO₄ ist zweiprotonig. Vergleiche die Molzahlen von H⁺ und OH⁻, um zu prüfen, ob vollständige Neutralisation eintritt.",
            NT_B4: "Mische 20 mL 0,15 M HNO₃ mit 30 mL 0,1 M KOH. Berechne die Molzahl jedes Reaktanden, um zu bestimmen, welcher nach der Neutralisationsreaktion im Überschuss vorliegt.",
            NT_B5: "Mische 10 mL 0,5 M HCl mit 25 mL 0,2 M NaOH. Berechne das Gesamtvolumen der Endlösung – diese Angabe wird benötigt, bevor die Endkonzentration bestimmt werden kann.",
            NT_C1: "Säureüberschuss: Mische 30 mL 0,2 M HCl mit 20 mL 0,2 M NaOH. Nicht alle Säure wird neutralisiert. Berechne die verbleibende [H⁺] in der Endlösung und bestimme den pH.",
            NT_C2: "Baseüberschuss: Mische 25 mL 0,1 M HCl mit 40 mL 0,1 M NaOH. Die Base ist im Überschuss. Berechne die verbleibende [OH⁻] und bestimme den pH der Lösung.",
            NT_C3: "Zweiprotonige Säure: H₂SO₄ + 2 NaOH → Na₂SO₄ + 2 H₂O. Bestimme das für vollständige Neutralisation notwendige Molverhältnis. Das 1:2-Verhältnis ist entscheidend für korrekte Stöchiometrie.",
            NT_C4: "Neutralisationswärme: ΔH = -57,3 kJ/mol für starke Säure + starke Base. Berechne die freigesetzte Wärme, wenn eine bestimmte Molzahl HCl mit NaOH in einem Kalorimeter reagiert.",
            NT_C5: "Gemischte Neutralisation: Zu einem Gemisch aus 20 mL 0,1 M HCl + 20 mL 0,1 M CH₃COOH werden 40 mL 0,1 M NaOH gegeben. Berechne die Gesamtmolzahl der Säuren und prüfe, ob NaOH beide vollständig neutralisiert.",
            NT_A1: "Schwache Säure + starke Base: CH₃COOH + NaOH → CH₃COONa + H₂O. Am Äquivalenzpunkt bleibt nur die konjugierte Base. Berechne den pH mit Kb von CH₃COO⁻.",
            NT_A2: "Schwache Base + starke Säure: NH₃ + HCl → NH₄Cl. Am Äquivalenzpunkt bleibt nur NH₄⁺. Berechne den pH mit Ka von NH₄⁺ (pKa = 14 - pKb).",
            NT_A3: "Teilneutralisation: Gib 25 mL 0,1 M NaOH zu 50 mL 0,1 M CH₃COOH. Die Hälfte der Säure wird neutralisiert, es entsteht ein Puffer. Wende Henderson-Hasselbalch an.",
            NT_A4: "Mehrprotonige Neutralisation: H₃PO₄ + 3 NaOH → Na₃PO₄ + 3 H₂O. Berechne das Molverhältnis und das benötigte NaOH-Volumen für vollständige Neutralisation.",
            NT_A5: "Konduktometrische Titration: Am Äquivalenzpunkt werden alle Ionen zu Wasser und Salz vereinigt – die Leitfähigkeit sinkt auf ein Minimum. Identifiziere diesen Punkt im Leitfähigkeit-Volumen-Diagramm.",
            NT_E1: "Blutpuffer-Neutralisation: Ein CO₂-Anstieg erzeugt 0,02 mol H₂CO₃. Berechne die benötigte Molzahl OH⁻ aus einem Medikament für vollständige Neutralisation – als Grundlage für die Dosierungsentscheidung.",
            NT_E2: "Amphoterer Puffer: H₂PO₄⁻ wirkt sowohl als Säure als auch als Base. Berechne die von 0,1 mol HPO₄²⁻ neutralisierte H⁺-Menge gemäß: HPO₄²⁻ + H⁺ → H₂PO₄⁻.",
            NT_E3: "Novartis Qualitätskontrolle: Neutralisation eines sauren Abwasserstroms. 100 L einer 0,05 M H₂SO₄ müssen behandelt werden. Berechne die benötigte Ca(OH)₂-Menge für die vollständige Neutralisation vor der sicheren Entsorgung.",
            NT_E4: "Milchsäure-Neutralisation: Beim Sport gelangen 0,05 mol CH₃CH(OH)COOH ins Blut. Berechne die vom Bicarbonatsystem verbrauchten HCO₃⁻-Mole, um den Blut-pH aufrechtzuerhalten.",
            NT_E5: "Renale Kompensation: Die Niere scheidet NH₄⁺ aus, um überschüssige H⁺ zu eliminieren. Wenn 0,1 mol NH₄⁺ im Urin ausgeschieden werden, berechne die dabei dem Blut zurückgegebene Menge an 'neuem' HCO₃⁻.",
            TT_B1: "Verwende C₁V₁ = C₂V₂ (für Titrationen: n₁ = n₂ am Äquivalenzpunkt). Berechne das Volumen 0,2 M NaOH, das zur vollständigen Neutralisation von 25 mL 0,1 M HCl benötigt wird.",
            TT_B2: "20 mL einer unbekannten HCl-Lösung werden am Äquivalenzpunkt von 30 mL 0,15 M NaOH neutralisiert. Berechne die HCl-Konzentration aus n(HCl) = n(NaOH).",
            TT_B3: "Titration von 50 mL 0,1 M CH₃COOH mit 0,1 M NaOH. Berechne das NaOH-Volumen am Äquivalenzpunkt aus n(Säure) = n(Base).",
            TT_B4: "Indikatorauswahl für starke Säure/starke Base: Am Äquivalenzpunkt liegt pH = 7. Bestimme einen geeigneten Indikator und berechne den erwarteten pH am Äquivalenzpunkt.",
            TT_B5: "Büretten-Ablesung: Anfangswert 0,50 mL, Endwert 25,80 mL. Berechne das tatsächlich zugegebene Titrationsmittelvolumen durch Subtraktion.",
            TT_C1: "Titrationskurvenanalyse: Ein steiler pH-Anstieg von 4 auf 10 markiert den Äquivalenzpunkt. Lese das genaue Äquivalenzvolumen am Wendepunkt der Kurve ab.",
            TT_C2: "Halbäquivalenzpunkt: 25 mL NaOH werden bis zum Äquivalenzpunkt benötigt. Bei halber Zugabe (12,5 mL) gilt pH = pKa. Berechne den pH am Halbäquivalenzpunkt.",
            TT_C3: "Indikatorbereich: Phenolphthalein wechselt die Farbe zwischen pH 8,2 und 10,0. Prüfe, ob dieser Indikator für eine Titration von schwacher Säure/starker Base mit alkalischem Äquivalenzpunkt geeignet ist.",
            TT_C4: "Zweiprotonige Titration: H₂SO₄ hat zwei Äquivalenzpunkte (erster: ein H⁺ neutralisiert; zweiter: beide H⁺ neutralisiert). Bestimme den pH am ersten Äquivalenzpunkt.",
            TT_C5: "Präzisionsprüfung: Drei Titrationsversuche ergeben 24,8, 25,1 und 24,9 mL. Berechne das Mittelvolumen für den Analysebericht.",
            TT_A1: "Schwachsäure-Titrationskurve: Berechne den pH bei 10 %, 50 %, 90 % und 100 % Neutralisation von 0,1 M CH₃COOH mit 0,1 M NaOH (Ka = 1,8×10⁻⁵) mittels Henderson-Hasselbalch.",
            TT_A2: "Pufferbereich: Zwischen 25 % und 75 % Neutralisation ändert sich der pH nur um ca. 1 Einheit. Markiere diesen flachen Bereich auf der Titrationskurve und erläutere den Puffereffekt.",
            TT_A3: "Mehrprotonige H₃PO₄-Titration zeigt drei Äquivalenzpunkte (pKa₁ = 2,15, pKa₂ = 7,20, pKa₃ = 12,35). Berechne den pH an jedem Äquivalenzpunkt.",
            TT_A4: "Derivativtitration: d(pH)/dV ist am Äquivalenzpunkt maximal. Nutze die Ableitungskurve, um aus Messdaten das genaue Äquivalenzvolumen zu bestimmen.",
            TT_A5: "Gran-Plot: Linearisiere die Daten vor dem Äquivalenzpunkt durch Auftragen von V × 10^(–pH) gegen das zugegebene Volumen. Der extrapolierte x-Achsenabschnitt ergibt das Äquivalenzvolumen.",
            TT_E1: "Pharmakopöe-Standards: Eine schwache organische Arzneisäure wird titriert. Der Halbäquivalenzpunkt liegt bei pH 4,75. Bestimme pKa – ein Pflichtparameter im Certificate of Analysis für die Zulassungsbehörde.",
        ...
        prompts: {
            ...
            ph_b1: "\\\\text{pH} = -\\log[H^+]",
            ph_b2: "\\\\text{pH} = -\\log[H^+]",
            ph_b3: "\\\\text{pOH} = -\\log[OH^-], \\\\text{pH} = 14 - \\\\text{pOH}",
            ph_b4: "\\\\text{pH} = -\\log[H^+]",
            ph_b5: "\\\\text{pOH} = -\\log[OH^-], \\\\text{pH} = 14 - \\\\text{pOH}",
            ph_c1: "\\\\text{pH} = \\\\frac{1}{2}(\\\\text{pKa} - \\log C)",
            ph_c2: "\\\\text{pH} = \\\\text{pKa} + \\log\\\\frac{[A^-]}{[HA]}",
            ph_c3: "\\\\text{pOH} = \\\\frac{1}{2}(\\\\text{pKb} - \\log C)",
            ph_c4: "\\\\text{pH} = \\\\text{pKa} + \\log\\\\frac{[A^-]}{[HA]}",
            ph_c5: "\\\\text{pH} = -\\log[H^+]",
            ph_a1: "\\\\text{pH (polyprotic)}",
            ph_a2: "\\\\text{pH} = \\\\text{pKa} + \\log\\\\frac{[A^-]}{[HA]}",
            ph_a3: "\\\\text{pI} = \\\\frac{\\\\text{pKa}_1 + \\\\text{pKa}_2}{2}",
            ph_a4: "\\\\text{pH (triprotic)}",
            ph_a5: "\\beta = 2.303 \\times C \\times \\\\frac{K_a[H^+]}{(K_a + [H^+])^2}",
            ph_e1: "pKa_{eff} = pKa_{ideal} + \\log \\gamma_{A^-}",
            ph_e2: "\\\\text{pH} = pKa(T) + \\log\\\\frac{[HCO_3^-]}{[CO_2]}",
            ph_e3: "pI = \\\\frac{pKa_1 + pKa_2}{2}",
            ph_e4: "\\\\text{pH} = 6.1 + \\log\\\\frac{[HCO_3^-]}{0.03 \\times P_{CO2}}",
            ph_e5: "\\\\text{pH} = 6.1 + \\log\\\\frac{[HCO_3^-]}{0.03 \\times P_{CO2}}",
            nt_b1: "n_{\\\\text{salt}} = n_{\\\\text{acid}} = n_{\\\\text{base}}",
            nt_b2: "\\\\text{pH}_{\\\\text{equivalence}}",
            nt_b3: "n_{H^+} = 2 \\times n_{H_2SO_4}",
            nt_b4: "n_{\\\\text{excess}}",
            nt_b5: "V_{\\\\text{total}}",
            nt_c1: "[H^+]_{\\\\text{excess}} = \\\\frac{n_{\\\\text{excess}}}{V_{\\\\text{total}}}",
            nt_c2: "[OH^-]_{\\\\text{excess}} = \\\\frac{n_{\\\\text{excess}}}{V_{\\\\text{total}}}",
            nt_c3: "\\\\frac{n_{H_2SO_4}}{n_{NaOH}}",
            nt_c4: "Q = n \\times \\Delta H",
            nt_c5: "\\\\text{pH}_{\\\\text{final}}",
            nt_a1: "\\\\text{pH} > 7 \\\\text{ (salt hydrolysis)}",
            nt_a2: "\\\\text{pH} < 7 \\\\text{ (salt hydrolysis)}",
            nt_a3: "\\\\text{pH} = \\\\text{pKa} + \\log\\\\frac{[A^-]}{[HA]}",
            nt_a4: "n_{\\\\text{base required}}",
            nt_a5: "V_{\\\\text{equivalence}}",
            nt_e1: "n_{OH^-} = 2 \\times n_{H_2CO_3} \\\\text{ (complete neutralization)}",
            nt_e2: "n_{H^+} = n_{HPO_4^{2-}}",
            nt_e3: "n_{acid} \\times 2 = n_{base} \\times 2",
            nt_e4: "n_{HCO_3^-} = n_{\\\\text{lactic acid}}",
            nt_e5: "n_{HCO_3^- \\\\text{ (new)}} = n_{NH_4^+ \\\\text{ (excreted)}}",
            tt_b1: "V_2 = \\\\frac{C_1V_1}{C_2}",
            tt_b2: "C_1 = \\\\frac{C_2V_2}{V_1}",
            tt_b3: "V_{\\\\text{eq}} = V_{\\\\text{acid}}",
            tt_b4: "\\\\text{pH}_{\\\\text{eq}}",
            tt_b5: "V_{\\\\text{delivered}} = V_{\\\\text{final}} - V_{\\\\text{initial}}",
            tt_c1: "\\\\text{Equivalence point}",
            tt_c2: "\\\\text{pH}_{1/2} = \\\\text{pKa}",
            tt_c3: "\\\\text{Suitable?}",
            tt_c4: "\\\\text{pH}_{\\\\text{eq1}}",
            tt_c5: "\\bar{V} = \\\\frac{\\sum V_i}{n}",
            tt_a1: "\\\\text{pH}_{50\\%} = \\\\text{pKa}",
            tt_a2: "\\Delta \\\\text{pH}",
            tt_a3: "\\\\text{Number of equivalence points}",
            tt_a4: "\\\\frac{d(\\\\text{pH})}{dV}_{\\\\text{max}}",
            tt_a5: "\\\\text{Linear extrapolation}",
            tt_e1: "\\\\text{pKa} = \\\\text{pH}_{1/2}",
    ...
    sc1_06: {
        scenarios: {
            ...
            EB_ELITE_1: "In the Novartis Historical Pharmaceutical Laboratory, ...",
            EB_ELITE_2: "At the Roche Advanced Organic Synthesis Laboratory, ...",
            EB_ELITE_3: "In the Novartis Pharmaceutical Research Laboratory, ...",
            EB_ELITE_4: "At the Roche Pharmaceutical Synthesis Facility, ...",
            EB_ELITE_5: "In the Novartis Pharmaceutical Salt Formation Laboratory, ...",
            ...
            RS_ADVANCED_4: "In the Roche Organic Synthesis Laboratory, ...",
            RS_ADVANCED_5: "At the Novartis Catalytic Hydrogenation Facility, ...",
            RS_ELITE_1: "In the Novartis Advanced Pharmaceutical Synthesis Laboratory, ...",
            RS_ELITE_2: "At the Roche Esterification Laboratory, ...",
            RS_ELITE_3: "In the Roche Advanced Organic Chemistry Laboratory, ...",
            RS_ELITE_4: "At the Novartis Pharmaceutical Methylation Laboratory, ...",
            RS_ELITE_5: "In the Novartis Historical Pharmaceutical Laboratory, ..."
        },
        back: "Zurück zum Nexus",
    ...
    sc2_07: {
        scenarios: {
            ...
            HL_ADVANCED_1: "In the Novartis Bioethanol Research Laboratory ...",
            HL_ADVANCED_2: "At the Roche Pharmaceutical Waste Management Facility ...",
            HL_ADVANCED_3: "In the Basel Chemistry Institute's Inorganic Synthesis Laboratory ...",
            HL_ADVANCED_4: "At the Novartis Catalytic Hydrogenation Research Laboratory ...",
            HL_ADVANCED_5: "In the Basel Biochemistry Research Institute's Fermentation Laboratory ...",
            HL_ELITE_1: "In the Novartis Historical Pharmaceutical Synthesis Laboratory ...",
            HL_ELITE_2: "At the Roche Advanced Pharmaceutical Synthesis Facility ...",
            HL_ELITE_3: "In the Novartis Antibiotic Synthesis Complex ...",
            HL_ELITE_4: "At the Roche Oncology Drug Manufacturing Facility ...",
            HL_ELITE_5: "In the Novartis Biologics Manufacturing Facility ...",
