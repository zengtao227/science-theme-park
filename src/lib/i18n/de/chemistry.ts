...
export const deChemistry = {
    ...
    sc2_01: {
        ...
        prompts: {
            arr_b: "k = Ae^{-E_a/RT}",
            arr_c1: "\\Delta T \\to \\Delta k",
            arr_c2: "E_a \\downarrow \\to k \\uparrow",
            arr_c3: "\\ln(k)",
            arr_c4: "E_a",
            arr_c5: "k_{\\text{neu}}/k_{\\text{alt}}",
            arr_a1: "\\ln(k_2/k_1)",
            arr_a2: "\\text{Steigung}",
            arr_a3: "A",
            arr_a4: "T",
            ...
            arr_e1: "k_{\\text{ges}}",
            arr_e2: "k(P)",
            arr_e3: "k_{\\text{tunnel}}",
            arr_e4: "k_H/k_D",
            arr_e5: "\\Delta G^\\ddagger",
            rl_b: "\\text{Rate}",
            rl_b4: "\\text{Rate}_{\\text{neu}}",
            rl_b5: "\\text{Rate}_0",
            rl_c2: "n",
            rl_c3: "[A]_t",
            rl_c4: "t",
            rl_c5: "k",
            rl_a2: "\\text{Rate}_{\\text{ges}}",
            rl_a3: "[I]_{\\text{ss}}",
            rl_a4: "K_{\\text{eq}}",
            rl_e1: "[A]_{\\text{max}}",
            rl_e2: "t_{\\text{Wende}}",
            rl_e3: "\\text{Kettenlänge}",
            rl_e4: "\\Phi",
            rl_e5: "V_{\\text{max}}",
            hl_b: "t_{1/2}",
            hl_b4: "[A]",
            ...
            hl_c3: "N_t",
            hl_c4: "[D]_t",
            hl_c5: "t_{1/2,A}/t_{1/2,B}",
            hl_a1: "t_{\\text{max}}",
            hl_a2: "t_{1/2,\\text{ges}}",
            hl_a3: "[A]_{\\text{eq}}",
            hl_a4: "t_{1/2}(350\\text{K})",
            hl_e1: "\\text{Alter}",
            hl_e2: "\\text{Verzweigungsverhältnis}",
            hl_e3: "A_2/A_1",
            hl_e5: "\\text{Expositionsalter}",
        },
        problems: {
