...
export const deBiology = {
    gb1_01: {
        ...
        hints: {
            delta_p_spq_squared: "Verwende die Näherung Δp ≈ s p q².",
            rare_alleles: "Seltene Allele bedeuten, dass q klein ist.",
            mean_fitness: "Die mittlere Fitness wird über die Genotypfrequenzen gewichtet.",
            balanced_polymorphism: "Das ist ein Gleichgewicht bei balancierter Polymorphie.",
            equilibrium: "Gehe zuerst vom Hardy-Weinberg-Gleichgewicht aus.",
            multiply_short: "Multipliziere die gegebenen Werte.",
            divide_speed: "Teile durch die verstrichenen Generationen.",
            inverse: "Verwende die Kehrwertbeziehung.",
            one_over_2n: "Nutze 1/(2N).",
            equal_sex: "Nimm gleich viele Männchen und Weibchen an.",
            ns_less_than_one: "Prüfe zuerst, ob Ns kleiner als 1 ist.",
            sample: "Behandle es als Stichprobenwahrscheinlichkeit.",
            structure: "Nutze die Formel zur Populationsstruktur.",
            pairwise: "Denke in paarweisen Abstammungslinien.",
            k_equals_u: "Unter Neutralität gilt k = u.",
            one_half_life: "Das entspricht einer Halbwertszeit.",
            two_half_lives: "Das entspricht zwei Halbwertszeiten.",
            three_half_lives: "Das entspricht drei Halbwertszeiten.",
            one_minus_one_over_2n: "Verwende 1 - 1/(2N).",
            quarter_remaining_path: "Folge der Halbierung bis zu einem Viertel Restmenge.",
            one_sixteenth_remaining: "1/16 Restmenge entspricht vier Halbwertszeiten.",
            definition_short: "Verwende direkt die Definition.",
            divide_short: "Teile die relevanten Größen.",
            calculate_short: "Führe die Rechnung schrittweise aus.",
            ln_2: "Beachte: ln 2 ≈ 0,693.",
            corrected: "Wende den Korrekturfaktor erst am Ende an.",
            formula: "Nutze die angegebene Modellformel.",
            adaptive: "Ein Wert größer als 1 spricht für adaptive Veränderung.",
            occam: "Bevorzuge den Baum mit weniger Änderungen.",
            percentage: "Deute 95 von 100 als Prozentsatz."
        },
        feedback: {
    ...
    gb2_02: {
        ...
        solver: {
            ...
            hormone_label: "Hormon:",
            gland_label: "Drüse:",
            target_organs_label: "Zielorgane:",
            feedback_chain_label: "Rückkopplungskette:",
            abnormal_labs_label: "Auffällige Laborwerte:",
            extract_endocrine_clue: "Endokrinen Hinweis herausarbeiten",
            trace_endocrine_mechanism: "Endokrinen Mechanismus nachverfolgen",
            trace_feedback_loop: "Stimulus und Antwort entlang der Rückkopplung verfolgen",
            trace_clinical_pattern: "Symptome und Laborabweichungen dem passenden endokrinen Muster zuordnen",
    ...
    sb1_01: {
        ...
        solver: {
            ...
            extract_organelle_clue: "Organellenhinweis herausarbeiten",
            trace_cell_role: "Zellrolle nachverfolgen",
            clue_size_label: "Größenhinweis:",
            clue_function_label: "Funktionshinweis:",
            clue_target_label: "Zielhinweis:",
            trace_identification_pattern: "Vergleiche Größe oder markantes Merkmal mit dem Organellenkatalog.",
            trace_function_pattern: "Folge der beschriebenen Zellaufgabe zu dem Organell, das sie erfüllt.",
            trace_fact_pattern: "Nutze die abgefragte Referenzangabe oder Zellbiologie-Tatsache als Entscheidungsmuster.",
    ...
    sb1_01_metabolic: {
        ...
        solver: {
            ...
            extract_metabolic_clue: "Stoffwechselhinweis herausarbeiten",
            trace_regulation_pattern: "Regulationsmuster nachverfolgen",
            osmotic_status_label: "Osmotischer Status:",
            respiration_clue_label: "Atmungshinweis:",
            homeostasis_clue_label: "Homöostase-Hinweis:",
            trace_osmosis_pattern: "Ordnen Sie die äußere Tonizität der Wasserbewegung zu, die das Gleichgewicht wiederherstellt.",
            trace_respiration_pattern: "Verfolgen Sie die Atmungskette von Brennstoff und Sauerstoff bis zu ATP, Kohlendioxid und Wasser.",
            trace_homeostasis_pattern: "Vergleichen Sie die Variable mit dem Sollwert und wählen Sie die Rückkopplungsreaktion, die sie wieder in den Normalbereich bringt.",
    ...
    sb1_02: {
        ...
        solver: {
            ...
            extract_photosynthesis_clue: "Photosynthese-Hinweis herausarbeiten",
            trace_photosynthesis_pattern: "Photosynthese-Muster nachverfolgen",
            clue_factor_label: "Faktor-Hinweis:",
            clue_structure_label: "Struktur-Hinweis:",
            trace_equation_pattern: "Verfolge die ausgeglichene Gleichung, damit Reaktanten und Produkte im richtigen stöchiometrischen Verhältnis bleiben.",
            trace_factor_pattern: "Prüfe zuerst, wie der genannte Faktor den limitierenden Schritt verändert, bevor du die Ratenänderung festlegst.",
            trace_chloroplast_pattern: "Ordne den Prozess der Chloroplastenregion zu, in der dieser Photosyntheseschritt stattfindet.",
    ...
    sb1_03: {
        ...
        solver: {
            ...
            extract_phase_clue: "Phasenhinweis herausarbeiten",
            trace_chromosome_pattern: "Chromosomenmuster nachverfolgen",
            phase_label: "Phase:",
            chromosome_count_label: "Relevante Anzahl:",
            trace_mitosis_pattern: "Schwesterchromatiden bleiben bis zur Anaphase verbunden und wandern dann zu entgegengesetzten Polen.",
            trace_meiosis_i_pattern: "Zuerst trennen sich homologe Chromosomen, während Schwesterchromatiden noch zusammenbleiben.",
            trace_meiosis_ii_pattern: "In der zweiten Teilung trennen sich Schwesterchromatiden in jeder haploiden Zelle.",
    ...
    sb1_04: {
        ...
        solver: {
            ...
            extract_plant_clue: "Pflanzenhinweis herausarbeiten",
            trace_transport_pattern: "Transportmuster nachverfolgen",
            clue_structure_label: "Struktur-Hinweis:",
            clue_function_label: "Funktionshinweis:",
            trace_plant_structure_pattern: "Ordne das genannte Organ oder Gewebe seiner Aufgabe bei Stütze, Aufnahme oder Photosynthese zu.",
            trace_water_transport_pattern: "Verfolge den Wasserweg von der Wurzel zum Blatt über Xylem, Transpirationssog und Kohäsions-Spannung.",
            trace_nutrient_transport_pattern: "Verfolge die Quelle-Senke-Bewegung im Phloem, um den Weg von Zucker oder Signalen durch die Pflanze zu bestimmen.",
    ...
    sb1_05: {
        ...
        solver: {
            ...
            extract_animal_clue: "Tierhinweis herausarbeiten",
            trace_survival_pattern: "Überlebensmuster nachverfolgen",
            animal_label: "Tier:",
            scientific_name_label: "Wissenschaftlicher Name:",
            trace_classification_pattern: "Nutze Körperbedeckung, Fortpflanzung und Skelettmerkmale zur Einordnung der Tiergruppe.",
            trace_adaptation_pattern: "Ordne die Umweltanforderung der Anpassung zu, die dort das Überleben verbessert.",
            trace_behavior_pattern: "Verbinde das Verhalten mit Migration, Fortpflanzung oder Schutzdruck.",
    ...
    sb2_01_tissues: {
        ...
        solver: {
            ...
            extract_key_clue: "Schlüsselhinweis herausarbeiten",
            classify_biological_level: "Biologische Ebene einordnen",
            tissue_clue_label: "Gewebehinweis:",
            organ_clue_label: "Organhinweis:",
            system_clue_label: "Systemhinweis:",
            tissue_step: "Nutze den Gewebehinweis, um die zentrale Funktion oder Struktur zuzuordnen.",
            organ_step: "Nutze den Organhinweis, um zu entscheiden, wie mehrere Gewebetypen in einem Organ zusammenwirken.",
            system_step: "Nutze den Hierarchiehinweis, um die Struktur auf der richtigen biologischen Ebene einzuordnen.",
    ...
    sb2_02: {
        ...
        solver: {
            ...
            extract_system_clue: "Systemhinweis herausarbeiten",
            trace_system_pathway: "Systemweg nachverfolgen",
            extract_key_clue: "Schlüsselhinweis herausarbeiten",
            trace_system_role: "Systemrolle verfolgen",
            route_clue_label: "Weg-Hinweis:",
            organ_clue_label: "Organhinweis:",
            system_clue_label: "Systemhinweis:",
            trace_digestive_pattern: "Folgen Sie der Nahrungsverarbeitung von Aufnahme über Verdauung und Absorption bis zur Ausscheidung.",
            trace_circulatory_pattern: "Folgen Sie dem Blut von Herz zu Gefäßen zu Geweben und zurück und ordnen Sie jeder Struktur ihre Transportrolle zu.",
            trace_respiratory_pattern: "Folgen Sie dem Luftstrom in die Lunge und dem Gasaustausch in den Alveolen, bevor Sie die fehlende Struktur bestimmen.",
            digestive_step: "Verfolge den Weg der Nahrung und ordne dem Organ seine Verdauungsaufgabe zu.",
            circulatory_step: "Verfolge, wie Blut fließt oder Stoffe austauscht, um die passende Struktur zu identifizieren.",
            respiratory_step: "Verfolge Luftstrom und Gasaustausch, um Organ oder Atemmechanismus zu bestimmen.",
    ...
    sb3_01: {
        ...
        solver: {
            ...
            identify_ecological_clue: "Ökologischen Hinweis erkennen",
            apply_ecological_pattern: "Ökologisches Muster anwenden",
            scenario_label: "Szenario:",
            stage_food_chain_step: "Gehe die trophische Reihenfolge von Produzent zu Konsument und weiter zum höheren Konsumenten durch.",
            stage_energy_flow_step: "Wende die 10-%-Regel vom aktuellen auf das nächste trophische Niveau an.",
            stage_cycles_step: "Verknüpfe den genannten Kreislaufprozess mit dem Produkt oder Speicher, der daraus entsteht.",
            stage_elite_step: "Nutze das gegebene ökologische Modell, um zu entscheiden, welche Größe zuerst isoliert oder berechnet werden muss.",
    ...
    sb2_03: {
        ...
        solver: {
            ...
            list_parent_gametes: "Elterngameten auflisten",
            build_punnett_square: "Punnett-Ergebnisse aufbauen",
            count_matching_offspring: "Passende Nachkommen zählen",
            gametes_from: "Gameten von",
            classic_dihybrid_gametes: "Im Standardmodell der dihybriden Kreuzung bildet jeder heterozygote Elternteil vier Gametenkombinationen.",
            outcomes_label: "Punnett-Ergebnisse:",
            dihybrid_outcomes_label: "Klassisches dihybrides Phänotypverhältnis:",
            genotype_count_label: "Genotyp-Zahlen:",
            phenotype_count_label: "Phänotyp-Zahlen:",
            matching_outcomes_label: "Passende Ergebnisse:",
            convert_ratio_label: "Verhältnis in Wahrscheinlichkeit umrechnen",
    ...
    sb2_04: {
        ...
        solver: {
            ...
            extract_key_clue: "Schlüsselhinweis herausarbeiten",
            classify_question_type: "Fragetyp einordnen",
            system_focus_label: "Systemfokus:",
            organ_clue_label: "Organhinweis:",
            process_clue_label: "Prozesshinweis:",
            scenario_clue_label: "Szenariohinweis:",
            identification_step: "Ordne die genannte Funktion dem Organ oder der Struktur zu, die sie ausführt.",
            process_step: "Verfolge den Prozess durch das System und bestimme die verantwortliche Struktur oder den Mechanismus.",
            coordination_step: "Verknüpfe Regulations-, Krankheits- oder Koordinationshinweise mit der physiologischen Reaktion.",
            comprehensive_step: "Verbinde mehrere Organe und Prozesse, bevor du die endgültige Antwort auswählst.",
