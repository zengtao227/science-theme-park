                ...
                {(stage === "CYCLES" || stage === "NUTRIENT_CYCLES") && (
                    <g className="animate-in fade-in duration-700">
                        ...
                        <g transform="translate(240, 40)">
                            ...
                            <text x={60} y={75} fill="#22c55e" fontSize="8" fontWeight="bold">{viz.fix}</text>

                            {/* Nitrate */}
                            <rect x={10} y={95} width={80} height={35} fill="#22c55e" opacity={0.5} rx={8} className="stroke-white/20 stroke-1" />
                            <text x={50} y={117} textAnchor="middle" fill="white" fontSize="9" fontWeight="bold">{viz.nitrate}</text>
                        </g>
                        ...
                        <g transform="translate(30, 240)">
                            ...
                            <text x={185} y={85} fill="#ffd93d" fontSize="8" fontWeight="bold">{viz.evap}</text>
                        </g>
                    </g>
                )}
