...
export default function PendulumCanvas(props: PendulumCanvasProps) {
    ...
    }, [theta, omega, props.showPhaseSpace]);
        ...
        <div className="w-full h-full flex flex-col">
            ...
            {props.showPhaseSpace && (
                <div className="h-48 border-t border-cyan-500">
                    <canvas ref={phaseCanvasRef} width={800} height={192} className="w-full h-full" />
                </div>
            )}
            
            {props.showEnergy && (
                <div className="h-32 border-t border-green-500">
