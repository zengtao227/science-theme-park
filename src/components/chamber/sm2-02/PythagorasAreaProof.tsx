  ...
  return (
    <div className="w-full rounded-2xl border border-white/10 bg-[#020208] p-3 space-y-3">
      <svg viewBox={viewBox} className="w-full h-[360px] md:h-[420px]" preserveAspectRatio="xMidYMid meet">
        ...
        <text x={mAB.x} y={mAB.y - 1} fill="#ffd8a8" fontSize={3} stroke="#020208" strokeWidth={0.3} paintOrder="stroke" textAnchor="middle">{labels.sideA}</text>
        <text x={mAC.x - 1.4} y={mAC.y} fill="#d3f9d8" fontSize={3} stroke="#020208" strokeWidth={0.3} paintOrder="stroke" textAnchor="end">{labels.sideB}</text>
        <text x={mBC.x + 1.4} y={mBC.y + 1.2} fill="#a5d8ff" fontSize={3} stroke="#020208" strokeWidth={0.3} paintOrder="stroke" textAnchor="start">{labels.hyp}</text>
