...
export default function OrganicReactionCanvas({
    ...
    }, [stage, animationFrame, showMechanism]);

    const drawCombustion = (ctx: CanvasRenderingContext2D, w: number, h: number, frame: number, showMech: boolean) => {
        const centerY = h / 2;
    ...
    const drawSubstitution = (ctx: CanvasRenderingContext2D, w: number, h: number, frame: number, showMech: boolean) => {
        const centerY = h / 2;
    ...
    const drawAddition = (ctx: CanvasRenderingContext2D, w: number, h: number, frame: number, showMech: boolean) => {
        const centerY = h / 2;
    ...
    const drawMolecule = (ctx: CanvasRenderingContext2D, x: number, y: number, formula: string, color: string) => {
        // Molecule circle
