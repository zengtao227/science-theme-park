    ...
    <div className="space-y-5">
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div
          ...
          style={{ maxWidth: expanded ? 640 : 420, transition: "max-width 0.35s ease-out" }}
        >
        ...
        {showClear && (
          <button
            onClick={onClear}
            className="min-h-[44px] px-4 text-[9px] font-black tracking-[0.35em] uppercase border border-neon-purple/40 text-neon-purple hover:border-neon-purple transition-all animate-fade-in"
          >
            {clearLabel}
          </button>
        )}
