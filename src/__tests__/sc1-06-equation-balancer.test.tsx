...
const mockT = (key: string, params?: Record<string, string>) => {
  const translations: Record<string, string> = {
    'sc1_06.stages.equation_balancing': 'Balance the Chemical Equation',
    'sc1_06.ui.hint': 'Show Hint',
    'sc1_06.ui.hide_hint': 'Hide Hint',
    'sc1_06.ui.reset': 'Reset',
    'sc1_06.ui.submit': 'Submit',
    'sc1_06.atomCount.element': 'Element',
    'sc1_06.atomCount.reactants': 'Reactants',
    'sc1_06.atomCount.products': 'Products',
    'sc1_06.atomCount.balanced': 'Status',
    'sc1_06.feedback.balanced': 'Balanced!',
    'sc1_06.feedback.unbalanced': 'Not balanced yet',
    'sc1_06.feedback.check_elements': 'Check your elements',
    'sc1_06.hints.increase_products': 'Try increasing products',
    'sc1_06.hints.increase_reactants': 'Try increasing reactants',
    'sc1_06.equation_balancer.title': 'Balance the Chemical Equation',
    'sc1_06.equation_balancer.element': 'Element',
    'sc1_06.equation_balancer.reactants': 'Reactants',
    'sc1_06.equation_balancer.products': 'Products',
    'sc1_06.equation_balancer.status': 'Status',
    'sc1_06.equation_balancer.balanced': '✓ Equation is balanced!',
    'sc1_06.equation_balancer.unbalanced': '✗ Equation is not balanced',
    'sc1_06.equation_balancer.correct': 'Correct! The equation is balanced.',
    'sc1_06.equation_balancer.incorrect': 'Incorrect. The equation is not balanced. Check the atom counts.',
    'sc1_06.equation_balancer.show_hint': 'Show Hint',
    'sc1_06.equation_balancer.hide_hint': 'Hide Hint',
    'sc1_06.equation_balancer.reset': 'Reset',
    'sc1_06.equation_balancer.submit': 'Submit',
    'sc1_06.equation_balancer.already_balanced': 'The equation is already balanced!',
    'sc1_06.equation_balancer.no_hint': 'No hint available.',
    'sc1_06.equation_balancer.hint_increase_products': `Try increasing the coefficient for a product containing ${params?.element || '{element}'}`,
    'sc1_06.equation_balancer.hint_increase_reactants': `Try increasing the coefficient for a reactant containing ${params?.element || '{element}'}`
  };
