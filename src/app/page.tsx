...
export default function Home() {
  ...
  const physicsModules = useMemo(() => ([
    ...
    { code: "SP3.04", title: t.home.sp3_04_title || "SP3.04 // FLUIDS & PRESSURE", desc: t.home.sp3_04_subtitle || "Archimedes' principle and hydraulic systems.", color: "neon-cyan", href: "/chamber/sp3-04", tags: ["physics"] },
    { code: "SP3.05", title: t.home.sp3_05_title || "SP3.05 // SIMPLE MACHINES", desc: t.home.sp3_05_subtitle || "Levers, pulleys, and mechanical advantage.", color: "neon-amber", href: "/chamber/sp3-05", tags: ["physics"] },
    { code: "SP3.06", title: t.home.sp3_06_title, desc: "Waves, Sound, and Musical Physics", color: "neon-green", href: "/chamber/sp3-06", tags: ["physics"] },
    { code: "SP3.07", title: "SP3.07 // NAVIGATION & VECTORS", desc: "Rhine Ferry navigation and vector addition.", color: "neon-cyan", href: "/chamber/sp3-07", tags: ["physics"] },
    { code: "SP3.08", title: "SP3.08 // GEOMETRICAL OPTICS", desc: "Reflection, Refraction, and Lens Ray Tracing", color: "neon-purple", href: "/chamber/sp3-08", tags: ["physics"] },
