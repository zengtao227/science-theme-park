    ...
    if (stage === "SCIENTIFIC") {
        if (difficulty === "BASIC") {
            ...
            quests.push({
                ...
                slots: [{ id: "x", labelLatex: "x", placeholder: t("sm2_05.placeholders.value"), expected: 120000 }],
            ...
            quests.push({
                ...
                targetLatex: `x`,
                visual: { mode: 'SCIENTIFIC', base: 10, m: 3.5, n: -4 },
                slots: [{ id: "x", labelLatex: "x", placeholder: t("sm2_05.placeholders.value"), expected: 0.00035 }],
            ...
            quests.push({
                ...
                slots: [{ id: "x", labelLatex: "x", placeholder: t("sm2_05.placeholders.value"), expected: 8900 }],
                correctLatex: `8,900`,
                hintLatex: [`Move decimal 3 places right`],
            });
            quests.push({
                ...
                slots: [{ id: "x", labelLatex: "x", placeholder: t("sm2_05.placeholders.value"), expected: 0.024 }],
                correctLatex: `0.024`,
                hintLatex: [`Move decimal 2 places left`],
            });
            quests.push({
                ...
                slots: [{ id: "x", labelLatex: "x", placeholder: t("sm2_05.placeholders.value"), expected: 6700000 }],
