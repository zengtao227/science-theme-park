...
export default function SC201Page() {
  ...
  const buildStagePool = useCallback((difficulty: Difficulty, stage: Stage): KineticsQuest[] => {
    const pools: Record<Stage, Record<Difficulty, KineticsQuest[]>> = {
      ARRHENIUS: {
        BASIC: [
          {
            id: "ARR_B1", difficulty, stage,
            scenario: t("sc2_01.scenarios.arrhenius") || "Arrhenius Equation",
