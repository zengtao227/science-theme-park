    ...
    const pools: Record<Stage, Record<Difficulty, KineticsQuest[]>> = {
      ARRHENIUS: {
        ...
        CORE: [
          ...
          { id: "ARR_C4", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_activation") || "Find Ea from k ratio", promptLatex: t("sc2_01.prompts.arr_c4"), expressionLatex: "k_2/k_1=10, \\Delta T=50", targetLatex: "E_a", slots: [{ id: "ea", labelLatex: "E_a", placeholder: t("sc2_01.placeholders.question"), expected: 53, unit: "kJ/mol" }], correctLatex: "53", temperature: 350, activationEnergy: 53 },
        ...
        ADVANCED: [
          { id: "ARR_A1", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_two_temps") || "k at two temperatures", promptLatex: t("sc2_01.prompts.arr_a1"), expressionLatex: "T_1=300, T_2=350", targetLatex: "E_a", slots: [{ id: "ea", labelLatex: "E_a", placeholder: t("sc2_01.placeholders.question"), expected: 52, unit: "kJ/mol" }], correctLatex: "52", temperature: 350, activationEnergy: 52 },
          { id: "ARR_A2", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_plot") || "Arrhenius plot slope", promptLatex: t("sc2_01.prompts.arr_a2"), expressionLatex: "-E_a/R", targetLatex: "E_a", slots: [{ id: "ea", labelLatex: "E_a", placeholder: t("sc2_01.placeholders.question"), expected: 65, unit: "kJ/mol" }], correctLatex: "65", temperature: 300, activationEnergy: 65 },
          ...
          { id: "ARR_A4", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_temp_for_k") || "Find T for target k", promptLatex: t("sc2_01.prompts.arr_a4"), expressionLatex: "k=10^6, E_a=60", targetLatex: "T", slots: [{ id: "t", labelLatex: "T", placeholder: t("sc2_01.placeholders.question"), expected: 450, unit: "K" }], correctLatex: "450", temperature: 450, activationEnergy: 60 },
          { id: "ARR_A5", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_enzyme") || "Enzyme kinetics", promptLatex: t("sc2_01.prompts.arr_a5"), expressionLatex: "E_a=40, T=310", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: t("sc2_01.placeholders.question"), expected: 5.2 }], correctLatex: "5.2", temperature: 310, activationEnergy: 40 },
        ],
        ELITE: [
          ...
          { id: "ARR_E2", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_pressure") || "Pressure effect on k", promptLatex: t("sc2_01.prompts.arr_e2"), expressionLatex: "\\Delta V^\\ddagger=-10", targetLatex: "k_2/k_1", slots: [{ id: "ratio", labelLatex: "\\text{ratio}", placeholder: t("sc2_01.placeholders.question"), expected: 1.5 }], correctLatex: "1.5", temperature: 300, activationEnergy: 50 },
          { id: "ARR_E3", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_quantum") || "Quantum tunneling correction", promptLatex: t("sc2_01.prompts.arr_e3"), expressionLatex: "\\kappa=2.5", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: t("sc2_01.placeholders.question"), expected: 3.8 }], correctLatex: "3.8", temperature: 300, activationEnergy: 50 },
          { id: "ARR_E4", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_isotope") || "Kinetic isotope effect", promptLatex: t("sc2_01.prompts.arr_e4"), expressionLatex: "E_a=50", targetLatex: "\\\\text{KIE}", slots: [{ id: "kie", labelLatex: "k_H/k_D", placeholder: t("sc2_01.placeholders.question"), expected: 7 }], correctLatex: "7", temperature: 300, activationEnergy: 50 },
      ...
      RATE_LAW: {
        BASIC: [
          { id: "RL_B1", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_first_order") || "First order: rate = k[A]", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[A]=2.0, k=0.5", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: t("sc2_01.placeholders.question"), expected: 1.0, unit: "M/s" }], correctLatex: "1.0", temperature: 300, activationEnergy: 50 },
          { id: "RL_B2", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_second_order") || "Second order: rate = k[A]^{2}", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[A]=1.5, k=0.4", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: t("sc2_01.placeholders.question"), expected: 0.9, unit: "M/s" }], correctLatex: "0.9", temperature: 300, activationEnergy: 50 },
          ...
          { id: "RL_B4", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_concentration") || "[A] doubles, rate?", promptLatex: t("sc2_01.prompts.rl_b4"), expressionLatex: "\\text{1st order}", targetLatex: "\\\\text{ratio}", slots: [{ id: "ratio", labelLatex: "\\text{ratio}", placeholder: t("sc2_01.placeholders.question"), expected: 2 }], correctLatex: "2", temperature: 300, activationEnergy: 50 },
          { id: "RL_B5", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_initial") || "Initial rate method", promptLatex: t("sc2_01.prompts.rl_b5"), expressionLatex: "[A]_0=1.0, k=0.6", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: t("sc2_01.placeholders.question"), expected: 0.6, unit: "M/s" }], correctLatex: "0.6", temperature: 300, activationEnergy: 50 },
        ],
        CORE: [
          { id: "RL_C1", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_mixed") || "rate = k[A][B]", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[A]=2, [B]=3, k=0.5", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: t("sc2_01.placeholders.question"), expected: 3.0, unit: "M/s" }], correctLatex: "3.0", temperature: 300, activationEnergy: 50 },
          ...
          { id: "RL_C4", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_time") || "Time for [A] to halve", promptLatex: t("sc2_01.prompts.rl_c4"), expressionLatex: "k=0.05", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: t("sc2_01.placeholders.question"), expected: 13.9, unit: "s" }], correctLatex: "13.9", temperature: 300, activationEnergy: 50 },
          { id: "RL_C5", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_constant") || "Find k from data", promptLatex: t("sc2_01.prompts.rl_c5"), expressionLatex: "\\text{rate}=2, [A]=4", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: t("sc2_01.placeholders.question"), expected: 0.5 }], correctLatex: "0.5", temperature: 300, activationEnergy: 50 },
        ],
        ADVANCED: [
          ...
          { id: "RL_A2", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_mechanism") || "Multi-step mechanism", promptLatex: t("sc2_01.prompts.rl_a2"), expressionLatex: "k_1=0.5, k_2=0.3", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: t("sc2_01.placeholders.question"), expected: 0.15, unit: "M/s" }], correctLatex: "0.15", temperature: 300, activationEnergy: 50 },
          { id: "RL_A3", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_steady_state") || "Steady-state approximation", promptLatex: t("sc2_01.prompts.rl_a3"), expressionLatex: "k_1=0.5, k_2=0.2", targetLatex: "[I]", slots: [{ id: "i", labelLatex: "[I]", placeholder: t("sc2_01.placeholders.question"), expected: 2.5, unit: "M" }], correctLatex: "2.5", temperature: 300, activationEnergy: 50 },
          { id: "RL_A4", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_pre_equilibrium") || "Pre-equilibrium approximation", promptLatex: t("sc2_01.prompts.rl_a4"), expressionLatex: "k_f=0.8, k_r=0.2", targetLatex: "K", slots: [{ id: "k", labelLatex: "K", placeholder: t("sc2_01.placeholders.question"), expected: 4 }], correctLatex: "4", temperature: 300, activationEnergy: 50 },
          { id: "RL_A5", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_inhibition") || "Competitive inhibition", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[I]=2, K_I=1", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: t("sc2_01.placeholders.question"), expected: 0.33, unit: "M/s" }], correctLatex: "0.33", temperature: 300, activationEnergy: 50 },
        ],
        ELITE: [
          { id: "RL_E1", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_oscillating") || "Oscillating reaction", promptLatex: t("sc2_01.prompts.rl_e1"), expressionLatex: "\\text{Belousov-Zhabotinsky}", targetLatex: "[A]", slots: [{ id: "a", labelLatex: "[A]", placeholder: t("sc2_01.placeholders.question"), expected: 1.5, unit: "M" }], correctLatex: "1.5", temperature: 300, activationEnergy: 50 },
          { id: "RL_E2", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_autocatalytic") || "Autocatalytic reaction", promptLatex: t("sc2_01.prompts.rl_e2"), expressionLatex: "[A]_0=0.1", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: t("sc2_01.placeholders.question"), expected: 15, unit: "s" }], correctLatex: "15", temperature: 300, activationEnergy: 50 },
          ...
          { id: "RL_E5", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_enzyme_complex") || "Michaelis-Menten", promptLatex: t("sc2_01.prompts.rl_e5"), expressionLatex: "K_M=1, [S]=5", targetLatex: "V", slots: [{ id: "v", labelLatex: "V", placeholder: t("sc2_01.placeholders.question"), expected: 0.83, unit: "M/s" }], correctLatex: "0.83", temperature: 300, activationEnergy: 50 },
        ],
      },
      HALF_LIFE: {
        BASIC: [
          ...
          { id: "HL_B5", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_time") || "Time for 75% decay", promptLatex: t("sc2_01.prompts.rl_c4"), expressionLatex: "t_{1/2}=10", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: t("sc2_01.placeholders.question"), expected: 20, unit: "s" }], correctLatex: "20", temperature: 300, activationEnergy: 50 },
        ],
        CORE: [
          { id: "HL_C1", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_find_k") || "Find k from t_1/_2", promptLatex: t("sc2_01.prompts.rl_c5"), expressionLatex: "t_{1/2}=5", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: t("sc2_01.placeholders.question"), expected: 0.14 }], correctLatex: "0.14", temperature: 300, activationEnergy: 50 },
          { id: "HL_C2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_fraction") || "Fraction remaining after 3t_1/_2", promptLatex: t("sc2_01.prompts.hl_c2"), expressionLatex: "n=3", targetLatex: "f", slots: [{ id: "f", labelLatex: "f", placeholder: t("sc2_01.placeholders.question"), expected: 0.125 }], correctLatex: "0.125", temperature: 300, activationEnergy: 50 },
          ...
          { id: "HL_C5", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_compare") || "Compare two reactions", promptLatex: t("sc2_01.prompts.hl_c5"), expressionLatex: "k_A=0.2, k_B=0.4", targetLatex: "\\\\text{ratio}", slots: [{ id: "ratio", labelLatex: "\\text{ratio}", placeholder: t("sc2_01.placeholders.question"), expected: 2 }], correctLatex: "2", temperature: 300, activationEnergy: 50 },
        ],
        ADVANCED: [
          ...
          { id: "HL_A2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_parallel") || "Parallel reactions", promptLatex: t("sc2_01.prompts.hl_a2"), expressionLatex: "k_1=0.3, k_2=0.2", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: t("sc2_01.placeholders.question"), expected: 1.4, unit: "s" }], correctLatex: "1.4", temperature: 300, activationEnergy: 50 },
        ...
        ELITE: [
          ...
          { id: "HL_E2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_branching") || "Branching decay", promptLatex: t("sc2_01.prompts.hl_e2"), expressionLatex: "k_\\alpha/k_\\beta=2", targetLatex: "f_\\alpha", slots: [{ id: "f", labelLatex: "f_\\alpha", placeholder: t("sc2_01.placeholders.question"), expected: 0.67 }], correctLatex: "0.67", temperature: 300, activationEnergy: 50 },
          { id: "HL_E3", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_secular") || "Secular equilibrium", promptLatex: t("sc2_01.prompts.hl_e3"), expressionLatex: "t_{1/2,1}\\gg t_{1/2,2}", targetLatex: "\\\\text{ratio}", slots: [{ id: "ratio", labelLatex: "\\text{ratio}", placeholder: t("sc2_01.placeholders.question"), expected: 1 }], correctLatex: "1", temperature: 300, activationEnergy: 50 },
