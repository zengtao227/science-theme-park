  ...
  const buildStagePool = useCallback((tObj: typeof sc2_01_t, difficulty: Difficulty, stage: Stage): KineticsQuest[] => {
    const pools: Record<Stage, Record<Difficulty, KineticsQuest[]>> = {
      ARRHENIUS: {
        ...
        CORE: [
          { id: "ARR_C1", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_double_temp") || "Double T, k increases", promptLatex: t("sc2_01.prompts.arr_c1"), expressionLatex: "T: 300\\to600\\text{K}", targetLatex: "k_{\\\\text{ratio}}", slots: [{ id: "k", labelLatex: "k_{600}/k_{300}", placeholder: "?", expected: 100 }], correctLatex: "100", temperature: 600, activationEnergy: 50 },
          { id: "ARR_C2", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_ea_effect") || "Lower Ea, k increases", promptLatex: t("sc2_01.prompts.arr_c2"), expressionLatex: "E_a: 80\\to40\\text{kJ/mol}", targetLatex: "k_{\\\\text{ratio}}", slots: [{ id: "k", labelLatex: "k_{40}/k_{80}", placeholder: "?", expected: 50 }], correctLatex: "50", temperature: 300, activationEnergy: 40 },
          { id: "ARR_C3", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_ln_form") || "ln(k) = ln(A) - Ea/RT", promptLatex: t("sc2_01.prompts.arr_c3"), expressionLatex: "E_a=50, T=300", targetLatex: "\\ln(k)", slots: [{ id: "lnk", labelLatex: "\\ln(k)", placeholder: "?", expected: -20 }], correctLatex: "-20", temperature: 300, activationEnergy: 50 },
          { id: "ARR_C4", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_activation") || "Find Ea from k ratio", promptLatex: t("sc2_01.prompts.arr_c4"), expressionLatex: "k_2/k_1=10, \\Delta T=50", targetLatex: "E_a", slots: [{ id: "ea", labelLatex: "E_a", placeholder: "?", expected: 53, unit: "kJ/mol" }], correctLatex: "53", temperature: 350, activationEnergy: 53 },
          { id: "ARR_C5", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_catalyst") || "Catalyst lowers Ea by 20 kJ/mol", promptLatex: t("sc2_01.prompts.arr_c5"), expressionLatex: "E_a: 80\\to60", targetLatex: "\\\\text{ratio}", slots: [{ id: "ratio", labelLatex: "k_{\\text{ratio}}", placeholder: "?", expected: 8 }], correctLatex: "8", temperature: 300, activationEnergy: 60 },
        ],
        ADVANCED: [
          { id: "ARR_A1", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_two_temps") || "k at two temperatures", promptLatex: t("sc2_01.prompts.arr_a1"), expressionLatex: "T_1=300, T_2=350", targetLatex: "E_a", slots: [{ id: "ea", labelLatex: "E_a", placeholder: "?", expected: 52, unit: "kJ/mol" }], correctLatex: "52", temperature: 350, activationEnergy: 52 },
          { id: "ARR_A2", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_plot") || "Arrhenius plot slope", promptLatex: t("sc2_01.prompts.arr_a2"), expressionLatex: "-E_a/R", targetLatex: "E_a", slots: [{ id: "ea", labelLatex: "E_a", placeholder: "?", expected: 65, unit: "kJ/mol" }], correctLatex: "65", temperature: 300, activationEnergy: 65 },
          { id: "ARR_A3", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_frequency") || "Pre-exponential factor A", promptLatex: t("sc2_01.prompts.arr_a3"), expressionLatex: "k=1.5, E_a=50, T=300", targetLatex: "A", slots: [{ id: "a", labelLatex: "A", placeholder: "?", expected: 1e13 }], correctLatex: "10^{13}", temperature: 300, activationEnergy: 50 },
          { id: "ARR_A4", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_temp_for_k") || "Find T for target k", promptLatex: t("sc2_01.prompts.arr_a4"), expressionLatex: "k=10^6, E_a=60", targetLatex: "T", slots: [{ id: "t", labelLatex: "T", placeholder: "?", expected: 450, unit: "K" }], correctLatex: "450", temperature: 450, activationEnergy: 60 },
          { id: "ARR_A5", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_enzyme") || "Enzyme kinetics", promptLatex: t("sc2_01.prompts.arr_a5"), expressionLatex: "E_a=40, T=310", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: "?", expected: 5.2 }], correctLatex: "5.2", temperature: 310, activationEnergy: 40 },
        ],
        ELITE: [
          { id: "ARR_E1", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_complex") || "Complex reaction mechanism", promptLatex: t("sc2_01.prompts.arr_e1"), expressionLatex: "E_{a1}=50, E_{a2}=30", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: "?", expected: 2.5 }], correctLatex: "2.5", temperature: 300, activationEnergy: 40 },
          { id: "ARR_E2", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_pressure") || "Pressure effect on k", promptLatex: t("sc2_01.prompts.arr_e2"), expressionLatex: "\\Delta V^\\ddagger=-10", targetLatex: "k_2/k_1", slots: [{ id: "ratio", labelLatex: "\\text{ratio}", placeholder: "?", expected: 1.5 }], correctLatex: "1.5", temperature: 300, activationEnergy: 50 },
          { id: "ARR_E3", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_quantum") || "Quantum tunneling correction", promptLatex: t("sc2_01.prompts.arr_e3"), expressionLatex: "\\kappa=2.5", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: "?", expected: 3.8 }], correctLatex: "3.8", temperature: 300, activationEnergy: 50 },
          { id: "ARR_E4", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_isotope") || "Kinetic isotope effect", promptLatex: t("sc2_01.prompts.arr_e4"), expressionLatex: "E_a=50", targetLatex: "\\\\text{KIE}", slots: [{ id: "kie", labelLatex: "k_H/k_D", placeholder: "?", expected: 7 }], correctLatex: "7", temperature: 300, activationEnergy: 50 },
          { id: "ARR_E5", difficulty, stage, scenario: tObj.scenarios.arrhenius || "Arrhenius", context: t("sc2_01.problems.arr_transition") || "Transition state theory", promptLatex: t("sc2_01.prompts.arr_e5"), expressionLatex: "k=10^6, T=300", targetLatex: "\\Delta G", slots: [{ id: "dg", labelLatex: "\\Delta G^\\ddagger", placeholder: "?", expected: 65, unit: "kJ/mol" }], correctLatex: "65", temperature: 300, activationEnergy: 65 },
        ],
      },
      RATE_LAW: {
        BASIC: [
          { id: "RL_B1", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_first_order") || "First order: rate = k[A]", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[A]=2.0, k=0.5", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: "?", expected: 1.0, unit: "M/s" }], correctLatex: "1.0", temperature: 300, activationEnergy: 50 },
          { id: "RL_B2", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_second_order") || "Second order: rate = k[A]^{2}", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[A]=1.5, k=0.4", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: "?", expected: 0.9, unit: "M/s" }], correctLatex: "0.9", temperature: 300, activationEnergy: 50 },
          { id: "RL_B3", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_zero_order") || "Zero order: rate = k", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "k=0.8", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: "?", expected: 0.8, unit: "M/s" }], correctLatex: "0.8", temperature: 300, activationEnergy: 50 },
          { id: "RL_B4", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_concentration") || "[A] doubles, rate?", promptLatex: t("sc2_01.prompts.rl_b4"), expressionLatex: "\\text{1st order}", targetLatex: "\\\\text{ratio}", slots: [{ id: "ratio", labelLatex: "\\text{ratio}", placeholder: "?", expected: 2 }], correctLatex: "2", temperature: 300, activationEnergy: 50 },
          { id: "RL_B5", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_initial") || "Initial rate method", promptLatex: t("sc2_01.prompts.rl_b5"), expressionLatex: "[A]_0=1.0, k=0.6", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: "?", expected: 0.6, unit: "M/s" }], correctLatex: "0.6", temperature: 300, activationEnergy: 50 },
        ],
        CORE: [
          { id: "RL_C1", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_mixed") || "rate = k[A][B]", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[A]=2, [B]=3, k=0.5", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: "?", expected: 3.0, unit: "M/s" }], correctLatex: "3.0", temperature: 300, activationEnergy: 50 },
          { id: "RL_C2", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_order") || "Find reaction order", promptLatex: t("sc2_01.prompts.rl_c2"), expressionLatex: "[A]\\times2 \\to \\text{rate}\\times4", targetLatex: "n", slots: [{ id: "n", labelLatex: "n", placeholder: "?", expected: 2 }], correctLatex: "2", temperature: 300, activationEnergy: 50 },
          { id: "RL_C3", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_integrated") || "Integrated rate law", promptLatex: t("sc2_01.prompts.rl_c3"), expressionLatex: "[A]_0=1, k=0.1, t=10", targetLatex: "[A]", slots: [{ id: "a", labelLatex: "[A]", placeholder: "?", expected: 0.37, unit: "M" }], correctLatex: "0.37", temperature: 300, activationEnergy: 50 },
          { id: "RL_C4", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_time") || "Time for [A] to halve", promptLatex: t("sc2_01.prompts.rl_c4"), expressionLatex: "k=0.05", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: "?", expected: 13.9, unit: "s" }], correctLatex: "13.9", temperature: 300, activationEnergy: 50 },
          { id: "RL_C5", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_constant") || "Find k from data", promptLatex: t("sc2_01.prompts.rl_c5"), expressionLatex: "\\text{rate}=2, [A]=4", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: "?", expected: 0.5 }], correctLatex: "0.5", temperature: 300, activationEnergy: 50 },
        ],
        ADVANCED: [
          { id: "RL_A1", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_complex_order") || "rate = k[A]^{1.5}[B]^{0.5}", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[A]=4, [B]=9, k=0.2", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: "?", expected: 2.4, unit: "M/s" }], correctLatex: "2.4", temperature: 300, activationEnergy: 50 },
          { id: "RL_A2", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_mechanism") || "Multi-step mechanism", promptLatex: t("sc2_01.prompts.rl_a2"), expressionLatex: "k_1=0.5, k_2=0.3", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: "?", expected: 0.15, unit: "M/s" }], correctLatex: "0.15", temperature: 300, activationEnergy: 50 },
          { id: "RL_A3", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_steady_state") || "Steady-state approximation", promptLatex: t("sc2_01.prompts.rl_a3"), expressionLatex: "k_1=0.5, k_2=0.2", targetLatex: "[I]", slots: [{ id: "i", labelLatex: "[I]", placeholder: "?", expected: 2.5, unit: "M" }], correctLatex: "2.5", temperature: 300, activationEnergy: 50 },
          { id: "RL_A4", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_pre_equilibrium") || "Pre-equilibrium approximation", promptLatex: t("sc2_01.prompts.rl_a4"), expressionLatex: "k_f=0.8, k_r=0.2", targetLatex: "K", slots: [{ id: "k", labelLatex: "K", placeholder: "?", expected: 4 }], correctLatex: "4", temperature: 300, activationEnergy: 50 },
          { id: "RL_A5", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_inhibition") || "Competitive inhibition", promptLatex: t("sc2_01.prompts.rl_b"), expressionLatex: "[I]=2, K_I=1", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\text{rate}", placeholder: "?", expected: 0.33, unit: "M/s" }], correctLatex: "0.33", temperature: 300, activationEnergy: 50 },
        ],
        ELITE: [
          { id: "RL_E1", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_oscillating") || "Oscillating reaction", promptLatex: t("sc2_01.prompts.rl_e1"), expressionLatex: "\\text{Belousov-Zhabotinsky}", targetLatex: "[A]", slots: [{ id: "a", labelLatex: "[A]", placeholder: "?", expected: 1.5, unit: "M" }], correctLatex: "1.5", temperature: 300, activationEnergy: 50 },
          { id: "RL_E2", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_autocatalytic") || "Autocatalytic reaction", promptLatex: t("sc2_01.prompts.rl_e2"), expressionLatex: "[A]_0=0.1", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: "?", expected: 15, unit: "s" }], correctLatex: "15", temperature: 300, activationEnergy: 50 },
          { id: "RL_E3", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_chain") || "Chain reaction", promptLatex: t("sc2_01.prompts.rl_e3"), expressionLatex: "k_p/k_t=100", targetLatex: "\\nu", slots: [{ id: "nu", labelLatex: "\\nu", placeholder: "?", expected: 100 }], correctLatex: "100", temperature: 300, activationEnergy: 50 },
          { id: "RL_E4", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_photochemical") || "Photochemical reaction", promptLatex: t("sc2_01.prompts.rl_e4"), expressionLatex: "\\text{quantum yield}", targetLatex: "\\Phi", slots: [{ id: "phi", labelLatex: "\\Phi", placeholder: "?", expected: 0.8 }], correctLatex: "0.8", temperature: 300, activationEnergy: 50 },
          { id: "RL_E5", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_enzyme_complex") || "Michaelis-Menten", promptLatex: t("sc2_01.prompts.rl_e5"), expressionLatex: "K_M=1, [S]=5", targetLatex: "V", slots: [{ id: "v", labelLatex: "V", placeholder: "?", expected: 0.83, unit: "M/s" }], correctLatex: "0.83", temperature: 300, activationEnergy: 50 },
        ],
      },
      HALF_LIFE: {
        BASIC: [
          { id: "HL_B1", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_first_order") || "First order: t_1/_2 = ln(2)/k", promptLatex: t("sc2_01.prompts.hl_b"), expressionLatex: "k=0.1", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: "?", expected: 6.9, unit: "s" }], correctLatex: "6.9", temperature: 300, activationEnergy: 50 },
          { id: "HL_B2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_second_order") || "Second order: t_1/_2 = 1/(k[A]₀)", promptLatex: t("sc2_01.prompts.hl_b"), expressionLatex: "k=0.5, [A]_0=2", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: "?", expected: 1.0, unit: "s" }], correctLatex: "1.0", temperature: 300, activationEnergy: 50 },
          { id: "HL_B3", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_zero_order") || "Zero order: t_1/_2 = [A]₀/(2k)", promptLatex: t("sc2_01.prompts.hl_b"), expressionLatex: "k=0.4, [A]_0=4", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: "?", expected: 5.0, unit: "s" }], correctLatex: "5.0", temperature: 300, activationEnergy: 50 },
          { id: "HL_B4", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_remaining") || "After 2 half-lives, [A] = ?", promptLatex: t("sc2_01.prompts.hl_b4"), expressionLatex: "[A]_0=8", targetLatex: "[A]", slots: [{ id: "a", labelLatex: "[A]", placeholder: "?", expected: 2.0, unit: "M" }], correctLatex: "2.0", temperature: 300, activationEnergy: 50 },
          { id: "HL_B5", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_time") || "Time for 75% decay", promptLatex: t("sc2_01.prompts.rl_c4"), expressionLatex: "t_{1/2}=10", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: "?", expected: 20, unit: "s" }], correctLatex: "20", temperature: 300, activationEnergy: 50 },
        ],
        CORE: [
          { id: "HL_C1", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_find_k") || "Find k from t_1/_2", promptLatex: t("sc2_01.prompts.rl_c5"), expressionLatex: "t_{1/2}=5", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: "?", expected: 0.14 }], correctLatex: "0.14", temperature: 300, activationEnergy: 50 },
          { id: "HL_C2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_fraction") || "Fraction remaining after 3t_1/_2", promptLatex: t("sc2_01.prompts.hl_c2"), expressionLatex: "n=3", targetLatex: "f", slots: [{ id: "f", labelLatex: "f", placeholder: "?", expected: 0.125 }], correctLatex: "0.125", temperature: 300, activationEnergy: 50 },
          { id: "HL_C3", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_radioactive") || "Radioactive decay", promptLatex: t("sc2_01.prompts.hl_c3"), expressionLatex: "N_0=1000, t=20, t_{1/2}=10", targetLatex: "N", slots: [{ id: "n", labelLatex: "N", placeholder: "?", expected: 250 }], correctLatex: "250", temperature: 300, activationEnergy: 50 },
          { id: "HL_C4", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_drug") || "Drug elimination", promptLatex: t("sc2_01.prompts.hl_c4"), expressionLatex: "[D]_0=100, t_{1/2}=4\\text{h}, t=12\\text{h}", targetLatex: "[D]", slots: [{ id: "d", labelLatex: "[D]", placeholder: "?", expected: 12.5, unit: "mg/L" }], correctLatex: "12.5", temperature: 300, activationEnergy: 50 },
          { id: "HL_C5", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_compare") || "Compare two reactions", promptLatex: t("sc2_01.prompts.hl_c5"), expressionLatex: "k_A=0.2, k_B=0.4", targetLatex: "\\\\text{ratio}", slots: [{ id: "ratio", labelLatex: "\\text{ratio}", placeholder: "?", expected: 2 }], correctLatex: "2", temperature: 300, activationEnergy: 50 },
        ],
        ADVANCED: [
          { id: "HL_A1", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_consecutive") || "Consecutive reactions", promptLatex: t("sc2_01.prompts.hl_a1"), expressionLatex: "k_1=0.5, k_2=0.2", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: "?", expected: 4.6, unit: "s" }], correctLatex: "4.6", temperature: 300, activationEnergy: 50 },
          { id: "HL_A2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_parallel") || "Parallel reactions", promptLatex: t("sc2_01.prompts.hl_a2"), expressionLatex: "k_1=0.3, k_2=0.2", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: "?", expected: 1.4, unit: "s" }], correctLatex: "1.4", temperature: 300, activationEnergy: 50 },
          { id: "HL_A3", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_reversible") || "Reversible reaction", promptLatex: t("sc2_01.prompts.hl_a3"), expressionLatex: "k_f=0.5, k_r=0.1", targetLatex: "[A]", slots: [{ id: "a", labelLatex: "[A]", placeholder: "?", expected: 0.17, unit: "M" }], correctLatex: "0.17", temperature: 300, activationEnergy: 50 },
          { id: "HL_A4", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_temperature") || "t_1/_2 at different T", promptLatex: t("sc2_01.prompts.hl_a4"), expressionLatex: "t_{1/2}(300)=10, E_a=50", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: "?", expected: 2.5, unit: "s" }], correctLatex: "2.5", temperature: 350, activationEnergy: 50 },
        ...
        ELITE: [
          { id: "HL_E1", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_isotope_dating") || "Carbon-14 dating", promptLatex: t("sc2_01.prompts.hl_e1"), expressionLatex: "N/N_0=0.25, t_{1/2}=5730", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: "?", expected: 11460, unit: "years" }], correctLatex: "11460", temperature: 300, activationEnergy: 50 },
          { id: "HL_E2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_branching") || "Branching decay", promptLatex: t("sc2_01.prompts.hl_e2"), expressionLatex: "k_\\alpha/k_\\beta=2", targetLatex: "f_\\alpha", slots: [{ id: "f", labelLatex: "f_\\alpha", placeholder: "?", expected: 0.67 }], correctLatex: "0.67", temperature: 300, activationEnergy: 50 },
          { id: "HL_E3", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_secular") || "Secular equilibrium", promptLatex: t("sc2_01.prompts.hl_e3"), expressionLatex: "t_{1/2,1}\\gg t_{1/2,2}", targetLatex: "\\\\text{ratio}", slots: [{ id: "ratio", labelLatex: "\\text{ratio}", placeholder: "?", expected: 1 }], correctLatex: "1", temperature: 300, activationEnergy: 50 },
          { id: "HL_E4", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_transient") || "Transient equilibrium", promptLatex: t("sc2_01.prompts.hl_a1"), expressionLatex: "t_{1/2,1}=10, t_{1/2,2}=2", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: "?", expected: 3.5, unit: "s" }], correctLatex: "3.5", temperature: 300, activationEnergy: 50 },
          { id: "HL_E5", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_cosmogenic") || "Cosmogenic nuclide", promptLatex: t("sc2_01.prompts.hl_e5"), expressionLatex: "^{10}\\text{Be}, N/N_0=0.5", targetLatex: "t", slots: [{ id: "t", labelLatex: "t", placeholder: "?", expected: 1.39e6, unit: "years" }], correctLatex: "1.39\\times10^6", temperature: 300, activationEnergy: 50 },
        ],
      },
    };
