    ...
    const pools: Record<Stage, Record<Difficulty, KineticsQuest[]>> = {
      ...
      RATE_LAW: {
        BASIC: [
          ...
          { id: "RL_B2", difficulty, stage, scenario: tObj.scenarios.rate_law || "Rate Law", context: t("sc2_01.problems.rl_second_order") || "Second order: rate = k[A]^2", promptLatex: "\\\\text{rate}", expressionLatex: "[A]=1.5, k=0.4", targetLatex: "\\\\text{rate}", slots: [{ id: "rate", labelLatex: "\\\\text{rate}", placeholder: "?", expected: 0.9, unit: "M/s" }], correctLatex: "0.9", temperature: 300, activationEnergy: 50 },
      ...
      HALF_LIFE: {
        BASIC: [
          { id: "HL_B1", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_first_order") || "First order: t_1/_2 = ln(2)/k", promptLatex: "t_{1/2}", expressionLatex: "k=0.1", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: "?", expected: 6.9, unit: "s" }], correctLatex: "6.9", temperature: 300, activationEnergy: 50 },
          { id: "HL_B2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_second_order") || "Second order: t_1/_2 = 1/(k[A]₀)", promptLatex: "t_{1/2}", expressionLatex: "k=0.5, [A]_0=2", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: "?", expected: 1.0, unit: "s" }], correctLatex: "1.0", temperature: 300, activationEnergy: 50 },
          { id: "HL_B3", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_zero_order") || "Zero order: t_1/_2 = [A]₀/(2k)", promptLatex: "t_{1/2}", expressionLatex: "k=0.4, [A]_0=4", targetLatex: "t", slots: [{ id: "t", labelLatex: "t_{1/2}", placeholder: "?", expected: 5.0, unit: "s" }], correctLatex: "5.0", temperature: 300, activationEnergy: 50 },
        ...
        CORE: [
          { id: "HL_C1", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_find_k") || "Find k from t_1/_2", promptLatex: "k", expressionLatex: "t_{1/2}=5", targetLatex: "k", slots: [{ id: "k", labelLatex: "k", placeholder: "?", expected: 0.14 }], correctLatex: "0.14", temperature: 300, activationEnergy: 50 },
          { id: "HL_C2", difficulty, stage, scenario: tObj.scenarios.half_life || "Half-Life", context: t("sc2_01.problems.hl_fraction") || "Fraction remaining after 3t_1/_2", promptLatex: "f", expressionLatex: "n=3", targetLatex: "f", slots: [{ id: "f", labelLatex: "f", placeholder: "?", expected: 0.125 }], correctLatex: "0.125", temperature: 300, activationEnergy: 50 },
