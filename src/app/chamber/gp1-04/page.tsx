        ...
        BASIC: [
          {
            ...
            targetLatex: "T",
            slots: [{ id: "T", labelLatex: "T", placeholder: "1", expected: 1 }],
            correctLatex: "T=1",
          },
        ],
        CORE: [
        ...
        ADVANCED: [
          {
            ...
            targetLatex: "k",
            slots: [{ id: "k", labelLatex: "k", placeholder: "x.xx", expected: 2.45 }],
        ...
        ELITE: [
          {
            ...
            targetLatex: "\\lambda",
            slots: [{ id: "lam", labelLatex: "\\lambda(m)", placeholder: "x.xe-16", expected: 4.13e-16 }],
        ...
        BASIC: [
          {
            ...
            targetLatex: "T",
            slots: [{ id: "T", labelLatex: "T", placeholder: "0.xxx", expected: 0.135 }],
        ...
        CORE: [
          {
            ...
            targetLatex: "\\kappa",
            slots: [{ id: "kappa", labelLatex: "\\kappa", placeholder: "x.xx", expected: 2 }],
        ...
        ADVANCED: [
          {
            ...
            targetLatex: "T",
            slots: [{ id: "T", labelLatex: "T", placeholder: "0.xxx", expected: 0.0025 }],
        ...
        ELITE: [
          {
            ...
            targetLatex: "a",
            slots: [{ id: "a", labelLatex: "a(nm)", placeholder: "x.xx", expected: 1.54 }],
        ...
        BASIC: [
          {
            ...
            targetLatex: "n",
            slots: [{ id: "n", labelLatex: "n", placeholder: "2", expected: 2 }],
            correctLatex: "n=2",
          },
        ],
        CORE: [
          {
            ...
            targetLatex: "E_3",
            slots: [{ id: "E3", labelLatex: "E_3(eV)", placeholder: "x.x", expected: 4.5 }],
        ...
        ADVANCED: [
          {
            ...
            targetLatex: "\\Delta E",
            slots: [{ id: "dE", labelLatex: "\\Delta E(eV)", placeholder: "x.x", expected: 1.5 }],
        ...
        ELITE: [
          {
            ...
            targetLatex: "f",
            slots: [{ id: "f", labelLatex: "f(Hz)", placeholder: "x.xe14", expected: 5.80e14 }],
