        ...
        if (difficulty === "CORE") {
            return [
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{Old}=8,\\; \\text{${t("sm2_04.labels.new_value")}}=12`,
                    targetLatex: `k`,
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{Old}=12,\\; \\text{${t("sm2_04.labels.new_value")}}=18`,
                    targetLatex: `k`,
                    slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 1.5 }],
        ...
        if (difficulty === "ADVANCED") {
            return [
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{Old}=15,\\; \\text{${t("sm2_04.labels.new_value")}}=9`,
                    targetLatex: `k`,
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{Old}=20,\\; \\text{${t("sm2_04.labels.new_value")}}=14`,
                    targetLatex: `k`,
        ...
        return [
            {
                ...
                promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                expressionLatex: `\\text{Old}=18,\\; \\text{${t("sm2_04.labels.new_value")}}=10.8`,
                targetLatex: `k`,
                slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 0.6 }],
            ...
            },
            {
                ...
                promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                expressionLatex: `\\text{Old}=16.8,\\; \\text{${t("sm2_04.labels.new_value")}}=25.2`,
                targetLatex: `k`,
                slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 1.5 }],
            ...
            },
            {
                ...
                promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                expressionLatex: `\\text{Old}=35,\\; \\text{${t("sm2_04.labels.new_value")}}=21`,
                targetLatex: `k`,
                slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 0.6 }],
