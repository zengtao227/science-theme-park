            ...
            return [
                {
                    ...
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}} = 4, \\; k = 2`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 8 }],
                    correctLatex: `\\text{${t("sm2_04.labels.new_value")}}=4\\cdot 2=8`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `\\text{${t("sm2_04.labels.new_value")}}=k\\cdot \\text{${t("sm2_04.labels.old_value")}}`, `8`],
                    visual: { kind: "rect-scale", a: 4, b: 2, k: 2 },
                },
                {
                    id: "SF_B2", difficulty, stage,
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=6,\\; k=3`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 18 }],
                    correctLatex: `\\text{${t("sm2_04.labels.new_value")}}=6\\cdot 3=18`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `\\text{${t("sm2_04.labels.new_value")}}=k\\cdot \\text{${t("sm2_04.labels.old_value")}}`, `18`],
                    visual: { kind: "rect-scale", a: 6, b: 2, k: 3 },
                },
                {
                    id: "SF_B3", difficulty, stage,
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=10,\\; k=2`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 20 }],
                    correctLatex: `\\text{${t("sm2_04.labels.new_value")}}=10\\cdot 2=20`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `\\text{${t("sm2_04.labels.new_value")}}=k\\cdot \\text{${t("sm2_04.labels.old_value")}}`, `20`],
                    visual: { kind: "rect-scale", a: 10, b: 3, k: 2 },
                },
                {
                    id: "SF_B4", difficulty, stage,
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=5,\\; k=4`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 20 }],
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=8,\\; k=2`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 16 }],
                    correctLatex: `\\text{${t("sm2_04.labels.new_value")}}=8\\cdot 2=16`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `\\text{${t("sm2_04.labels.new_value")}}=k\\cdot \\text{${t("sm2_04.labels.old_value")}}`, `16`],
            ...
            return [
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=4,\\; k=\\frac{3}{2}`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 6 }],
                    correctLatex: `\\text{${t("sm2_04.labels.new_value")}}=4\\cdot \\frac{3}{2}=6`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `\\text{${t("sm2_04.labels.new_value")}}=k\\cdot \\text{${t("sm2_04.labels.old_value")}}`, `6`],
                    visual: { kind: "rect-scale", a: 4, b: 2, k: 1.5 },
                },
                {
                    id: "SF_C2", difficulty, stage,
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=8,\\; \\text{${t("sm2_04.labels.new_value")}}=12`,
                    targetLatex: `k`,
                    slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 1.5 }],
                    correctLatex: `k=\\frac{12}{8}=\\frac{3}{2}=1.5`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `k=\\frac{\\text{${t("sm2_04.labels.new_value")}}}{\\text{${t("sm2_04.labels.old_value")}}}`, `k=\\frac{3}{2}`],
                    visual: { kind: "rect-scale", a: 8, b: 3, k: 1.5 },
                },
                {
                    id: "SF_C3", difficulty, stage,
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=6,\\; k=\\frac{5}{3}`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 10 }],
                    correctLatex: `\\text{${t("sm2_04.labels.new_value")}}=6\\cdot \\frac{5}{3}=10`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `\\text{${t("sm2_04.labels.new_value")}}=k\\cdot \\text{${t("sm2_04.labels.old_value")}}`, `10`],
                    visual: { kind: "rect-scale", a: 6, b: 2, k: 5 / 3 },
                },
                {
                    id: "SF_C4", difficulty, stage,
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=12,\\; \\text{${t("sm2_04.labels.new_value")}}=18`,
                    targetLatex: `k`,
                    slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 1.5 }],
                    correctLatex: `k=\\frac{18}{12}=\\frac{3}{2}=1.5`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `k=\\frac{\\text{${t("sm2_04.labels.new_value")}}}{\\text{${t("sm2_04.labels.old_value")}}}`, `1.5`],
                    visual: { kind: "rect-scale", a: 12, b: 3, k: 1.5 },
                },
                {
                    id: "SF_C5", difficulty, stage,
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=9,\\; k=\\frac{4}{3}`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 12 }],
                    correctLatex: `\\text{${t("sm2_04.labels.new_value")}}=9\\cdot \\frac{4}{3}=12`,
                    hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `\\text{${t("sm2_04.labels.new_value")}}=k\\cdot \\text{${t("sm2_04.labels.old_value")}}`, `12`],
            ...
            return [
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=5,\\; k=0.8`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 4 }],
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=15,\\; \\text{${t("sm2_04.labels.new_value")}}=9`,
                    targetLatex: `k`,
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=7.5,\\; k=1.6`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 12 }],
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=20,\\; \\text{${t("sm2_04.labels.new_value")}}=14`,
                    targetLatex: `k`,
                ...
                },
                {
                    ...
                    promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                    expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=12.5,\\; k=0.64`,
                    targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                    slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 8 }],
        ...
        return [
            {
                ...
                promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=18,\\; \\text{${t("sm2_04.labels.new_value")}}=10.8`,
                targetLatex: `k`,
                slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 0.6 }],
            ...
            },
            {
                ...
                promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=22.5,\\; k=\\frac{8}{15}`,
                targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 12 }],
            ...
            },
            {
                ...
                promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=16.8,\\; \\text{${t("sm2_04.labels.new_value")}}=25.2`,
                targetLatex: `k`,
                slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 1.5 }],
            ...
            },
            {
                ...
                promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=27,\\; k=\\frac{5}{9}`,
                targetLatex: `\\text{${t("sm2_04.labels.new_value")}}`,
                slots: [{ id: "n", labelLatex: `\\text{${t("sm2_04.labels.new_value")}}`, placeholder: sm2_04_t.placeholders.value, expected: 15 }],
                correctLatex: `\\text{${t("sm2_04.labels.new_value")}}=27\\cdot \\frac{5}{9}=15`,
                hintLatex: [t("sm2_04.hints.rules.scale_factor_latex"), `\\text{${t("sm2_04.labels.new_value")}}=k\\cdot \\text{${t("sm2_04.labels.old_value")}}`, `15`],
                visual: { kind: "rect-scale", a: 27, b: 7, k: 5 / 9 },
            },
            {
                id: "SF_E5", difficulty, stage,
                promptLatex: t("sm2_04.stages.stages_prompt_latex"),
                expressionLatex: `\\text{${t("sm2_04.labels.old_value")}}=35,\\; \\text{${t("sm2_04.labels.new_value")}}=21`,
                targetLatex: `k`,
                slots: [{ id: "k", labelLatex: `k`, placeholder: "k", expected: 0.6 }],
            ...
            return [
                {
                    ...
                    targetLatex: `w`,
                    slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 1.2 }],
                ...
                },
                {
                    ...
                    targetLatex: `w`,
                    slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 3.2 }],
                ...
                },
                {
                    ...
                    targetLatex: `w`,
                    slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 4 }],
                ...
                },
                {
                    ...
                    targetLatex: `w`,
                    slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 2.8 }],
                ...
                },
                {
                    ...
                    targetLatex: `w`,
                    slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 3.6 }],
        ...
        return [
            {
                ...
                targetLatex: `w`,
                slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 4.8 }],
            ...
            },
            {
                ...
                targetLatex: `w`,
                slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 5.6 }],
            ...
            },
            {
                ...
                targetLatex: `w`,
                slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 4.4 }],
            ...
            },
            {
                ...
                targetLatex: `w`,
                slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 5.2 }],
            ...
            },
            {
                ...
                targetLatex: `w`,
                slots: [{ id: "w", labelLatex: `w`, placeholder: sm2_04_t.placeholders.width, expected: 6 }],
