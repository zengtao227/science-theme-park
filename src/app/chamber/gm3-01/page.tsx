        ...
        <div className="min-h-screen bg-black text-green-400 font-mono p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 mb-6 border-2 border-cyan-500 p-4 bg-black/80">
                <div className="flex justify-between items-center mb-2">
                    <h1 className="text-2xl font-bold text-cyan-400">{t("gm3_01.title")}</h1>
                    <Link href="/" className="px-4 py-2 border border-cyan-500 hover:bg-cyan-500/20 transition-colors">
                        {t("gm3_01.back")}
                    </Link>
                </div>
                <div className="text-sm text-cyan-300/70">{t("gm3_01.footer_left")}</div>
            </div>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="border-2 border-green-500 p-4 bg-black/80 space-y-4 overflow-y-auto max-h-[600px]">
                    <div className="border-b border-green-500 pb-2 mb-4">
                        <h2 className="text-lg font-bold text-green-400">{t("gm3_01.monitor_title")}</h2>
                    </div>

                    <div className="space-y-2">
                        <label className="text-sm text-cyan-400">{t("gm3_01.labels.rows")}</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-sm text-purple-400">{t("gm3_01.labels.ball_count")}</label>
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center space-x-2 cursor-pointer">
                            ...
                            <span className="text-green-400">{t("gm3_01.labels.show_distribution")}</span>
                        </label>
                    </div>

                    <div className="border border-green-500 p-3 space-y-2">
                        <div className="text-sm text-green-400">{t("gm3_01.normal.title")}</div>
                        <div className="space-y-1 text-xs">
                            <div className="flex justify-between">
                                <span className="text-green-300">{t("gm3_01.normal.mean")}</span>
                                <span className="text-green-200 font-bold">{mean.toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-green-300">{t("gm3_01.normal.std_dev")}</span>
                                <span className="text-green-200 font-bold">{stdDev.toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-green-300">{t("gm3_01.normal.variance")}</span>
                    ...
                    <div className="border border-purple-500 p-3 space-y-2">
                        <div className="text-sm text-purple-400">{t("gm3_01.binomial.title")}</div>
                        <div className="text-xs space-y-1 text-purple-300/80">
                            <div>{t("gm3_01.binomial.line_1")}</div>
                            <div>{t("gm3_01.binomial.line_2")}</div>
                            <div>{t("gm3_01.binomial.line_3")}</div>
                            <div>{t("gm3_01.binomial.line_4")}</div>
                        </div>
                    </div>

                    <div className="border border-cyan-500 p-3 space-y-2">
                        <div className="text-sm text-cyan-400">{t("gm3_01.mission.title")}</div>
                        <div className="text-xs text-cyan-300/80">{t("gm3_01.mission.description")}</div>
                    </div>
                </div>
            </div>
        </div>
