            ...
            if (difficulty === "BASIC") {
                ...
                levers.forEach((lever, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "lever",
                        promptLatex: `Lever: load ${lever.load} N at ${lever.loadArm} m, effort arm ${lever.effortArm} m. Effort force?`,
            ...
            if (difficulty === "CORE") {
                ...
                levers.forEach((lever, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "lever",
                        promptLatex: `Class ${lever.class} lever: load ${lever.load} N, effort arm ${lever.effortArm} m, load arm ${lever.loadArm} m. Effort?`,
            ...
            if (difficulty === "ADVANCED") {
                ...
                levers.forEach((lever, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "lever",
                        promptLatex: `Lever with ${lever.efficiency * 100}% efficiency: load ${lever.load} N, MA = ${lever.effortArm}. Actual effort?`,
            ...
            if (difficulty === "ELITE") {
                ...
                levers.forEach((lever, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "lever",
                        promptLatex: `Two-stage lever system: each stage MA = ${lever.effortArm}, load ${lever.load} N. Input effort?`,
            ...
            if (difficulty === "BASIC") {
                ...
                pulleys.forEach((pulley, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "pulley",
                        promptLatex: `Pulley system: ${pulley.strands} supporting strands, load ${pulley.load} N. Effort force?`,
            ...
            if (difficulty === "CORE") {
                ...
                pulleys.forEach((pulley, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "pulley",
                        promptLatex: `Pulley: ${pulley.movable} movable, ${pulley.fixed} fixed. Load ${pulley.load} N. Effort?`,
            ...
            if (difficulty === "ADVANCED") {
                ...
                pulleys.forEach((pulley, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "pulley",
                        promptLatex: `Pulley: ${pulley.strands} strands, ${pulley.efficiency * 100}% efficiency, load ${pulley.load} N. Actual effort?`,
            ...
            if (difficulty === "ELITE") {
                ...
                pulleys.forEach((pulley, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "pulley",
                        promptLatex: `Block and tackle: ${pulley.blocks} blocks, ${pulley.strands} strands, load ${pulley.load} N. Effort?`,
                        expressionLatex: `F_e = \\frac{F_l}{n}`,
                        targetLatex: pulley.effort.toString(),
                        slots: [{ id: "ans", labelLatex: "F_e\\text{ (N)}", placeholder: "...", expected: pulley.effort.toString() }],
                        correctLatex: `${pulley.effort}\\,\\text{N}`,
            ...
            if (difficulty === "BASIC") {
                ...
                planes.forEach((plane, idx) => {
                    quests.push({
                        ...
                        promptLatex: `Inclined plane: height ${plane.height} m, length ${plane.length} m, load ${plane.load} N. Effort?`,
            ...
            if (difficulty === "CORE") {
                ...
                planes.forEach((plane, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "inclined_plane",
                        promptLatex: `Inclined plane: angle ${plane.angle}°, load ${plane.load} N. Effort parallel to plane?`,
            ...
            if (difficulty === "ADVANCED") {
                ...
                planes.forEach((plane, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "inclined_plane",
                        promptLatex: `Inclined plane: h=${plane.height} m, l=${plane.length} m, load ${plane.load} N, friction μ=${plane.friction}. Effort?`,
            ...
            if (difficulty === "ELITE") {
                ...
                planes.forEach((plane, idx) => {
                    quests.push({
                        ...
                        stage,
                        machineType: "inclined_plane",
                        promptLatex: `Screw jack: pitch ${plane.pitch} cm, handle radius ${plane.radius} cm, load ${plane.load} N. Effort?`,
