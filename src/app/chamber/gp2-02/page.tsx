    ...
    if (stage === "FIRST_LAW") {
        if (difficulty === "BASIC") {
            ...
            quests.push(
                ...
                { id: "FL-A5", difficulty, stage, processType: "basic", promptLatex: "Boiling water: Q=Lv*m (Latent). W=P dV. dU < Q?", expressionLatex: "\Delta U = Q - P\Delta V", targetLatex: t("gp2_02.labels.yes_no"), slots: [{ id: "a", labelLatex: t("gp2_02.labels.label_yn"), placeholder: "yes", expected: "yes" }], correctLatex: "Yes", hintLatex: ["Work done expanding"] }
            );
        } else { // ELITE
            quests.push(
                ...
                { id: "FL-E3", difficulty, stage, processType: "basic", promptLatex: "Adiabatic: TV^{g-1} = const. Monatomic g=1.67. Compress V by 2. T factor?", expressionLatex: "2^{0.67} \approx 1.59", targetLatex: t("gp2_02.labels.factor"), slots: [{ id: "f", labelLatex: "F", placeholder: "1.59", expected: 1.59 }], correctLatex: "1.59", hintLatex: ["Power law"] },
                { id: "FL-E4", difficulty, stage, processType: "basic", promptLatex: "Polytropic PV^n = C. Work integral PdV. n!=1.", expressionLatex: "\\frac{P_2V_2 - P_1V_1}{1-n}", targetLatex: t("gp2_02.labels.formula"), slots: [{ id: "n", labelLatex: "n", placeholder: "n", expected: "n" }], correctLatex: "Polytropic index", hintLatex: ["Calculus"] },
    ...
    if (stage === "INTERNAL_ENERGY") {
        if (difficulty === "BASIC") {
            quests.push(
                ...
                { id: "IE-B3", difficulty, stage, processType: "monatomic", promptLatex: "Ideal gas T doubles. U factor?", expressionLatex: "U \propto T", targetLatex: t("gp2_02.labels.factor"), slots: [{ id: "f", labelLatex: "F", placeholder: "2", expected: 2 }], correctLatex: "2", hintLatex: ["Linear"] },
                ...
                { id: "IE-B5", difficulty, stage, processType: "monatomic", promptLatex: "Cool gas, T decreases. U?", expressionLatex: "U \downarrow", targetLatex: t("gp2_02.labels.sign"), slots: [{ id: "s", labelLatex: "+/-", placeholder: "-", expected: "-" }], correctLatex: "Decreases", hintLatex: ["Kinetic energy drops"] }
            );
        } else if (difficulty === "CORE") {
            quests.push(
                ...
                { id: "IE-C3", difficulty, stage, processType: "change", promptLatex: "dU depends on path or state?", expressionLatex: "\oint dU = 0", targetLatex: t("gp2_02.labels.type"), slots: [{ id: "t", labelLatex: t("gp2_02.labels.label_type"), placeholder: "state", expected: "state" }], correctLatex: "State Function", hintLatex: ["Path independent"] },
            ...
            quests.push(
                { id: "IE-A1", difficulty, stage, processType: "advanced", promptLatex: "Real gas: U depends on T and V. Why V?", expressionLatex: "\\text{Interaction}", targetLatex: t("gp2_02.labels.reason"), slots: [{ id: "r", labelLatex: "R", placeholder: "forces", expected: "forces" }], correctLatex: "Intermolecular forces", hintLatex: ["Potential energy"] },
                ...
                { id: "IE-A3", difficulty, stage, processType: "advanced", promptLatex: "Vibrational modes freeze out at low T. Diatomic Cv -> ?", expressionLatex: "5/2 R \to 3/2 R", targetLatex: t("gp2_02.labels.cv_r"), slots: [{ id: "c", labelLatex: "F", placeholder: "1.5", expected: 1.5 }], correctLatex: "1.5", hintLatex: ["Behaves like monatomic"] },
                { id: "IE-A4", difficulty, stage, processType: "advanced", promptLatex: "U for ideal gas depends only on T. Is this true for Enthalpy H?", expressionLatex: "H=U+PV=U+nRT \propto T", targetLatex: "Y/N", slots: [{ id: "a", labelLatex: t("gp2_02.labels.label_yn"), placeholder: "yes", expected: "yes" }], correctLatex: "Yes", hintLatex: ["Also pure T func"] },
            ...
            quests.push(
                ...
                { id: "IE-E2", difficulty, stage, processType: "elite", promptLatex: "Real Gas Joule Expansion. dT usually?", expressionLatex: "dT < 0", targetLatex: t("gp2_02.labels.sign"), slots: [{ id: "s", labelLatex: "+/-", placeholder: "-", expected: "-" }], correctLatex: "Negative (Cooling)", hintLatex: ["Work against forces"] },
                ...
                { id: "IE-E4", difficulty, stage, processType: "elite", promptLatex: "Internal Energy Density u = U/V. For photon gas, u = a T^{4}. Pressure P = u/3. EoS?", expressionLatex: "P = 1/3 a T^{4}", targetLatex: t("gp2_02.labels.factor"), slots: [{ id: "f", labelLatex: "1/x", placeholder: "3", expected: 3 }], correctLatex: "1/3", hintLatex: ["Radiation pressure"] },
    ...
    if (stage === "WORK_HEAT") {
        if (difficulty === "BASIC") {
            quests.push(
                ...
                { id: "WH-B4", difficulty, stage, processType: "basic", promptLatex: "Sign convention: Work done ON the system?", expressionLatex: "W < 0", targetLatex: t("gp2_02.labels.sign"), slots: [{ id: "s", labelLatex: "+/-", placeholder: "-", expected: "-" }], correctLatex: "Negative", hintLatex: ["Opposite to expansion"] },
            ...
            quests.push(
                ...
                { id: "WH-C4", difficulty, stage, processType: "cycle", promptLatex: "Clockwise cycle on PV diagram. Total Work sign?", expressionLatex: "W > 0", targetLatex: t("gp2_02.labels.sign"), slots: [{ id: "s", labelLatex: "+/-", placeholder: "+", expected: "+" }], correctLatex: "Positive", hintLatex: ["Net expansion"] },
                { id: "WH-C5", difficulty, stage, processType: "unit", promptLatex: "Unit of P x V? Pa x m^{3} = ?", expressionLatex: "N/m^{2} \times m^{3} = Nm = J", targetLatex: t("gp2_02.labels.unit"), slots: [{ id: "u", labelLatex: "U", placeholder: "Joule", expected: "Joule" }], correctLatex: "Joule", hintLatex: ["Energy"] }
            );
        } else if (difficulty === "ADVANCED") {
            quests.push(
                ...
                { id: "WH-A5", difficulty, stage, processType: "path", promptLatex: "Is Work a path function or state function?", expressionLatex: "\\text{Depends on path}", targetLatex: t("gp2_02.labels.type"), slots: [{ id: "t", labelLatex: t("gp2_02.labels.label_ps"), placeholder: "path", expected: "path" }], correctLatex: "Path", hintLatex: ["Trajectory matters"] }
            );
        } else { // ELITE
            quests.push(
                { id: "WH-E1", difficulty, stage, processType: "elite", promptLatex: "Polytropic n. W = (P2V2-P1V1)/(1-n). If n=1?", expressionLatex: "\\text{Undefined}", targetLatex: t("gp2_02.labels.limit"), slots: [{ id: "l", labelLatex: t("gp2_02.labels.label_type"), placeholder: "isothermal", expected: "isothermal" }], correctLatex: "Isothermal (ln)", hintLatex: ["Logarithmic case"] },
                { id: "WH-E2", difficulty, stage, processType: "elite", promptLatex: "Van der Waals Work: P = nRT/(V-nb) - ... Ignore 'a'. Isothermal expansion V1 to V2.", expressionLatex: "nRT \ln((V_2-nb)/(V_1-nb))", targetLatex: t("gp2_02.labels.corr"), slots: [{ id: "c", labelLatex: "-", placeholder: "nb", expected: "nb" }], correctLatex: "-nb", hintLatex: ["Excluded volume"] },
                { id: "WH-E3", difficulty, stage, processType: "elite", promptLatex: "Stirling Angle Cycle. Two Isotherms, Two ...?", expressionLatex: "\\text{Isochors}", targetLatex: t("gp2_02.labels.procs"), slots: [{ id: "p", labelLatex: "V", placeholder: "constant", expected: "constant" }], correctLatex: "Constant Volume", hintLatex: ["Regeneration"] },
                ...
                { id: "WH-E5", difficulty, stage, processType: "elite", promptLatex: "Entropy production in irreversible work?", expressionLatex: "dS > 0", targetLatex: t("gp2_02.labels.sign"), slots: [{ id: "s", labelLatex: "+/-", placeholder: "+", expected: "+" }], correctLatex: "Positive", hintLatex: ["Second Law"] }
            );
        }
    }
