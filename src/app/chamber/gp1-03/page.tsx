        ...
        BASIC: [
          {
            ...
            targetLatex: "\\gamma",
            slots: [{ id: "gamma", labelLatex: "\\gamma", placeholder: "x.xx", expected: 1.25 }],
        ...
        CORE: [
          {
            ...
            targetLatex: "E",
            slots: [{ id: "E", labelLatex: "E(GeV)", placeholder: "xxxx", expected: 6566 }],
        ...
        ADVANCED: [
          {
            ...
            targetLatex: "\\gamma",
            slots: [{ id: "gamma", labelLatex: "\\gamma", placeholder: "xx.x", expected: 7.09 }],
        ...
        ELITE: [
          {
            ...
            targetLatex: "p",
            slots: [{ id: "p", labelLatex: "p(GeV/c)", placeholder: "xxxx", expected: 7000 }],
        ...
        BASIC: [
          {
            ...
            targetLatex: "\\sqrt{s}",
            slots: [{ id: "s", labelLatex: "\\sqrt{s}(TeV)", placeholder: "xx.x", expected: 13 }],
        ...
        CORE: [
          {
            ...
            targetLatex: "N",
            slots: [{ id: "N", labelLatex: "N", placeholder: "xxxx", expected: 1000000 }],
            correctLatex: "N=10^6",
          },
        ],
        ADVANCED: [
          {
            ...
            targetLatex: "E_{cm}",
            slots: [{ id: "Ecm", labelLatex: "E_{cm}(TeV)", placeholder: "xx.x", expected: 13 }],
        ...
        ELITE: [
          {
            ...
            targetLatex: "\\beta",
            slots: [{ id: "beta", labelLatex: "\\beta=v/c", placeholder: "0.xxxxx", expected: 0.99999999 }],
        ...
        BASIC: [
          {
            ...
            targetLatex: "r",
            slots: [{ id: "r", labelLatex: "r(m)", placeholder: "x.xx", expected: 3.33 }],
        ...
        CORE: [
          {
            ...
            targetLatex: "m",
            slots: [{ id: "m", labelLatex: "m(GeV/c^2)", placeholder: "xxx", expected: 118 }],
        ...
        ADVANCED: [
          {
            ...
            targetLatex: "\\eta",
            slots: [{ id: "eta", labelLatex: "\\eta", placeholder: "x.xx", expected: 2.44 }],
        ...
        ELITE: [
          {
            ...
            targetLatex: "\\Delta m",
            slots: [{ id: "dm", labelLatex: "\\Delta m(GeV)", placeholder: "-x.x", expected: -0.3 }],
