            ...
            if (difficulty === "BASIC") {
                QUEST_DATA.SI_UNITS.BASIC.forEach((u, idx) => {
                    quests.push({
                        ...
                        promptLatex: `What is the SI unit for ${u.measurement}?`,
            ...
            if (difficulty === "ADVANCED") {
                QUEST_DATA.SI_UNITS.ADVANCED.forEach((c, idx) => {
                    quests.push({
                        ...
                        fromUnit: c.from,
                        toUnit: c.to,
                        promptLatex: `Convert ${c.value} ${c.from} to ${c.to}`,
            ...
            if (difficulty === "CORE") {
                ...
                rounding.forEach((r, idx) => {
                    quests.push({
                        ...
                        difficulty,
                        stage,
                        promptLatex: `Round ${r.value} to ${r.sigfigs} significant figures`,
            ...
            if (difficulty === "ADVANCED") {
                ...
                calculations.forEach((c, idx) => {
                    quests.push({
                        ...
                        difficulty,
                        stage,
                        promptLatex: `Calculate ${c.expr} with proper sig figs`,
