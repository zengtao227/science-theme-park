        ...
        if (difficulty === "BASIC") {
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.oxidation_state")}}`, placeholder: "±n", expected: item.answer }],
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.oxidation_state")}}`, placeholder: "±n", expected: round2(item.answer) }],
