        ...
        if (difficulty === "BASIC") {
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.agent")}}`, placeholder: "Formula", expected: item.answer }],
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.electrons")}}`, placeholder: "n", expected: item.electrons }],
        ...
        if (difficulty === "BASIC") {
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.mass_g")}}`, placeholder: "g", expected: round2(item.mass) }],
