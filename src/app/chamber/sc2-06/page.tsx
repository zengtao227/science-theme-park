        ...
        if (difficulty === "BASIC") {
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.oxidation_state")}}`, placeholder: t("sc2_06.placeholders.plus_minus_n"), expected: item.answer }],
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.oxidation_state")}}`, placeholder: t("sc2_06.placeholders.plus_minus_n"), expected: round2(item.answer) }],
        ...
        if (difficulty === "BASIC") {
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.agent")}}`, placeholder: t("sc2_06.placeholders.formula"), expected: item.answer }],
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.electrons")}}`, placeholder: t("sc2_06.placeholders.n"), expected: item.electrons }],
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              expressionLatex: `\\text{${item.reaction}}`,
              targetLatex: `${item.electrons}e^-`,
              slots: [{ id: "ans", labelLatex: t("sc2_06.labels.total_electrons"), placeholder: t("sc2_06.placeholders.n"), expected: item.electrons }],
              correctLatex: `${item.electrons}e^-`,
              reactants: [{ formula: "Reactant", oxidationState: 0 }],
              products: [{ formula: "Product", oxidationState: 0 }],
              oxidationStates: {},
        ...
        if (difficulty === "BASIC") {
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              targetLatex: `\\text{${item.answer}}`,
              slots: [{ id: "ans", labelLatex: t("common.labels.answer"), placeholder: t("sc2_06.placeholders.ellipsis"), expected: item.answer }],
              correctLatex: `\\text{${item.answer}}`,
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: "E^\\circ_{\\text{cell}}", placeholder: t("sc2_06.placeholders.v"), expected: round2(item.e0) }],
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: "E_{\\text{cell}}", placeholder: t("sc2_06.placeholders.v"), expected: round2(item.e) }],
          ...
          data.forEach((item, idx) => {
            quests.push({
              ...
              slots: [{ id: "ans", labelLatex: `\\text{${t("sc2_06.labels.mass_g")}}`, placeholder: t("sc2_06.placeholders.g"), expected: round2(item.mass) }],
