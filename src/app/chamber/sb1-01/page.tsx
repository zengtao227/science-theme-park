        ...
        if (stage === "IDENTIFICATION") {
            ...
            orgList.forEach((org, idx) => {
                quests.push({
                    ...
                    expressionLatex: `\\text{${t("sb1_01.expressions.size_label")}} ${org.size} \\, \\mu\\text{m}`,
                    targetLatex: org.key,
                    slots: [{ id: "ans", labelLatex: t("common.labels.organelle"), placeholder: t("sb1_01.placeholders.ellipsis"), expected: org.key }],
        ...
        if (stage === "FUNCTION") {
            ...
            funcList.forEach((item, idx) => {
                quests.push({
                    ...
                    expressionLatex: `\\text{${t("sb1_01.expressions.function_label")}} \\text{${item.func}}`,
                    targetLatex: item.answer,
                    slots: [{ id: "ans", labelLatex: t("common.labels.organelle"), placeholder: t("sb1_01.placeholders.ellipsis"), expected: item.answer }],
        ...
        if (stage === "ORGANELLES") {
            ...
            compList.forEach((item, idx) => {
                quests.push({
                    ...
                    slots: [{ id: "ans", labelLatex: t("common.labels.value"), placeholder: t("sb1_01.placeholders.ellipsis"), expected: item.answer }],
