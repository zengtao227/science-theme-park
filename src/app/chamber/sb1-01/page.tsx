        ...
        if (stage === "IDENTIFICATION") {
            ...
            orgList.forEach((org, idx) => {
                quests.push({
                    ...
                    targetLatex: org.key,
                    slots: [{ id: "ans", labelLatex: t("common.labels.organelle"), placeholder: "...", expected: org.key }],
        ...
        if (stage === "FUNCTION") {
            ...
            funcList.forEach((item, idx) => {
                quests.push({
                    ...
                    slots: [{ id: "ans", labelLatex: t("common.labels.organelle"), placeholder: "...", expected: item.answer }],
