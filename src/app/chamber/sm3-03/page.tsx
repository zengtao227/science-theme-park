...
function buildStagePool(sm3_03_t: any, d: Difficulty, s: Stage): S303Quest[] {
  ...
  if (s === "EXPONENTIAL") {
    ...
    if (d === "BASIC") {
      quests.push(
        q("E-B1", "BASIC", "EXPONENTIAL", pBasic, "N_0=100,\\; d=2\\;h,\\; t=4\\;h", "N(t)", [{ id: "N", l: "N(4)", e: 400 }], "N(4)=400", { initialCount: 100, doublingTime: 2, time: 4, scenarioKey: "exp_bac" }),
        q("E-B2", "BASIC", "EXPONENTIAL", pBasic, "N_0=10,\\; d=3\\;h,\\; t=6\\;h", "N(t)", [{ id: "N", l: "N(6)", e: 40 }], "N(6)=40", { initialCount: 10, doublingTime: 3, time: 6, scenarioKey: "exp_bac" }),
        q("E-B3", "BASIC", "EXPONENTIAL", pBasic, "N_0=50,\\; d=1\\;h,\\; t=3\\;h", "N(t)", [{ id: "N", l: "N(3)", e: 400 }], "N(3)=400", { initialCount: 50, doublingTime: 1, time: 3, scenarioKey: "exp_bac" }),
        q("E-B4", "BASIC", "EXPONENTIAL", pBasic, "N_0=25,\\; d=2\\;h,\\; t=6\\;h", "N(t)", [{ id: "N", l: "N(6)", e: 200 }], "N(6)=200", { initialCount: 25, doublingTime: 2, time: 6, scenarioKey: "exp_bac" }),
        q("E-B5", "BASIC", "EXPONENTIAL", pBasic, "N_0=200,\\; d=4\\;h,\\; t=4\\;h", "N(t)", [{ id: "N", l: "N(4)", e: 400 }], "N(4)=400", { initialCount: 200, doublingTime: 4, time: 4, scenarioKey: "exp_bac" }),
        q("E-B6", "BASIC", "EXPONENTIAL", pBasic, "N_0=1000,\\; d=10\\;h,\\; t=20\\;h", "N(t)", [{ id: "N", l: "N(20)", e: 4000 }], "N(20)=4000", { initialCount: 1000, doublingTime: 10, time: 20, scenarioKey: "exp_bac" }),
        q("E-B7", "BASIC", "EXPONENTIAL", pBasic, "N_0=5,\\; d=1\\;h,\\; t=5\\;h", "N(t)", [{ id: "N", l: "N(5)", e: 160 }], "N(5)=160", { initialCount: 5, doublingTime: 1, time: 5, scenarioKey: "exp_bac" }),
        q("E-B8", "BASIC", "EXPONENTIAL", pBasic, "N_0=1,\\; d=1\\;h,\\; t=10\\;h", "N(t)", [{ id: "N", l: "N(10)", e: 1024 }], "N(10)=1024", { initialCount: 1, doublingTime: 1, time: 10, scenarioKey: "exp_bac" })
      );
    } else if (d === "CORE") {
      quests.push(
        ...
        q("E-C3", "CORE", "EXPONENTIAL", pBasic, "N_0=100,\\; d=3\\;h,\\; t=4.5\\;h", "N(t)", [{ id: "N", l: "N(4.5)", e: 282.8 }], "N \\approx 282.8", { initialCount: 100, doublingTime: 3, time: 4.5, scenarioKey: "exp_bac" }),
        q("E-C4", "CORE", "EXPONENTIAL", pBasic, "N_0=20,\\; d=2\\;h,\\; t=7\\;h", "N(t)", [{ id: "N", l: "N(7)", e: 226.3 }], "20 \\cdot 2^{3.5} \\approx 226.3", { initialCount: 20, doublingTime: 2, time: 7, scenarioKey: "exp_bac" }),
        q("E-C5", "CORE", "EXPONENTIAL", pBasic, "N_0=1000,\\; d=5\\;h,\\; t=2.5\\;h", "N(t)", [{ id: "N", l: "N(2.5)", e: 1414.2 }], "N \\approx 1414.2", { initialCount: 1000, doublingTime: 5, time: 2.5, scenarioKey: "exp_bac" }),
        q("E-C6", "CORE", "EXPONENTIAL", pBasic, "N_0=10,\\; d=1.5\\;h,\\; t=3\\;h", "N(t)", [{ id: "N", l: "N(3)", e: 40 }], "N(3)=40", { initialCount: 10, doublingTime: 1.5, time: 3, scenarioKey: "exp_bac" }),
        q("E-C7", "CORE", "EXPONENTIAL", pBasic, "N_0=64,\\; d=2\\;h,\\; t=-2\\;h", "N(t)", [{ id: "N", l: "N(-2)", e: 32 }], "64 \\cdot 2^{-1} = 32", { initialCount: 64, doublingTime: 2, time: -2, scenarioKey: "exp_bac" }), // Decay scenario in growth context
        q("E-C8", "CORE", "EXPONENTIAL", pBasic, "N_0=80,\\; d=4\\;h,\\; t=-2\\;h", "N(t)", [{ id: "N", l: "N(-2)", e: 56.6 }], "80 \\cdot 2^{-0.5} \\approx 56.6", { initialCount: 80, doublingTime: 4, time: -2, scenarioKey: "exp_bac" })
      );
    } else if (d === "ADVANCED") {
      quests.push(
        q("E-A1", "ADVANCED", "EXPONENTIAL", pAdv, "N_0=100,\\; t=6\\;h,\\; d=2\\;h", "n", [{ id: "n", l: "n", e: 3 }], "n=t/d=3", { initialCount: 100, doublingTime: 2, time: 6, scenarioKey: "exp_virus" }),
        q("E-A2", "ADVANCED", "EXPONENTIAL", pAdv, "N(t)=400,\\; N_0=50", "n", [{ id: "n", l: "n", e: 3 }], "2^n=8 \\implies n=3", { initialCount: 50, doublingTime: 2, time: 6, finalCount: 400, scenarioKey: "exp_virus" }), // time inferred
        q("E-A3", "ADVANCED", "EXPONENTIAL", pAdv, "N(t)=1000,\\; N_0=1000", "n", [{ id: "n", l: "n", e: 0 }], "n=0", { initialCount: 1000, doublingTime: 5, time: 0, scenarioKey: "exp_virus" }),
      ...
      quests.push(
        q("E-E1", "ELITE", "EXPONENTIAL", pElite, "N_0=100,\\; t=d=1\\;h", "k", [{ id: "k", l: "k", e: 0.69 }], "k=\\ln(2)/1 \\approx 0.69", { initialCount: 100, doublingTime: 1, time: 1, scenarioKey: "exp_moore" }),
        q("E-E2", "ELITE", "EXPONENTIAL", pElite, "d=2\\;h", "k", [{ id: "k", l: "k", e: 0.35 }], "k=\\ln(2)/2 \\approx 0.35", { initialCount: 100, doublingTime: 2, scenarioKey: "exp_moore" }),
        q("E-E3", "ELITE", "EXPONENTIAL", pElite, "d=10\\;h", "k", [{ id: "k", l: "k", e: 0.07 }], "k \\approx 0.069", { initialCount: 100, doublingTime: 10, scenarioKey: "exp_moore" }),
        q("E-E4", "ELITE", "EXPONENTIAL", pElite, "N(t)=100e^{0.693t},\\; t=1", "N(1)", [{ id: "N", l: "N", e: 200 }], "e^{0.693} \\approx 2", { initialCount: 100, doublingTime: 1, time: 1, scenarioKey: "exp_moore" }),
        q("E-E5", "ELITE", "EXPONENTIAL", pElite, "N(t)=N_0 e^{kt},\\; k=0.1", "d", [{ id: "d", l: "d", e: 6.9 }], "d=\\ln(2)/0.1 \\approx 6.9", { initialCount: 100, doublingTime: 6.9, scenarioKey: "exp_moore" }),
        q("E-E6", "ELITE", "EXPONENTIAL", pElite, "N_0=50,\\; N(2)=200", "k", [{ id: "k", l: "k", e: 0.69 }], "4=e^{2k} \\implies k=\\ln(4)/2 \\approx 0.69", { initialCount: 50, doublingTime: 1, scenarioKey: "exp_moore" }),
        q("E-E7", "ELITE", "EXPONENTIAL", pElite, "2^{t/d} = e^{kt}", "kd", [{ id: "kd", l: "k \\cdot d", e: 0.69 }], "\\ln(2) \\approx 0.69", { initialCount: 1, doublingTime: 1, scenarioKey: "exp_moore" }),
        q("E-E8", "ELITE", "EXPONENTIAL", pElite, "\\text{Rate } 10\\% \\implies e^{0.1t}", "d", [{ id: "d", l: "d", e: 6.9 }], "d \\approx 6.9", { initialCount: 100, doublingTime: 6.9, scenarioKey: "exp_moore" })
      );
    }
  }
  ...
  if (s === "LOGARITHM") {
    ...
    if (d === "BASIC") {
      ...
      quests.push(
        ...
        q("L-A6", "ADVANCED", "LOGARITHM", pAdv, "\\log_9(3)", "v", [{ id: "v", l: "v", e: 0.5 }], "0.5", { initialCount: 1, doublingTime: 1, scenarioKey: "log_security" }),
        q("L-A7", "ADVANCED", "LOGARITHM", pAdv, "\\log_{0.5}(4)", "v", [{ id: "v", l: "v", e: -2 }], "-2", { initialCount: 1, doublingTime: 1, scenarioKey: "log_security" }),
        q("L-A8", "ADVANCED", "LOGARITHM", pAdv, "\\ln(\\sqrt{e})", "v", [{ id: "v", l: "v", e: 0.5 }], "0.5", { initialCount: 1, doublingTime: 1, scenarioKey: "log_security" })
      );
    } else { // ELITE
      quests.push(
        q("L-E1", "ELITE", "LOGARITHM", pElite, "\\log_2(x) + \\log_2(4) = 5", "x", [{ id: "x", l: "x", e: 8 }], "x=8", { initialCount: 1, doublingTime: 1, scenarioKey: "log_ph" }),
        q("L-E2", "ELITE", "LOGARITHM", pElite, "\\log_2(x) = 3", "x", [{ id: "x", l: "x", e: 8 }], "x=8", { initialCount: 1, doublingTime: 1, scenarioKey: "log_ph" }),
        q("L-E3", "ELITE", "LOGARITHM", pElite, "\\log_x(16)=2", "x", [{ id: "x", l: "x", e: 4 }], "x=4", { initialCount: 1, doublingTime: 1, scenarioKey: "log_security" }),
        q("L-E4", "ELITE", "LOGARITHM", pElite, "\\ln(x)=0", "x", [{ id: "x", l: "x", e: 1 }], "x=1", { initialCount: 1, doublingTime: 1, scenarioKey: "log_ph" }),
        q("L-E5", "ELITE", "LOGARITHM", pElite, "2\\log_2(x)=6", "x", [{ id: "x", l: "x", e: 8 }], "x=8", { initialCount: 1, doublingTime: 1, scenarioKey: "log_ph" }),
        q("L-E6", "ELITE", "LOGARITHM", pElite, "\\log_2(x+2)=3", "x", [{ id: "x", l: "x", e: 6 }], "x=6", { initialCount: 1, doublingTime: 1, scenarioKey: "log_ph" }),
        q("L-E7", "ELITE", "LOGARITHM", pElite, "e^{2x}=1", "x", [{ id: "x", l: "x", e: 0 }], "x=0", { initialCount: 1, doublingTime: 1, scenarioKey: "log_ph" }),
        q("L-E8", "ELITE", "LOGARITHM", pElite, "\\log_{10}(x)=-1", "x", [{ id: "x", l: "x", e: 0.1 }], "0.1", { initialCount: 1, doublingTime: 1, scenarioKey: "log_ph" })
      );
    }
  }
  ...
  if (s === "APPLICATIONS") {
    ...
    if (d === "BASIC") { // Half-life
      quests.push(
        q("A-B1", "BASIC", "APPLICATIONS", pHalf, "N_0=1000,\\; t_{1/2}=5\\;yr,\\; t=10\\;yr", "N(t)", [{ id: "N", l: "N", e: 250 }], "N=250", { initialCount: 1000, doublingTime: 5, time: 10, chartMode: "halflife", scenarioKey: "app_med" }),
        q("A-B2", "BASIC", "APPLICATIONS", pHalf, "N_0=100,\\; h=2\\;h,\\; t=6\\;h", "N(t)", [{ id: "N", l: "N", e: 12.5 }], "N=12.5", { initialCount: 100, doublingTime: 2, time: 6, chartMode: "halflife", scenarioKey: "app_med" }),
        q("A-B3", "BASIC", "APPLICATIONS", pHalf, "N_0=500,\\; h=10\\;min,\\; t=20\\;min", "N(t)", [{ id: "N", l: "N", e: 125 }], "N=125", { initialCount: 500, doublingTime: 10, time: 20, chartMode: "halflife", scenarioKey: "app_med" }),
        q("A-B4", "BASIC", "APPLICATIONS", pHalf, "N_0=64,\\; h=1\\;d,\\; t=3\\;d", "N(t)", [{ id: "N", l: "N", e: 8 }], "N=8", { initialCount: 64, doublingTime: 1, time: 3, chartMode: "halflife", scenarioKey: "app_med" }),
        q("A-B5", "BASIC", "APPLICATIONS", pHalf, "N_0=200,\\; h=4\\;h,\\; t=2\\;h", "N(t)", [{ id: "N", l: "N", e: 141.4 }], "N \\approx 141.4", { initialCount: 200, doublingTime: 4, time: 2, chartMode: "halflife", scenarioKey: "app_med" }),
        q("A-B6", "BASIC", "APPLICATIONS", pHalf, "N_0=10,\\; h=100\\;y,\\; t=50\\;y", "N(t)", [{ id: "N", l: "N", e: 7.1 }], "N \\approx 7.1", { initialCount: 10, doublingTime: 100, time: 50, chartMode: "halflife", scenarioKey: "app_carbon" }),
        q("A-B7", "BASIC", "APPLICATIONS", pHalf, "N_0=100,\\; N(t)=25,\\; h=5\\;d", "t", [{ id: "t", l: "t", e: 10, u: "d" }], "t=10", { initialCount: 100, doublingTime: 5, finalCount: 25, chartMode: "halflife", scenarioKey: "app_med" }), // Inverse
        q("A-B8", "BASIC", "APPLICATIONS", pHalf, "N_0=80,\\; N(t)=10,\\; t=9\\;h", "h", [{ id: "h", l: "h", e: 3, u: "h" }], "h=3", { initialCount: 80, doublingTime: 3, time: 9, chartMode: "halflife", scenarioKey: "app_med" }) // Inverse h
      );
      ...
      quests.push(
        q("A-A1", "ADVANCED", "APPLICATIONS", pRate, "P_0=100,\\; P=200,\\; t=10", "r\\%", [{ id: "r", l: "r", e: 7.2 }], "7.2\\%", { initialCount: 100, doublingTime: 10, time: 10, chartMode: "exponential", scenarioKey: "app_pop" }),
        q("A-A2", "ADVANCED", "APPLICATIONS", pRate, "P_0=1000,\\; P=2000,\\; t=7", "r\\%", [{ id: "r", l: "r", e: 10.4 }], "r \\approx 10\\%", { initialCount: 1000, doublingTime: 7, time: 7, chartMode: "exponential", scenarioKey: "app_pop" }),
        q("A-A3", "ADVANCED", "APPLICATIONS", pRate, "N_0=50,\\; N=400,\\; t=6", "d", [{ id: "d", l: "d", e: 2 }], "d=2", { initialCount: 50, doublingTime: 2, time: 6, scenarioKey: "app_pop" }),
        q("A-A4", "ADVANCED", "APPLICATIONS", pRate, "N_0=10,\\; N=1000,\\; t=3", "d", [{ id: "d", l: "d", e: 0.45 }], "d \\approx 0.45", { initialCount: 10, doublingTime: 0.45, time: 3, scenarioKey: "app_pop" }),
        q("A-A5", "ADVANCED", "APPLICATIONS", pRate, "P_0=100,\\; r=5\\%", "t_{double}", [{ id: "t", l: "t", e: 14.2 }], "t \\approx 14", { initialCount: 100, doublingTime: 14.2, scenarioKey: "app_pop" }),
        q("A-A6", "ADVANCED", "APPLICATIONS", pRate, "P_0=1,\\; r=2\\%", "t_{double}", [{ id: "t", l: "t", e: 35 }], "t \\approx 35", { initialCount: 1, doublingTime: 35, scenarioKey: "app_pop" }),
        q("A-A7", "ADVANCED", "APPLICATIONS", pRate, "N_0=100,\\; N=50,\\; t=5", "h", [{ id: "h", l: "h", e: 5 }], "h=5", { initialCount: 100, doublingTime: 5, chartMode: "halflife", scenarioKey: "app_med" }),
        q("A-A8", "ADVANCED", "APPLICATIONS", pRate, "N_0=100,\\; N=25,\\; t=10", "h", [{ id: "h", l: "h", e: 5 }], "h=5", { initialCount: 100, doublingTime: 5, chartMode: "halflife", scenarioKey: "app_med" })
      );
    } else { // ELITE - pH and Carbon Dating
      quests.push(
        q("A-E1", "ELITE", "APPLICATIONS", pPH, "[H^+]=10^{-3}", "pH", [{ id: "pH", l: "pH", e: 3 }], "pH=3", { initialCount: 10, doublingTime: 3.3, finalCount: 1000, chartMode: "logarithm", scenarioKey: "log_ph" }), // visual abstract
        q("A-E2", "ELITE", "APPLICATIONS", pPH, "[H^+]=10^{-7}", "pH", [{ id: "pH", l: "pH", e: 7 }], "pH=7", { initialCount: 1, doublingTime: 1, finalCount: 128, chartMode: "logarithm", scenarioKey: "log_ph" }),
        q("A-E3", "ELITE", "APPLICATIONS", pPH, "pH=4", "[H^+]", [{ id: "H", l: "10^x", e: -4 }], "10^{-4}", { initialCount: 10000, doublingTime: 1, chartMode: "logarithm", scenarioKey: "log_ph" }),
        q("A-E4", "ELITE", "APPLICATIONS", pPH, "[H^+]=0.01", "pH", [{ id: "pH", l: "pH", e: 2 }], "pH=2", { initialCount: 100, doublingTime: 1, chartMode: "logarithm", scenarioKey: "log_ph" }),
        q("A-E5", "ELITE", "APPLICATIONS", pPH, "\\text{Half-life } 5730y,\\; 12.5\\% \\text{ left}", "t", [{ id: "t", l: "t", e: 17190 }], "5730 \\cdot 3", { initialCount: 100, doublingTime: 5730, time: 17190, chartMode: "halflife", scenarioKey: "app_carbon" }),
        q("A-E6", "ELITE", "APPLICATIONS", pPH, "\\text{Half-life } 5730y,\\; 50\\% \\text{ left}", "t", [{ id: "t", l: "t", e: 5730 }], "5730", { initialCount: 100, doublingTime: 5730, time: 5730, chartMode: "halflife", scenarioKey: "app_carbon" }),
        q("A-E7", "ELITE", "APPLICATIONS", pPH, "N=N_0 e^{-0.1t},\\; t=10", "N/N_0", [{ id: "r", l: "ratio", e: 0.37 }], "e^{-1} \\approx 0.37", { initialCount: 1, doublingTime: 6.9, time: 10, chartMode: "halflife", scenarioKey: "app_carbon" }),
        q("A-E8", "ELITE", "APPLICATIONS", pPH, "\\log_{10}(I/I_0)=2", "I/I_0", [{ id: "r", l: "ratio", e: 100 }], "100", { initialCount: 1, doublingTime: 1, finalCount: 100, chartMode: "logarithm", scenarioKey: "log_sound" })
      );
    }
  }
