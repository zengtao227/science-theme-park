        ...
        if (stage === "COMBUSTION") {
            ...
            activeList.forEach((comb, idx) => {
                quests.push({
                    ...
                    slots: [{ id: "ans", labelLatex: "\\ce{CO2}\\text{ molecules}", placeholder: t("sc3_03.placeholders.ellipsis"), expected: comb.co2.toString() }],
        ...
        if (stage === "SUBSTITUTION") {
            ...
            activeList.forEach((sub, idx) => {
                quests.push({
                    ...
                    slots: [{ id: "ans", labelLatex: t("common.labels.product"), placeholder: t("sc3_03.placeholders.formula"), expected: sub.product }],
        ...
        if (stage === "ADDITION") {
            ...
            activeList.forEach((add, idx) => {
                quests.push({
                    ...
                    slots: [{ id: "ans", labelLatex: t("common.labels.product"), placeholder: t("sc3_03.placeholders.formula"), expected: add.product }],
                                    ...
                                    {currentQuest?.slots.map((slot: any) => (
                                        <div key={slot.id} className="w-full max-w-md space-y-3">
                                            <div className="flex justify-between items-center text-[10px] uppercase font-bold tracking-widest text-white/60">
                                                ...
                                                <span className="text-neon-purple/30 font-mono">{t("common.reference")}</span>
                                            </div>
