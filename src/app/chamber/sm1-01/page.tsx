...
export default function S101Page() {
    ...
    const sm1_01_t = {
        ...
        quests: {
            ...
            space_diagonal: t("sm1_01.quests.space_diagonal"),
        },
            ...
            monitorContent={
                <>
                    <div className="relative w-full">
                        {/* Use 3D Cube for volume stage with cube geometry stack */}
                        {stage === 'VOLUMES' && currentQuest?.visualMeta?.type === 'cube' ? (
                            <Cube3D
                                ...
                                translations={{
                                    ...
                                    diagonal: sm1_01_t.quests.space_diagonal,
                            ...
                            <>
                                <S101_GeometryCanvas
                                    ...
                                    translations={{
                                        ...
                                        width: sm1_01_t.labels.width,
                                        height: sm1_01_t.labels.height,
                                        base: sm1_01_t.labels.base,
                                        radius: sm1_01_t.labels.radius,
                                        side: sm1_01_t.labels.side,
                                    }}
                                />
