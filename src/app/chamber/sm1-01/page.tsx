            ...
            return [
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 40, unit: "m^2" }],
                ...
                },
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 12, unit: "m^2" }],
                ...
                },
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 25, unit: "m^2" }],
                ...
                },
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 28.3, unit: "cm^2" }],
                ...
                },
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 60, unit: "m^2" }],
        ...
        if (difficulty === "CORE") {
            return [
                ...
                },
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 36, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Rhine bridge trapezoid support}`,
                    expressionLatex: `\\text{${t.labels.side} }a=8\\text{m, }\\text{${t.labels.base} }b=14\\text{m, }\\text{${t.labels.height} }h=6\\text{m}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 66, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Circular fountain at Basel Marktplatz}`,
                    expressionLatex: `\\text{${t.labels.radius} }r=5\\text{m}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 78.5, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Roche Tower window (rectangle)}`,
                    expressionLatex: `\\text{${t.labels.length} }a=15\\text{m, }\\text{${t.labels.width} }b=9\\text{m}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 135, unit: "m^2" }],
            ...
            return [
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 200, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Cathedral roof triangle}`,
                    expressionLatex: `\\text{${t.labels.base} }b=18\\text{m, }\\text{height is 2/3 of base}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 108, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Novartis campus trapezoid plaza}`,
                    expressionLatex: `\\text{${t.labels.side} }a=12\\text{m, }\\text{${t.labels.base} }b=20\\text{m, }\\text{${t.labels.height} }h=8\\text{m}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 128, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Zoo circular pond}`,
                    expressionLatex: `\\text{diameter }d=14\\text{m}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 153.9, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel University courtyard (rectangle)}`,
                    expressionLatex: `\\text{perimeter }P=60\\text{m, length is twice width}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 200, unit: "m^2" }],
            ...
            return [
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 75, unit: "m^2" }],
                ...
                },
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 50, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Messe exhibition trapezoid booth}`,
                    expressionLatex: `\\text{${t.labels.side} }a=10\\text{m, }\\text{${t.labels.base} }b=20\\text{m, }\\text{${t.labels.height} }h=15\\text{m}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 225, unit: "m^2" }],
                ...
                },
                {
                    ...
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 78.5, unit: "cm^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel SBB station rectangular platform}`,
                    expressionLatex: `\\text{area }A=300\\text{m}^2\\text{, length is 3 times width}`,
                    targetLatex: `P`,
                    slots: [{ id: "P", labelLatex: `P`, placeholder: "perimeter", expected: 80, unit: "m" }],
            ...
            return [
                {
                    ...
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 64, unit: "m^3" }],
                ...
                },
                {
                    ...
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 60, unit: "m^3" }],
                ...
                },
                {
                    ...
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 63, unit: "cm^3" }],
                    correctLatex: `V=\\pi r^2h\\approx 63`,
                    hintLatex: [`V=\\pi r^2h`],
                    visualMeta: { type: 'cylinder', params: { r: 2, h: 5 } },
                },
                {
                    id: "VB4", difficulty, stage,
                    promptLatex: `\\text{Basel storage cube}`,
                    expressionLatex: `\\text{${t.labels.side} }a=3\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 27, unit: "m^3" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Novartis shipping box}`,
            ...
            return [
                {
                    ...
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 216, unit: "m^3" }],
                    correctLatex: `V=6^3=216`,
                    hintLatex: [`V=a^3`],
                    visualMeta: { type: 'cube', params: { a: 6 } },
                },
                {
                    id: "VC2", difficulty, stage,
                    promptLatex: `\\text{Roche warehouse container}`,
                    expressionLatex: `\\text{${t.labels.length} }a=8\\text{m, }\\text{${t.labels.width} }b=6\\text{m, }\\text{${t.labels.height} }h=4\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 192, unit: "m^3" }],
                    correctLatex: `V=8\\cdot 6\\cdot 4=192`,
                    hintLatex: [`V=abc`],
                    visualMeta: { type: 'prism', params: { a: 8, b: 6, c: 4 } },
                },
                {
                    id: "VC3", difficulty, stage,
                    promptLatex: `\\text{Basel water tank (cylinder)}`,
                    expressionLatex: `\\text{${t.labels.radius} }r=4\\text{m, }\\text{${t.labels.height} }h=5\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 251, unit: "m^3" }],
                    correctLatex: `V=\\pi r^2h\\approx 251`,
                    hintLatex: [`V=\\pi r^2h`],
                    visualMeta: { type: 'cylinder', params: { r: 4, h: 5 } },
                },
                {
                    id: "VC4", difficulty, stage,
                    promptLatex: `\\text{Basel Museum cube display}`,
                    expressionLatex: `\\text{${t.labels.side} }a=7\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 343, unit: "m^3" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel SBB cargo container}`,
                    expressionLatex: `\\text{${t.labels.length} }a=12\\text{m, }\\text{${t.labels.width} }b=8\\text{m, }\\text{${t.labels.height} }h=3\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 288, unit: "m^3" }],
            ...
            return [
                {
                    ...
                    promptLatex: `\\text{Basel storage cube, surface area 150 m}^2`,
                    expressionLatex: `\\text{surface area }SA=150\\text{m}^2`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 125, unit: "m^3" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Novartis lab container, base 6×8 m, height 10 m}`,
                    expressionLatex: `\\text{${t.labels.length} }a=6\\text{m, }\\text{${t.labels.width} }b=8\\text{m, }\\text{${t.labels.height} }h=10\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 480, unit: "m^3" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Rhine water pipe, diameter 8 m, length 12 m}`,
                    expressionLatex: `\\text{diameter }d=8\\text{m, }\\text{${t.labels.height} }h=12\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 603, unit: "m^3" }],
                    correctLatex: `r=4 \\Rightarrow V=\\pi r^2h\\approx 603`,
                    hintLatex: [`r=d/2`, `V=\\pi r^2h`],
                    visualMeta: { type: 'cylinder', params: { r: 4, h: 12 } },
                },
                {
                    id: "VA4", difficulty, stage,
                    promptLatex: `\\text{Roche Tower cube room, edge 9 m}`,
                    expressionLatex: `\\text{${t.labels.side} }a=9\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 729, unit: "m^3" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Messe exhibition hall, 20×15×8 m}`,
                    expressionLatex: `\\text{${t.labels.length} }a=20\\text{m, }\\text{${t.labels.width} }b=15\\text{m, }\\text{${t.labels.height} }h=8\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 2400, unit: "m^3" }],
        ...
        if (difficulty === "ELITE") {
            return [
                ...
                },
                {
                    ...
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 300, unit: "m^3" }],
                ...
                },
                {
                    ...
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 785, unit: "cm^3" }],
                    correctLatex: `LA=2\\pi rh \\Rightarrow h=10 \\Rightarrow V=\\pi r^2h\\approx 785`,
                    hintLatex: [`LA=2\\pi rh`, `V=\\pi r^2h`],
                    visualMeta: { type: 'cylinder', params: { r: 5, h: 10 } },
                },
                {
                    id: "VE4", difficulty, stage,
                    promptLatex: `\\text{Basel University cube lab, volume 1000 m}^3`,
                    expressionLatex: `\\text{volume }V=1000\\text{m}^3`,
                    targetLatex: `SA`,
                    slots: [{ id: "SA", labelLatex: `SA`, placeholder: "surface area", expected: 600, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Novartis cylindrical tank, radius 6 m, volume 678.6 m}^3`,
                    expressionLatex: `\\text{${t.labels.radius} }r=6\\text{m, }\\text{volume }V=678.6\\text{m}^3`,
                    targetLatex: `h`,
                    slots: [{ id: "h", labelLatex: `h`, placeholder: "height", expected: 6, unit: "m" }],
                    correctLatex: `V=\\pi r^2h \\Rightarrow h=V/(\\pi r^2)\\approx 6`,
                    hintLatex: [`V=\\pi r^2h`, `h=V/(\\pi r^2)`],
        ...
        if (difficulty === "BASIC") {
            return [
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel park rectangular path}`,
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Cathedral triangular roof section}`,
                    expressionLatex: `\\text{Triangle: }b=8,\\; h=6`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 24, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Novartis circular logo}`,
                    expressionLatex: `\\text{Circle: }r=4`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 50.3, unit: "cm^2" }],
            ...
            return [
                {
                    ...
                    targetLatex: `d`,
                    slots: [{ id: "d", labelLatex: `d`, placeholder: "diagonal", expected: 10.39, unit: "m" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Rhine bridge trapezoid support}`,
                    expressionLatex: `\\text{Trapezoid: }a=10,\\; b=16,\\; h=8`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 104, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Roche Tower rectangular prism}`,
                    expressionLatex: `\\text{Prism: }a=8,\\; b=6,\\; h=10`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 480, unit: "m^3" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel water tank cylinder}`,
                    expressionLatex: `\\text{Cylinder: }r=5,\\; h=8`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 628, unit: "m^3" }],
                    correctLatex: `V=\\pi r^2h\\approx 628`,
                    hintLatex: [`V=\\pi r^2h`],
                    visualMeta: { type: 'cylinder', params: { r: 5, h: 8 } },
                },
                {
                    id: "CC5", difficulty, stage,
                    promptLatex: `\\text{Basel Messe exhibition cube}`,
                    expressionLatex: `\\text{Cube: }a=8`,
                    targetLatex: `SA`,
                    slots: [{ id: "SA", labelLatex: `SA`, placeholder: "surface area", expected: 384, unit: "m^2" }],
            ...
            return [
                {
                    ...
                    promptLatex: `\\text{Basel University cube lab, diagonal 12 m}`,
                    expressionLatex: `\\text{space diagonal }d=12\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 192.5, unit: "m^3" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Novartis trapezoid plaza, perimeter 50 m}`,
                    expressionLatex: `\\text{Trapezoid: }a=8,\\; b=16,\\; h=10,\\; \\text{find area}`,
                    targetLatex: `A`,
                    slots: [{ id: "A", labelLatex: `A`, placeholder: "area", expected: 120, unit: "m^2" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel Rhine cylindrical pipe, diameter 10 m, length 15 m}`,
                    expressionLatex: `\\text{diameter }d=10\\text{m, }\\text{length }h=15\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 1178, unit: "m^3" }],
                    correctLatex: `r=5 \\Rightarrow V=\\pi r^2h\\approx 1178`,
                    hintLatex: [`r=d/2`, `V=\\pi r^2h`],
                    visualMeta: { type: 'cylinder', params: { r: 5, h: 15 } },
                },
                {
                    id: "CA4", difficulty, stage,
                    promptLatex: `\\text{Roche Tower prism, base 12×10 m, height 20 m}`,
                    expressionLatex: `\\text{base }12\\times 10\\text{m, height }20\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 2400, unit: "m^3" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel SBB cube storage, surface area 294 m}^2`,
                    expressionLatex: `\\text{surface area }SA=294\\text{m}^2`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 343, unit: "m^3" }],
            ...
            return [
                {
                    ...
                    promptLatex: `\\text{Basel Museum cube, volume 512 m}^3\\text{, find diagonal}`,
                    expressionLatex: `\\text{volume }V=512\\text{m}^3`,
                    targetLatex: `d`,
                    slots: [{ id: "d", labelLatex: `d`, placeholder: "diagonal", expected: 13.86, unit: "m" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Novartis cylinder tank, lateral area 314.16 m}^2\\text{, radius 5 m}`,
                    expressionLatex: `\\text{lateral area }LA=314.16\\text{m}^2\\text{, }r=5\\text{m}`,
                    targetLatex: `V`,
                    slots: [{ id: "V", labelLatex: `V`, placeholder: "volume", expected: 785, unit: "m^3" }],
                    correctLatex: `LA=2\\pi rh \\Rightarrow h=10 \\Rightarrow V=\\pi r^2h\\approx 785`,
                    hintLatex: [`LA=2\\pi rh`, `V=\\pi r^2h`],
                    visualMeta: { type: 'cylinder', params: { r: 5, h: 10 } },
                },
                {
                    ...
                    promptLatex: `\\text{Basel Rhine bridge trapezoid, area 180 m}^2\\text{, }a=10\\text{, }b=20\\text{, find }h`,
                    expressionLatex: `\\text{area }A=180\\text{m}^2\\text{, }a=10\\text{, }b=20`,
                    targetLatex: `h`,
                    slots: [{ id: "h", labelLatex: `h`, placeholder: "height", expected: 12, unit: "m" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Roche Tower prism, volume 1200 m}^3\\text{, base }10\\times 8\\text{ m, find height}`,
                    expressionLatex: `\\text{volume }V=1200\\text{m}^3\\text{, base }10\\times 8\\text{m}`,
                    targetLatex: `h`,
                    slots: [{ id: "h", labelLatex: `h`, placeholder: "height", expected: 15, unit: "m" }],
                ...
                },
                {
                    ...
                    promptLatex: `\\text{Basel water tank cylinder, volume 1570.8 m}^3\\text{, height 20 m, find radius}`,
                    expressionLatex: `\\text{volume }V=1570.8\\text{m}^3\\text{, height }h=20\\text{m}`,
                    targetLatex: `r`,
                    slots: [{ id: "r", labelLatex: `r`, placeholder: "radius", expected: 5, unit: "m" }],
                    correctLatex: `V=\\pi r^2h \\Rightarrow r^2=V/(\\pi h) \\Rightarrow r=5`,
                    hintLatex: [`V=\\pi r^2h`, `r=\\sqrt{V/(\\pi h)}`],
