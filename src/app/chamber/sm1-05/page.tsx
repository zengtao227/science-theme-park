...
export default function SM105Page() {
    ...
    const buildStagePool = useCallback((difficulty: Difficulty, stage: Stage): S105Quest[] => {
        ...
        if (stage === "MIXTURES") {
            if (isBasic) {
                quests.push(
                    { id: "M-B1", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_syrup, expressionLatex: "\\frac{20}{100}", targetLatex: "20", visualData: { solute: 20, solvent: 80, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 20 }], correctLatex: "20", hintLatex: [sm1_05_t.hints.mix_total_100] },
                    ...
                    { id: "M-B3", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_juice, expressionLatex: "\\frac{50}{100}", targetLatex: "50", visualData: { solute: 50, solvent: 50, hideResult: true, soluteColor: "#eab308" }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 50 }], correctLatex: "50", hintLatex: [sm1_05_t.hints.percent_half] },
                    { id: "M-B4", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_colors, expressionLatex: "\\frac{30}{100}", targetLatex: "30", visualData: { solute: 30, solvent: 70, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 30 }], correctLatex: "30", hintLatex: ["30 out of 100."] },
                    { id: "M-B5", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_zero, expressionLatex: "0", targetLatex: "0", visualData: { solute: 0, solvent: 100, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 0 }], correctLatex: "0", hintLatex: ["Pure solvent."] }
                );
            } else if (isCore) {
                quests.push(
                    { id: "M-C1", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_25g, expressionLatex: "\\frac{25}{100}", targetLatex: "25", visualData: { solute: 25, solvent: 75, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 25 }], correctLatex: "25", hintLatex: ["Total 100g."] },
                    { id: "M-C2", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_20ml, expressionLatex: "\\frac{20}{200}", targetLatex: "10", visualData: { solute: 20, solvent: 180, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 10 }], correctLatex: "10", hintLatex: ["Total 200ml."] },
                    { id: "M-C3", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_40ml, expressionLatex: "\\frac{40}{200}", targetLatex: "20", visualData: { solute: 40, solvent: 160, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 20 }], correctLatex: "20", hintLatex: ["Double the percent calculation."] },
                    { id: "M-C4", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_find_solute, expressionLatex: "50", targetLatex: "50", visualData: { solute: 50, solvent: 450, hideResult: false }, slots: [{ id: "ans", labelLatex: "ml", placeholder: "?", expected: 50 }], correctLatex: "50", hintLatex: ["500 \\times 0.1"] },
                    { id: "M-C5", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_find_mass, expressionLatex: "10", targetLatex: "10", visualData: { solute: 10, solvent: 190, hideResult: false }, slots: [{ id: "ans", labelLatex: "g", placeholder: "?", expected: 10 }], correctLatex: "10", hintLatex: ["200 \\times 0.05"] }
                );
            } else if (isAdv) {
                quests.push(
                    { id: "M-A1", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_add_10g, expressionLatex: "10/50", targetLatex: "20", visualData: { solute: 10, solvent: 40, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 20 }], correctLatex: "20", hintLatex: ["Total 50g."] },
                    { id: "M-A2", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_add_50ml, expressionLatex: "50/200", targetLatex: "25", visualData: { solute: 50, solvent: 150, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 25 }], correctLatex: "25", hintLatex: [sm1_05_t.hints.percent_quarter] },
                    { id: "M-A3", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_dilute, expressionLatex: "50g / 200ml", targetLatex: "25", visualData: { solute: 50, solvent: 150, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 25 }], correctLatex: "25", hintLatex: [sm1_05_t.hints.mix_dilute] },
                    { id: "M-A4", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_find_water, expressionLatex: "20/Total=0.1", targetLatex: "180", visualData: { solute: 20, solvent: 180, hideResult: false }, slots: [{ id: "ans", labelLatex: sm1_05_t.labels.water, placeholder: "?", expected: 180 }], correctLatex: "180", hintLatex: ["Total must be 200. 200-20=180."] },
                    { id: "M-A5", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_avg, expressionLatex: "15", targetLatex: "15", visualData: { solute: 30, solvent: 170, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 15 }], correctLatex: "15", hintLatex: [sm1_05_t.hints.mix_avg] }
                );
            } else {
                // Elite
                quests.push(
                    { id: "M-E1", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_weighted, expressionLatex: "(20+60)/500", targetLatex: "16", visualData: { solute: 80, solvent: 420, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 16 }], correctLatex: "16", hintLatex: ["Total solute 80g. Total mass 500g."] },
                    { id: "M-E2", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_evaporate, expressionLatex: "20/100", targetLatex: "20", visualData: { solute: 20, solvent: 80, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 20 }], correctLatex: "20", hintLatex: ["Solute stays 20g. Total becomes 100g."] },
                    ...
                    { id: "M-E4", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_inverse, expressionLatex: "20/(100+X)=0.1", targetLatex: "100", visualData: { solute: 20, solvent: 180, hideResult: true }, slots: [{ id: "ans", labelLatex: sm1_05_t.labels.share, placeholder: "?", expected: 100 }], correctLatex: "100", hintLatex: ["Dilute by half."] },
                    { id: "M-E5", difficulty, stage, visualMode: "MIXTURES", promptLatex: sm1_05_t.prompts.mix_final_challenge, expressionLatex: "(40+50)/250", targetLatex: "36", visualData: { solute: 90, solvent: 160, hideResult: true }, slots: [{ id: "ans", labelLatex: "%", placeholder: "?", expected: 36 }], correctLatex: "36", hintLatex: ["Orig solute 40g. Total 250g."] }
                );
            }
        }
