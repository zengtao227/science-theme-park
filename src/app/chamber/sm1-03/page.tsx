      ...
      NUMBER_LINE: {
        BASIC: [
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.pos}}`,
            expressionLatex: "-3",
            targetLatex: "x",
            value: -3,
        ...
        CORE: [
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.colder}}`,
            expressionLatex: "-5 < -2",
            targetLatex: "x",
            value: -5,
            slots: [{ id: "x", labelLatex: "x", placeholder: "-x", expected: -5, unit: "" }],
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.smaller}}`,
            expressionLatex: "-3 < 1",
            targetLatex: "x",
            value: -3,
            slots: [{ id: "x", labelLatex: "x", placeholder: "-x", expected: -3, unit: "" }],
        ...
        ADVANCED: [
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.midpoint}}`,
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.range}}`,
        ...
        ELITE: [
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.result}}`,
      ...
      RATIONALS: {
        BASIC: [
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.decimal}}`,
        ...
        CORE: [
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.which_is_larger}}`,
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.smallest_value}}`,
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.sum}}`,
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.difference}}`,
        ...
        ADVANCED: [
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.product}}`,
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.quotient}}`,
        ...
        ELITE: [
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.order_smallest}}`,
        ...
        BASIC: [
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.x_coord}}`,
            expressionLatex: "(2, 3)",
            targetLatex: "x",
            x: 2,
            y: 3,
          ...
          },
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.y_coord}}`,
            expressionLatex: "(3, 4)",
            targetLatex: "y",
            x: 3,
            y: 4,
        ...
        CORE: [
          {
            ...
            promptLatex: `\\\\text{${tObj.labels.quadrant}}`,
            expressionLatex: "(-2, 5)",
            targetLatex: "Q",
            x: -2,
            y: 5,
