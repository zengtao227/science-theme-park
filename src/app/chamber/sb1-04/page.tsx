    ...
    const buildStagePool = useCallback((
        ...
        if (stage === "PLANT_STRUCTURE") {
            ...
            return structureData[difficulty].map((item, idx) => ({
                ...
                expressionLatex: `\\text{${t("sb1_04.expressions.structure_label")}} ${item.structure}`,
                targetLatex: "answer",
                slots: [{
                    id: "answer",
                    labelLatex: "Function",
        ...
        if (stage === "WATER_TRANSPORT") {
            ...
            return waterData[difficulty].map((item, idx) => ({
                ...
                stage,
                promptLatex: item.prompt,
                expressionLatex: `\\text{${t("sb1_04.expressions.water_transport_title")}}`,
                targetLatex: "answer",
                slots: [{
                    id: "answer",
                    labelLatex: "Answer",
        ...
        if (stage === "NUTRIENT_TRANSPORT") {
            ...
            return nutrientData[difficulty].map((item, idx) => ({
                ...
                stage,
                promptLatex: item.prompt,
                expressionLatex: `\\text{${t("sb1_04.expressions.nutrient_transport_title")}}`,
                targetLatex: "answer",
                slots: [{
                    id: "answer",
                    labelLatex: "Answer",
